...
namespace DfExample.DBFlute.ExBhv {
    ...
    public partial class ProductBhv : DfExample.DBFlute.AllCommon.Bhv.AbstractBehaviorWritable {
        ...
        public virtual Product SelectByPKValue(int? productId) {
            return SelectEntity(BuildPKCB(productId));
        }

        public virtual Product SelectByPKValueWithDeletedCheck(int? productId) {
            return SelectEntityWithDeletedCheck(BuildPKCB(productId));
        }

        private ProductCB BuildPKCB(int? productId) {
        ...
        public virtual void LoadPurchaseList(IList<Product> productList, LoadReferrerOption<PurchaseCB, Purchase> loadReferrerOption) {
            ...
            HelpLoadReferrerInternally<Product, int?, PurchaseCB, Purchase>
                    (productList, loadReferrerOption, new MyInternalLoadPurchaseListCallback(referrerBhv));
        }
        protected class MyInternalLoadPurchaseListCallback : InternalLoadReferrerCallback<Product, int?, PurchaseCB, Purchase> {
            ...
            public int? getPKVal(Product e) { return e.ProductId; }
            ...
            public void qyFKIn(PurchaseCB cb, IList<int?> ls) { cb.Query().SetProductId_InScope(ls); }
            ...
            public int? getFKVal(Purchase e) { return e.ProductId; }
