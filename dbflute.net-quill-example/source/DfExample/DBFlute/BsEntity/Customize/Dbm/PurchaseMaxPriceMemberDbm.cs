...
namespace DfExample.DBFlute.BsEntity.Customize.Dbm {
    ...
    public class PurchaseMaxPriceMemberDbm : AbstractDBMeta {
        ...
        protected void InitializeColumnInfo() {
            ...
            _columnPurchaseMaxPrice = cci("PURCHASE_MAX_PRICE", "PURCHASE_MAX_PRICE", null, null, false, "PurchaseMaxPrice", typeof(int?), false, "INT", 20, 0, false, OptimisticLockType.NONE, null, null, null);
        ...
        public class EntityPropertyMemberIdSetupper : EntityPropertySetupper<PurchaseMaxPriceMember> {
            public void Setup(PurchaseMaxPriceMember entity, Object value) { entity.MemberId = (value != null) ? (int?)value : null; }
        }
        ...
        public class EntityPropertyPurchaseMaxPriceSetupper : EntityPropertySetupper<PurchaseMaxPriceMember> {
            public void Setup(PurchaseMaxPriceMember entity, Object value) { entity.PurchaseMaxPrice = (value != null) ? (int?)value : null; }
        }
