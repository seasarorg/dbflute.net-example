...
namespace DfExample.DBFlute.ExEntity {
    ...
    /// <summary>
    /// The entity of white_myself_check as TABLE. (partial class for auto-generation)
    /// <![CDATA[
    /// [primary-key]
    ///     MYSELF_CHECK_ID
    /// 
    ...
    /// </summary>
    [Seasar.Dao.Attrs.Table("white_myself_check")]
    [System.Serializable]
    public partial class WhiteMyselfCheck : Entity {
        ...
        /// <summary>MYSELF_ID: {IX, INT(10), FK to white_myself}</summary>
        ...
        //                                                                      Table Name
        //                                                                      ==========
        public String TableDbName { get { return "white_myself_check"; } }
        public String TablePropertyName { get { return "WhiteMyselfCheck"; } }
        ...
        /// <summary>white_myself as 'WhiteMyself'.</summary>
        [Seasar.Dao.Attrs.Relno(0), Seasar.Dao.Attrs.Relkeys("MYSELF_ID:MYSELF_ID")]
        public WhiteMyself WhiteMyself {
            get { return _whiteMyself; }
            set { _whiteMyself = value; }
        }
        ...
        public override bool Equals(Object other) {
            if (other == null || !(other is WhiteMyselfCheck)) { return false; }
            WhiteMyselfCheck otherEntity = (WhiteMyselfCheck)other;
        ...
        public override String ToString() {
            return "WhiteMyselfCheck:" + BuildColumnString() + BuildRelationString();
        }
