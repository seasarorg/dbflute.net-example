...
namespace DfExample.DBFlute.CBean.CQ {
    ...
    [System.Serializable]
    public class WhiteAllInOneClsCQ : BsWhiteAllInOneClsCQ {
        ...
        public WhiteAllInOneClsCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
