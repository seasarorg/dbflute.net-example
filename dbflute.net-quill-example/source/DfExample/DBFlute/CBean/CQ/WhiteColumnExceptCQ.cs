...
namespace DfExample.DBFlute.CBean.CQ {
    ...
    [System.Serializable]
    public class WhiteColumnExceptCQ : BsWhiteColumnExceptCQ {
        ...
        public WhiteColumnExceptCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
