...
namespace DfExample.DBFlute.CBean.CQ.Ciq {
    ...
    [System.Serializable]
    public class MemberSecurityCIQ : AbstractBsMemberSecurityCQ {
        ...
        protected override ConditionValue getCValueLoginPassword() {
            return _myCQ.LoginPassword;
        }


        protected override ConditionValue getCValueReminderQuestion() {
            return _myCQ.ReminderQuestion;
        }


        protected override ConditionValue getCValueReminderAnswer() {
