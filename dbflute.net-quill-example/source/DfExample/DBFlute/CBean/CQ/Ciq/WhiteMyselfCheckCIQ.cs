...
namespace DfExample.DBFlute.CBean.CQ.Ciq {
    ...
    [System.Serializable]
    public class WhiteMyselfCheckCIQ : AbstractBsWhiteMyselfCheckCQ {
        ...
        //                                                                     Constructor
        //                                                                     ===========
        public WhiteMyselfCheckCIQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel, BsWhiteMyselfCheckCQ myCQ)
        ...
        protected override ConditionValue getCValueMyselfCheckId() {
            return _myCQ.MyselfCheckId;
        }


        protected override ConditionValue getCValueMyselfCheckName() {
        ...
        public override String keepMyselfId_InScopeSubQuery_WhiteMyself(WhiteMyselfCQ subQuery) {
            return _myCQ.keepMyselfId_InScopeSubQuery_WhiteMyself(subQuery);
        }

        public override String keepMyselfId_NotInScopeSubQuery_WhiteMyself(WhiteMyselfCQ subQuery) {
            return _myCQ.keepMyselfId_NotInScopeSubQuery_WhiteMyself(subQuery);
        }
