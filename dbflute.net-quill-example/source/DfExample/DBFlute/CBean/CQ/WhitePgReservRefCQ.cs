...
namespace DfExample.DBFlute.CBean.CQ {
    ...
    [System.Serializable]
    public class WhitePgReservRefCQ : BsWhitePgReservRefCQ {
        ...
        public WhitePgReservRefCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
