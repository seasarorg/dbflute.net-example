...
namespace DfExample.DBFlute.CBean.CQ {
    ...
    [System.Serializable]
    public class WhiteCompoundPkRefCQ : BsWhiteCompoundPkRefCQ {
        ...
        public WhiteCompoundPkRefCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
