...
namespace DfExample.DBFlute.CBean.CQ {
    ...
    [System.Serializable]
    public class VendorSelfReferenceCQ : BsVendorSelfReferenceCQ {
        ...
        public VendorSelfReferenceCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
