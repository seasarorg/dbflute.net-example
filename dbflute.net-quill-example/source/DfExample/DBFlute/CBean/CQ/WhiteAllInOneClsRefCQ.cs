...
namespace DfExample.DBFlute.CBean.CQ {
    ...
    [System.Serializable]
    public class WhiteAllInOneClsRefCQ : BsWhiteAllInOneClsRefCQ {
        ...
        public WhiteAllInOneClsRefCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
