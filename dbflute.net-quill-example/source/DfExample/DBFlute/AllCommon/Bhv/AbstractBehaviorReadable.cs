...
using DfExample.DBFlute.AllCommon.CBean.OutsideSql.Executor;
...
namespace DfExample.DBFlute.AllCommon.Bhv {
    ...
    public abstract class AbstractBehaviorReadable : BehaviorReadable {
        ...
        protected virtual void AssertConditionBeanNotNull(DfExample.DBFlute.AllCommon.CBean.ConditionBean cb) {
