...
namespace DfExample.DBFlute.AllCommon.Helper
{
    public class MapListStringImpl : MapListString
    {
        ...
        public Dictionary<String, Object> generateMap(string mapString)
        {
            ...
            if (!"".Equals(_remainderString) && !_endBrace.Equals(_remainderString))
            {
                ...
                throw new DfExample.DBFlute.AllCommon.JavaLike.IllegalStateException(msg);
            }
            return generatedMap;
        }
        ...
        protected void removePrefix(String prefixString)
        {
            if (_remainderString == null)
            {
                ...
                throw new DfExample.DBFlute.AllCommon.JavaLike.IllegalArgumentException(msg);
            }
            removeBothSideSpaceAndTabAndNewLine();
        ...
        protected void assertMapString(String mapString)
        {
            if (mapString == null)
            {
                ...
                throw new DfExample.DBFlute.AllCommon.JavaLike.IllegalArgumentException(msg + "mapString=" + mapString);
            }
        ...
        protected void assertListString(String listString)
        {
            if (listString == null)
            {
                ...
                throw new DfExample.DBFlute.AllCommon.JavaLike.IllegalArgumentException(msg + "liststring=" + listString);
            }
