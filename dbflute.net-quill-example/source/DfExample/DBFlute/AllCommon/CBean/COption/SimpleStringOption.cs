...
// using DfExample.DBFlute.AllCommon.CBean.COption.Parts;
// using DfExample.DBFlute.AllCommon.CBean.COption.Parts.Local;
using DfExample.DBFlute.AllCommon.Util;

namespace DfExample.DBFlute.AllCommon.CBean.COption {
