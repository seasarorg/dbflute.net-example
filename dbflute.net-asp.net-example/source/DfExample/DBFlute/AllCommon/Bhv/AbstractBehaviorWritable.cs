...
namespace DfExample.DBFlute.AllCommon.Bhv {
    ...
    public abstract class AbstractBehaviorWritable : AbstractBehaviorReadable, BehaviorWritable {
        ...
        protected virtual void SetupCommonColumnOfInsertIfNeeds(Entity targetEntity) {
            ...
            DateTime? registerDatetime = DfExample.DBFlute.AllCommon.AccessContext.GetAccessTimestampOnThread();
            entity.RegisterDatetime = registerDatetime;
            
            String registerUser = DfExample.DBFlute.AllCommon.AccessContext.GetAccessUserOnThread();
            entity.RegisterUser = registerUser;
            
            String registerProcess = DfExample.DBFlute.AllCommon.AccessContext.GetAccessProcessOnThread();
        ...
        protected virtual void SetupCommonColumnOfUpdateIfNeeds(Entity targetEntity) {
            ...
            DateTime? updateDatetime = DfExample.DBFlute.AllCommon.AccessContext.GetAccessTimestampOnThread();
            entity.UpdateDatetime = updateDatetime;
            
            String updateUser = DfExample.DBFlute.AllCommon.AccessContext.GetAccessUserOnThread();
            entity.UpdateUser = updateUser;
            
            String updateProcess = DfExample.DBFlute.AllCommon.AccessContext.GetAccessProcessOnThread();
            entity.UpdateProcess = updateProcess;
              }

        protected virtual void FilterEntityOfUpdate(DfExample.DBFlute.AllCommon.Entity targetEntity) {
        }

        protected virtual void AssertEntityOfUpdate(DfExample.DBFlute.AllCommon.Entity entity) {
        }
