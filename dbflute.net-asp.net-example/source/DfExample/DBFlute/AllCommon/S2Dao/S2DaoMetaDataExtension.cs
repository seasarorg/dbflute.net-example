...
using DfExample.DBFlute.AllCommon.Annotation;
...
using DfExample.DBFlute.AllCommon.S2Dao.Internal.SqlCommand;
using DfExample.DBFlute.AllCommon.S2Dao.Internal.RsHandler;
...
namespace DfExample.DBFlute.AllCommon.S2Dao {
    ...
    public class BeanMetaDataDBFluteDBMetaExtension : BeanMetaDataImpl {
        protected DfExample.DBFlute.AllCommon.JavaLike.List<IPropertyType> _primaryKeyList = new DfExample.DBFlute.AllCommon.JavaLike.ArrayList<IPropertyType>();
