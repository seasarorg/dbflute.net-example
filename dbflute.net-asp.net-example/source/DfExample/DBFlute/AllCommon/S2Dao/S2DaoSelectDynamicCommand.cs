...
using DfExample.DBFlute.AllCommon.S2Dao.Internal.SqlParser;
...
namespace DfExample.DBFlute.AllCommon.S2Dao {
    ...
    public class S2DaoSelectDynamicCommand : SelectDynamicCommand {
        ...
        protected virtual object[] FilterArgumentsForDataReaderHandler(object[] args) {
            ...
            object[] filteredArgs;
            if (args[args.Length - 1] is DfExample.DBFlute.AllCommon.Ado.CursorHandler) {
        ...
        protected IDataReaderHandler FindSpecifiedDataReaderHandler(object[] args) {
            ...
            if (args[args.Length-1] is DfExample.DBFlute.AllCommon.Ado.CursorHandler) {
                DfExample.DBFlute.AllCommon.Ado.CursorHandler cursorHandler = (DfExample.DBFlute.AllCommon.Ado.CursorHandler)args[args.Length-1];
        ...
        protected class DataReaderCursol : IDataReaderHandler {
            protected DfExample.DBFlute.AllCommon.Ado.CursorHandler _cursorHandler;
            public DataReaderCursol(DfExample.DBFlute.AllCommon.Ado.CursorHandler cursorHandler) {
