...
namespace DfExample.DBFlute.ExBhv {
    ...
    public partial class MemberBhv : DfExample.DBFlute.AllCommon.Bhv.AbstractBehaviorWritable {
        ...
        public virtual Member SelectByPKValue(long? memberId) {
            return SelectEntity(BuildPKCB(memberId));
        }

        public virtual Member SelectByPKValueWithDeletedCheck(long? memberId) {
        ...
        protected override void SetupNextValueToPrimaryKey(Entity entity) {// Very Internal
            Member myEntity = (Member)entity;
            myEntity.MemberId = SelectNextVal();
        }
        ...
        public virtual void LoadMemberAddressList(IList<Member> memberList, LoadReferrerOption<MemberAddressCB, MemberAddress> loadReferrerOption) {
            ...
            HelpLoadReferrerInternally<Member, long?, MemberAddressCB, MemberAddress>
                    (memberList, loadReferrerOption, new MyInternalLoadMemberAddressListCallback(referrerBhv));
        }
        protected class MyInternalLoadMemberAddressListCallback : InternalLoadReferrerCallback<Member, long?, MemberAddressCB, MemberAddress> {
            ...
            public long? getPKVal(Member e) { return e.MemberId; }
            ...
            public void qyFKIn(MemberAddressCB cb, IList<long?> ls) { cb.Query().SetMemberId_InScope(ls); }
            ...
            public long? getFKVal(MemberAddress e) { return e.MemberId; }
        ...
        public virtual void LoadMemberLoginList(IList<Member> memberList, LoadReferrerOption<MemberLoginCB, MemberLogin> loadReferrerOption) {
            ...
            HelpLoadReferrerInternally<Member, long?, MemberLoginCB, MemberLogin>
                    (memberList, loadReferrerOption, new MyInternalLoadMemberLoginListCallback(referrerBhv));
        }
        protected class MyInternalLoadMemberLoginListCallback : InternalLoadReferrerCallback<Member, long?, MemberLoginCB, MemberLogin> {
            ...
            public void qyFKIn(MemberLoginCB cb, IList<long?> ls) { cb.Query().SetMemberId_InScope(ls); }
            ...
            public long? getFKVal(MemberLogin e) { return e.MemberId; }
        ...
        public virtual void LoadPurchaseList(IList<Member> memberList, LoadReferrerOption<PurchaseCB, Purchase> loadReferrerOption) {
            ...
            HelpLoadReferrerInternally<Member, long?, PurchaseCB, Purchase>
                    (memberList, loadReferrerOption, new MyInternalLoadPurchaseListCallback(referrerBhv));
        }
        protected class MyInternalLoadPurchaseListCallback : InternalLoadReferrerCallback<Member, long?, PurchaseCB, Purchase> {
            ...
            public void qyFKIn(PurchaseCB cb, IList<long?> ls) { cb.Query().SetMemberId_InScope(ls); }
            ...
            public long? getFKVal(Purchase e) { return e.MemberId; }
