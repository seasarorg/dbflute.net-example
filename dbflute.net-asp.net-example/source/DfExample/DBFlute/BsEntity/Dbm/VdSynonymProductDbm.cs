...
namespace DfExample.DBFlute.BsEntity.Dbm {
    ...
    public class VdSynonymProductDbm : AbstractDBMeta {

        public static readonly Type ENTITY_TYPE = typeof(VdSynonymProduct);

        private static readonly VdSynonymProductDbm _instance = new VdSynonymProductDbm();
        private VdSynonymProductDbm() {
            InitializeColumnInfo();
            InitializeColumnInfoList();
            InitializeEntityPropertySetupper();
        }
        public static VdSynonymProductDbm GetInstance() {
            return _instance;
        }
        ...
        public override String TablePropertyName { get { return "VdSynonymProduct"; } }
        public override String TableSqlName { get { return "VD_SYNONYM_PRODUCT"; } }
        ...
        protected void InitializeColumnInfo() {
            _columnProductId = cci("PRODUCT_ID", "PRODUCT_ID", null, null, true, "ProductId", typeof(long?), true, "NUMBER", 16, 0, false, OptimisticLockType.NONE, null, null, null);
            ...
            _columnProductStatusCode = cci("PRODUCT_STATUS_CODE", "PRODUCT_STATUS_CODE", null, null, true, "ProductStatusCode", typeof(String), false, "CHAR", 3, 0, false, OptimisticLockType.NONE, null, "vdSynonymProductStatus", null);
        ...
        //                                   Foreign Element
        //                                   ---------------
        public ForeignInfo ForeignVdSynonymProductStatus { get {
            Map<ColumnInfo, ColumnInfo> map = new LinkedHashMap<ColumnInfo, ColumnInfo>();
            map.put(ColumnProductStatusCode, VdSynonymProductStatusDbm.GetInstance().ColumnProductStatusCode);
            return cfi("VdSynonymProductStatus", this, VdSynonymProductStatusDbm.GetInstance(), map, 0, false, false);
        }}
        ...
        //                                             Table
        //                                             -----
        public static readonly String TABLE_DB_NAME = "VD_SYNONYM_PRODUCT";
        public static readonly String TABLE_PROPERTY_NAME = "VdSynonymProduct";
        ...
        //                                      Foreign Name
        //                                      ------------
        public static readonly String FOREIGN_PROPERTY_NAME_VdSynonymProductStatus = "VdSynonymProductStatus";
        // -------------------------------------------------
        //                                     Referrer Name
        //                                     -------------
        ...
        //                                                                       Type Name
        //                                                                       =========
        public override String EntityTypeName { get { return "DfExample.DBFlute.ExEntity.VdSynonymProduct"; } }
        public override String DaoTypeName { get { return "DfExample.DBFlute.ExDao.VdSynonymProductDao"; } }
        public override String ConditionBeanTypeName { get { return "DfExample.DBFlute.CBean.VdSynonymProductCB"; } }
        public override String BehaviorTypeName { get { return "DfExample.DBFlute.ExBhv.VdSynonymProductBhv"; } }
        ...
        public VdSynonymProduct NewMyEntity() { return new VdSynonymProduct(); }
        public override ConditionBean NewConditionBean() { return NewMyConditionBean(); }
        public VdSynonymProductCB NewMyConditionBean() { return new VdSynonymProductCB(); }

        // ===============================================================================
        //                                                           Entity Property Setup
        //                                                           =====================
        protected Map<String, EntityPropertySetupper<VdSynonymProduct>> _entityPropertySetupperMap = new LinkedHashMap<String, EntityPropertySetupper<VdSynonymProduct>>();
        ...
        public override void SetupEntityProperty(String propertyName, Object entity, Object value) {
            EntityPropertySetupper<VdSynonymProduct> callback = _entityPropertySetupperMap.get(propertyName);
            callback.Setup((VdSynonymProduct)entity, value);
        }

        public class EntityPropertyProductIdSetupper : EntityPropertySetupper<VdSynonymProduct> {
            public void Setup(VdSynonymProduct entity, Object value) { entity.ProductId = (value != null) ? (long?)value : null; }
        }
        public class EntityPropertyProductNameSetupper : EntityPropertySetupper<VdSynonymProduct> {
            public void Setup(VdSynonymProduct entity, Object value) { entity.ProductName = (value != null) ? (String)value : null; }
        }
        public class EntityPropertyProductHandleCodeSetupper : EntityPropertySetupper<VdSynonymProduct> {
            public void Setup(VdSynonymProduct entity, Object value) { entity.ProductHandleCode = (value != null) ? (String)value : null; }
        }
        public class EntityPropertyProductStatusCodeSetupper : EntityPropertySetupper<VdSynonymProduct> {
            public void Setup(VdSynonymProduct entity, Object value) { entity.ProductStatusCode = (value != null) ? (String)value : null; }
        }
        public class EntityPropertyRegisterDatetimeSetupper : EntityPropertySetupper<VdSynonymProduct> {
            public void Setup(VdSynonymProduct entity, Object value) { entity.RegisterDatetime = (value != null) ? (DateTime?)value : null; }
        }
        public class EntityPropertyRegisterUserSetupper : EntityPropertySetupper<VdSynonymProduct> {
            public void Setup(VdSynonymProduct entity, Object value) { entity.RegisterUser = (value != null) ? (String)value : null; }
        }
        public class EntityPropertyRegisterProcessSetupper : EntityPropertySetupper<VdSynonymProduct> {
            public void Setup(VdSynonymProduct entity, Object value) { entity.RegisterProcess = (value != null) ? (String)value : null; }
        }
        public class EntityPropertyUpdateDatetimeSetupper : EntityPropertySetupper<VdSynonymProduct> {
            public void Setup(VdSynonymProduct entity, Object value) { entity.UpdateDatetime = (value != null) ? (DateTime?)value : null; }
        }
        public class EntityPropertyUpdateUserSetupper : EntityPropertySetupper<VdSynonymProduct> {
            public void Setup(VdSynonymProduct entity, Object value) { entity.UpdateUser = (value != null) ? (String)value : null; }
        }
        public class EntityPropertyUpdateProcessSetupper : EntityPropertySetupper<VdSynonymProduct> {
            public void Setup(VdSynonymProduct entity, Object value) { entity.UpdateProcess = (value != null) ? (String)value : null; }
        }
        public class EntityPropertyVersionNoSetupper : EntityPropertySetupper<VdSynonymProduct> {
            public void Setup(VdSynonymProduct entity, Object value) { entity.VersionNo = (value != null) ? (long?)value : null; }
        }
    }
}
