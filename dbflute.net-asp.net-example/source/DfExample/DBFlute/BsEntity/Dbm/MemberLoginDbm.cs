...
namespace DfExample.DBFlute.BsEntity.Dbm {
    ...
    public class MemberLoginDbm : AbstractDBMeta {
        ...
        public override String SequenceName { get { return "SEQ_MEMBER_LOGIN"; } }
        public override String SequenceNextValSql { get { return "select SEQ_MEMBER_LOGIN.nextval from dual"; } }
        ...
        public class EntityPropertyMemberIdSetupper : EntityPropertySetupper<MemberLogin> {
            public void Setup(MemberLogin entity, Object value) { entity.MemberId = (value != null) ? (long?)value : null; }
        }
