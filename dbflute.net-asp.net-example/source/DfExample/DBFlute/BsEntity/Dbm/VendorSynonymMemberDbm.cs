...
namespace DfExample.DBFlute.BsEntity.Dbm {
    ...
    public class VendorSynonymMemberDbm : AbstractDBMeta {

        public static readonly Type ENTITY_TYPE = typeof(VendorSynonymMember);

        private static readonly VendorSynonymMemberDbm _instance = new VendorSynonymMemberDbm();
        private VendorSynonymMemberDbm() {
            InitializeColumnInfo();
            InitializeColumnInfoList();
            InitializeEntityPropertySetupper();
        }
        public static VendorSynonymMemberDbm GetInstance() {
            return _instance;
        }
        ...
        public override String TablePropertyName { get { return "VendorSynonymMember"; } }
        public override String TableSqlName { get { return "VENDOR_SYNONYM_MEMBER"; } }
        ...
        //                                             Table
        //                                             -----
        public static readonly String TABLE_DB_NAME = "VENDOR_SYNONYM_MEMBER";
        public static readonly String TABLE_PROPERTY_NAME = "VendorSynonymMember";
        ...
        //                                                                       Type Name
        //                                                                       =========
        public override String EntityTypeName { get { return "DfExample.DBFlute.ExEntity.VendorSynonymMember"; } }
        public override String DaoTypeName { get { return "DfExample.DBFlute.ExDao.VendorSynonymMemberDao"; } }
        public override String ConditionBeanTypeName { get { return "DfExample.DBFlute.CBean.VendorSynonymMemberCB"; } }
        public override String BehaviorTypeName { get { return "DfExample.DBFlute.ExBhv.VendorSynonymMemberBhv"; } }
        ...
        //                                                           =====================
        protected Map<String, EntityPropertySetupper<VendorSynonymMember>> _entityPropertySetupperMap = new LinkedHashMap<String, EntityPropertySetupper<VendorSynonymMember>>();
        ...
        public override void SetupEntityProperty(String propertyName, Object entity, Object value) {
            EntityPropertySetupper<VendorSynonymMember> callback = _entityPropertySetupperMap.get(propertyName);
            callback.Setup((VendorSynonymMember)entity, value);
        }

        public class EntityPropertyMemberIdSetupper : EntityPropertySetupper<VendorSynonymMember> {
            public void Setup(VendorSynonymMember entity, Object value) { entity.MemberId = (value != null) ? (long?)value : null; }
        }
        public class EntityPropertyMemberNameSetupper : EntityPropertySetupper<VendorSynonymMember> {
            public void Setup(VendorSynonymMember entity, Object value) { entity.MemberName = (value != null) ? (String)value : null; }
        }
        public class EntityPropertyMemberAccountSetupper : EntityPropertySetupper<VendorSynonymMember> {
            public void Setup(VendorSynonymMember entity, Object value) { entity.MemberAccount = (value != null) ? (String)value : null; }
        }
        public class EntityPropertyMemberStatusCodeSetupper : EntityPropertySetupper<VendorSynonymMember> {
            public void Setup(VendorSynonymMember entity, Object value) { entity.MemberStatusCode = (value != null) ? (String)value : null; }
        }
        public class EntityPropertyFormalizedDatetimeSetupper : EntityPropertySetupper<VendorSynonymMember> {
            public void Setup(VendorSynonymMember entity, Object value) { entity.FormalizedDatetime = (value != null) ? (DateTime?)value : null; }
        }
        public class EntityPropertyBirthdateSetupper : EntityPropertySetupper<VendorSynonymMember> {
            public void Setup(VendorSynonymMember entity, Object value) { entity.Birthdate = (value != null) ? (DateTime?)value : null; }
        }
        public class EntityPropertyRegisterDatetimeSetupper : EntityPropertySetupper<VendorSynonymMember> {
            public void Setup(VendorSynonymMember entity, Object value) { entity.RegisterDatetime = (value != null) ? (DateTime?)value : null; }
        }
        public class EntityPropertyRegisterUserSetupper : EntityPropertySetupper<VendorSynonymMember> {
            public void Setup(VendorSynonymMember entity, Object value) { entity.RegisterUser = (value != null) ? (String)value : null; }
        }
        public class EntityPropertyRegisterProcessSetupper : EntityPropertySetupper<VendorSynonymMember> {
            public void Setup(VendorSynonymMember entity, Object value) { entity.RegisterProcess = (value != null) ? (String)value : null; }
        }
        public class EntityPropertyUpdateDatetimeSetupper : EntityPropertySetupper<VendorSynonymMember> {
            public void Setup(VendorSynonymMember entity, Object value) { entity.UpdateDatetime = (value != null) ? (DateTime?)value : null; }
        }
        public class EntityPropertyUpdateUserSetupper : EntityPropertySetupper<VendorSynonymMember> {
            public void Setup(VendorSynonymMember entity, Object value) { entity.UpdateUser = (value != null) ? (String)value : null; }
        }
        public class EntityPropertyUpdateProcessSetupper : EntityPropertySetupper<VendorSynonymMember> {
            public void Setup(VendorSynonymMember entity, Object value) { entity.UpdateProcess = (value != null) ? (String)value : null; }
        }
        public class EntityPropertyVersionNoSetupper : EntityPropertySetupper<VendorSynonymMember> {
            public void Setup(VendorSynonymMember entity, Object value) { entity.VersionNo = (value != null) ? (long?)value : null; }
        }
    }
}
