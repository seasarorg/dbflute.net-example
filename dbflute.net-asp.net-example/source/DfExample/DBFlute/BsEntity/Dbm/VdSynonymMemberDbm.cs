...
namespace DfExample.DBFlute.BsEntity.Dbm {
    ...
    public class VdSynonymMemberDbm : AbstractDBMeta {

        public static readonly Type ENTITY_TYPE = typeof(VdSynonymMember);

        private static readonly VdSynonymMemberDbm _instance = new VdSynonymMemberDbm();
        private VdSynonymMemberDbm() {
            InitializeColumnInfo();
            InitializeColumnInfoList();
            InitializeEntityPropertySetupper();
        }
        public static VdSynonymMemberDbm GetInstance() {
            return _instance;
        }
        ...
        public override String TablePropertyName { get { return "VdSynonymMember"; } }
        public override String TableSqlName { get { return "VD_SYNONYM_MEMBER"; } }
        ...
        //                                             Table
        //                                             -----
        public static readonly String TABLE_DB_NAME = "VD_SYNONYM_MEMBER";
        public static readonly String TABLE_PROPERTY_NAME = "VdSynonymMember";
        ...
        //                                                                       Type Name
        //                                                                       =========
        public override String EntityTypeName { get { return "DfExample.DBFlute.ExEntity.VdSynonymMember"; } }
        public override String DaoTypeName { get { return "DfExample.DBFlute.ExDao.VdSynonymMemberDao"; } }
        public override String ConditionBeanTypeName { get { return "DfExample.DBFlute.CBean.VdSynonymMemberCB"; } }
        public override String BehaviorTypeName { get { return "DfExample.DBFlute.ExBhv.VdSynonymMemberBhv"; } }
        ...
        public VdSynonymMember NewMyEntity() { return new VdSynonymMember(); }
        public override ConditionBean NewConditionBean() { return NewMyConditionBean(); }
        public VdSynonymMemberCB NewMyConditionBean() { return new VdSynonymMemberCB(); }

        // ===============================================================================
        //                                                           Entity Property Setup
        //                                                           =====================
        protected Map<String, EntityPropertySetupper<VdSynonymMember>> _entityPropertySetupperMap = new LinkedHashMap<String, EntityPropertySetupper<VdSynonymMember>>();
        ...
        public override void SetupEntityProperty(String propertyName, Object entity, Object value) {
            EntityPropertySetupper<VdSynonymMember> callback = _entityPropertySetupperMap.get(propertyName);
            callback.Setup((VdSynonymMember)entity, value);
        }

        public class EntityPropertyMemberIdSetupper : EntityPropertySetupper<VdSynonymMember> {
            public void Setup(VdSynonymMember entity, Object value) { entity.MemberId = (value != null) ? (long?)value : null; }
        }
        public class EntityPropertyMemberNameSetupper : EntityPropertySetupper<VdSynonymMember> {
            public void Setup(VdSynonymMember entity, Object value) { entity.MemberName = (value != null) ? (String)value : null; }
        }
        public class EntityPropertyMemberAccountSetupper : EntityPropertySetupper<VdSynonymMember> {
            public void Setup(VdSynonymMember entity, Object value) { entity.MemberAccount = (value != null) ? (String)value : null; }
        }
        public class EntityPropertyMemberStatusCodeSetupper : EntityPropertySetupper<VdSynonymMember> {
            public void Setup(VdSynonymMember entity, Object value) { entity.MemberStatusCode = (value != null) ? (String)value : null; }
        }
        public class EntityPropertyFormalizedDatetimeSetupper : EntityPropertySetupper<VdSynonymMember> {
            public void Setup(VdSynonymMember entity, Object value) { entity.FormalizedDatetime = (value != null) ? (DateTime?)value : null; }
        }
        public class EntityPropertyBirthdateSetupper : EntityPropertySetupper<VdSynonymMember> {
            public void Setup(VdSynonymMember entity, Object value) { entity.Birthdate = (value != null) ? (DateTime?)value : null; }
        }
        public class EntityPropertyRegisterDatetimeSetupper : EntityPropertySetupper<VdSynonymMember> {
            public void Setup(VdSynonymMember entity, Object value) { entity.RegisterDatetime = (value != null) ? (DateTime?)value : null; }
        }
        public class EntityPropertyRegisterUserSetupper : EntityPropertySetupper<VdSynonymMember> {
            public void Setup(VdSynonymMember entity, Object value) { entity.RegisterUser = (value != null) ? (String)value : null; }
        }
        public class EntityPropertyRegisterProcessSetupper : EntityPropertySetupper<VdSynonymMember> {
            public void Setup(VdSynonymMember entity, Object value) { entity.RegisterProcess = (value != null) ? (String)value : null; }
        }
        public class EntityPropertyUpdateDatetimeSetupper : EntityPropertySetupper<VdSynonymMember> {
            public void Setup(VdSynonymMember entity, Object value) { entity.UpdateDatetime = (value != null) ? (DateTime?)value : null; }
        }
        public class EntityPropertyUpdateUserSetupper : EntityPropertySetupper<VdSynonymMember> {
            public void Setup(VdSynonymMember entity, Object value) { entity.UpdateUser = (value != null) ? (String)value : null; }
        }
        public class EntityPropertyUpdateProcessSetupper : EntityPropertySetupper<VdSynonymMember> {
            public void Setup(VdSynonymMember entity, Object value) { entity.UpdateProcess = (value != null) ? (String)value : null; }
        }
        public class EntityPropertyVersionNoSetupper : EntityPropertySetupper<VdSynonymMember> {
            public void Setup(VdSynonymMember entity, Object value) { entity.VersionNo = (value != null) ? (long?)value : null; }
        }
    }
}
