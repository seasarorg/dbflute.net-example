...
namespace DfExample.DBFlute.BsEntity.Dbm {
    ...
    public class MemberAddressDbm : AbstractDBMeta {
        ...
        protected void InitializeColumnInfo() {
            _columnMemberAddressId = cci("MEMBER_ADDRESS_ID", "MEMBER_ADDRESS_ID", null, null, true, "MemberAddressId", typeof(long?), true, "NUMBER", 16, 0, false, OptimisticLockType.NONE, null, null, null);
            ...
            _columnValidBeginDate = cci("VALID_BEGIN_DATE", "VALID_BEGIN_DATE", null, null, true, "ValidBeginDate", typeof(DateTime?), false, "DATE", 7, 0, false, OptimisticLockType.NONE, null, null, null);
            _columnValidEndDate = cci("VALID_END_DATE", "VALID_END_DATE", null, null, true, "ValidEndDate", typeof(DateTime?), false, "DATE", 7, 0, false, OptimisticLockType.NONE, null, null, null);
            _columnAddress = cci("ADDRESS", "ADDRESS", null, null, true, "Address", typeof(String), false, "VARCHAR2", 200, 0, false, OptimisticLockType.NONE, null, null, null);
        ...
        public class EntityPropertyMemberAddressIdSetupper : EntityPropertySetupper<MemberAddress> {
            public void Setup(MemberAddress entity, Object value) { entity.MemberAddressId = (value != null) ? (long?)value : null; }
        }
        public class EntityPropertyMemberIdSetupper : EntityPropertySetupper<MemberAddress> {
            public void Setup(MemberAddress entity, Object value) { entity.MemberId = (value != null) ? (long?)value : null; }
        }
