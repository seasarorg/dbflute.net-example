...
namespace DfExample.DBFlute.BsEntity.Dbm {
    ...
    public class MemberDbm : AbstractDBMeta {
        ...
        protected void InitializeColumnInfo() {
            _columnMemberId = cci("MEMBER_ID", "MEMBER_ID", null, "会員ID", true, "MemberId", typeof(long?), true, "NUMBER", 16, 0, false, OptimisticLockType.NONE, "連番", "memberLoginAsLatest,memberSecurityAsOne,memberWithdrawalAsOne", "memberAddressList,memberLoginList,purchaseList");
        ...
        public ForeignInfo ForeignMemberSecurityAsOne { get {
            ...
            return cfi("MemberSecurityAsOne", this, MemberSecurityDbm.GetInstance(), map, 2, true, false);
        }}
        public ForeignInfo ForeignMemberWithdrawalAsOne { get {
            Map<ColumnInfo, ColumnInfo> map = new LinkedHashMap<ColumnInfo, ColumnInfo>();
            map.put(ColumnMemberId, MemberWithdrawalDbm.GetInstance().ColumnMemberId);
            return cfi("MemberWithdrawalAsOne", this, MemberWithdrawalDbm.GetInstance(), map, 3, true, false);
        }}
        ...
        public override String SequenceName { get { return "SEQ_MEMBER"; } }
        public override String SequenceNextValSql { get { return "select SEQ_MEMBER.nextval from dual"; } }
        ...
        public class EntityPropertyMemberIdSetupper : EntityPropertySetupper<Member> {
            public void Setup(Member entity, Object value) { entity.MemberId = (value != null) ? (long?)value : null; }
        }
