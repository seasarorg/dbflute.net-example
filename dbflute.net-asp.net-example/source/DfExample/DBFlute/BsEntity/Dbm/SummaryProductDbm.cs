...
namespace DfExample.DBFlute.BsEntity.Dbm {
    ...
    public class SummaryProductDbm : AbstractDBMeta {
        ...
        protected void InitializeColumnInfo() {
            _columnProductId = cci("PRODUCT_ID", "PRODUCT_ID", null, null, true, "ProductId", typeof(long?), false, "NUMBER", 16, 0, false, OptimisticLockType.NONE, null, null, null);
        ...
        public class EntityPropertyProductIdSetupper : EntityPropertySetupper<SummaryProduct> {
            public void Setup(SummaryProduct entity, Object value) { entity.ProductId = (value != null) ? (long?)value : null; }
        }
