...
namespace DfExample.DBFlute.BsEntity.Dbm {
    ...
    public class MemberSecurityDbm : AbstractDBMeta {
        ...
        protected void InitializeColumnInfo() {
            _columnMemberId = cci("MEMBER_ID", "MEMBER_ID", null, null, true, "MemberId", typeof(long?), true, "NUMBER", 16, 0, false, OptimisticLockType.NONE, null, "member", null);
            _columnLoginPassword = cci("LOGIN_PASSWORD", "LOGIN_PASSWORD", null, null, true, "LoginPassword", typeof(String), false, "VARCHAR2", 50, 0, false, OptimisticLockType.NONE, null, null, null);
            _columnReminderQuestion = cci("REMINDER_QUESTION", "REMINDER_QUESTION", null, null, true, "ReminderQuestion", typeof(String), false, "VARCHAR2", 50, 0, false, OptimisticLockType.NONE, null, null, null);
            _columnReminderAnswer = cci("REMINDER_ANSWER", "REMINDER_ANSWER", null, null, true, "ReminderAnswer", typeof(String), false, "VARCHAR2", 50, 0, false, OptimisticLockType.NONE, null, null, null);
        ...
        public class EntityPropertyMemberIdSetupper : EntityPropertySetupper<MemberSecurity> {
            public void Setup(MemberSecurity entity, Object value) { entity.MemberId = (value != null) ? (long?)value : null; }
        }
