...
namespace DfExample.DBFlute.ExEntity {
    ...
    public partial class MemberSecurity : EntityDefinedCommonColumn {
        ...
        //                                                                       =========
        #region Attribute
        /// <summary>MEMBER_ID: {PK, NotNull, NUMBER(16), FK to MEMBER}</summary>
        protected long? _memberId;

        /// <summary>LOGIN_PASSWORD: {NotNull, VARCHAR2(50)}</summary>
        protected String _loginPassword;

        /// <summary>REMINDER_QUESTION: {NotNull, VARCHAR2(50)}</summary>
        protected String _reminderQuestion;

        /// <summary>REMINDER_ANSWER: {NotNull, VARCHAR2(50)}</summary>
