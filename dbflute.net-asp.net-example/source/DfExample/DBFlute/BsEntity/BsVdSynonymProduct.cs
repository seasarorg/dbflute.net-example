...
namespace DfExample.DBFlute.ExEntity {
    ...
    /// <summary>
    /// The entity of (商品)VD_SYNONYM_PRODUCT as SYNONYM. (partial class for auto-generation)
    /// <![CDATA[
    /// [primary-key]
    ///     PRODUCT_ID
    /// 
    ...
    /// 
    /// [foreign-table]
    ///     VD_SYNONYM_PRODUCT_STATUS
    /// 
    /// [referrer-table]
    ///     
    /// 
    /// [foreign-property]
    ///     vdSynonymProductStatus
    /// 
    /// [referrer-property]
    ///     
    /// ]]>
    ...
    /// </summary>
    [Seasar.Dao.Attrs.Table("VD_SYNONYM_PRODUCT")]
    [Seasar.Dao.Attrs.VersionNoProperty("VersionNo")]
    [System.Serializable]
    public partial class VdSynonymProduct : EntityDefinedCommonColumn {
        ...
        /// <summary>PRODUCT_STATUS_CODE: {NotNull, CHAR(3), FK to VD_SYNONYM_PRODUCT_STATUS}</summary>
        ...
        //                                                                      Table Name
        //                                                                      ==========
        public String TableDbName { get { return "VD_SYNONYM_PRODUCT"; } }
        public String TablePropertyName { get { return "VdSynonymProduct"; } }
        ...
        protected VdSynonymProductStatus _vdSynonymProductStatus;

        /// <summary>VD_SYNONYM_PRODUCT_STATUS as 'VdSynonymProductStatus'.</summary>
        [Seasar.Dao.Attrs.Relno(0), Seasar.Dao.Attrs.Relkeys("PRODUCT_STATUS_CODE:PRODUCT_STATUS_CODE")]
        public VdSynonymProductStatus VdSynonymProductStatus {
            get { return _vdSynonymProductStatus; }
            set { _vdSynonymProductStatus = value; }
        }
        ...
        public override bool Equals(Object other) {
            if (other == null || !(other is VdSynonymProduct)) { return false; }
            VdSynonymProduct otherEntity = (VdSynonymProduct)other;
        ...
        public override String ToString() {
            return "VdSynonymProduct:" + BuildColumnString() + BuildRelationString();
        }
        ...
        public virtual String ToStringWithRelation() {
            ...
            { sb.Append(l).Append(xbRDS(_vdSynonymProductStatus, "VdSynonymProductStatus")); }
            return sb.ToString();
        }
        ...
        protected virtual String BuildRelationString() {
            StringBuilder sb = new StringBuilder();
            String c = ",";
            if (_vdSynonymProductStatus != null) { sb.Append(c).Append("VdSynonymProductStatus"); }
