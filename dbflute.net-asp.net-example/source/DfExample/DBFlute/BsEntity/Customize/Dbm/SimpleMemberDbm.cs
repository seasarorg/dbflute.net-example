...
namespace DfExample.DBFlute.BsEntity.Customize.Dbm {
    ...
    public class SimpleMemberDbm : AbstractDBMeta {

        public static readonly Type ENTITY_TYPE = typeof(SimpleMember);

        private static readonly SimpleMemberDbm _instance = new SimpleMemberDbm();
        private SimpleMemberDbm() {
            InitializeColumnInfo();
            InitializeColumnInfoList();
            InitializeEntityPropertySetupper();
        }
        public static SimpleMemberDbm GetInstance() {
            return _instance;
        }
        ...
        //                                                                      Table Info
        //                                                                      ==========
        public override String TableDbName { get { return "SimpleMember"; } }
        public override String TablePropertyName { get { return "SimpleMember"; } }
        public override String TableSqlName { get { return "SimpleMember"; } }
        ...
        //                                             Table
        //                                             -----
        public static readonly String TABLE_DB_NAME = "SimpleMember";
        public static readonly String TABLE_PROPERTY_NAME = "SimpleMember";
        ...
        //                                                                       Type Name
        //                                                                       =========
        public override String EntityTypeName { get { return "DfExample.DBFlute.ExEntity.Customize.SimpleMember"; } }
        ...
        //                                                           =====================
        protected Map<String, EntityPropertySetupper<SimpleMember>> _entityPropertySetupperMap = new LinkedHashMap<String, EntityPropertySetupper<SimpleMember>>();
        ...
        public override void SetupEntityProperty(String propertyName, Object entity, Object value) {
            EntityPropertySetupper<SimpleMember> callback = _entityPropertySetupperMap.get(propertyName);
            callback.Setup((SimpleMember)entity, value);
        }

        public class EntityPropertyMemberIdSetupper : EntityPropertySetupper<SimpleMember> {
            public void Setup(SimpleMember entity, Object value) { entity.MemberId = (value != null) ? (long?)value : null; }
        }
        public class EntityPropertyMemberNameSetupper : EntityPropertySetupper<SimpleMember> {
            public void Setup(SimpleMember entity, Object value) { entity.MemberName = (value != null) ? (String)value : null; }
        }
        public class EntityPropertyMemberStatusNameSetupper : EntityPropertySetupper<SimpleMember> {
            public void Setup(SimpleMember entity, Object value) { entity.MemberStatusName = (value != null) ? (String)value : null; }
        }
    }
}
