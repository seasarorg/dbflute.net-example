...
namespace DfExample.DBFlute.ExEntity {
    ...
    /// <summary>
    /// The entity of (会員)VD_SYNONYM_MEMBER as SYNONYM. (partial class for auto-generation)
    /// <![CDATA[
    /// 会員登録時にInsertされる。
    /// 物理削除されることはない
    /// 
    ...
    /// </summary>
    [Seasar.Dao.Attrs.Table("VD_SYNONYM_MEMBER")]
    [Seasar.Dao.Attrs.VersionNoProperty("VersionNo")]
    [System.Serializable]
    public partial class VdSynonymMember : EntityDefinedCommonColumn {
        ...
        //                                                                      Table Name
        //                                                                      ==========
        public String TableDbName { get { return "VD_SYNONYM_MEMBER"; } }
        public String TablePropertyName { get { return "VdSynonymMember"; } }
        ...
        public override bool Equals(Object other) {
            if (other == null || !(other is VdSynonymMember)) { return false; }
            VdSynonymMember otherEntity = (VdSynonymMember)other;
        ...
        public override String ToString() {
            return "VdSynonymMember:" + BuildColumnString() + BuildRelationString();
        }
