...
namespace DfExample.DBFlute.ExEntity {
    ...
    /// <summary>
    /// The entity of (会員)MEMBER_VENDOR_SYNONYM as SYNONYM. (partial class for auto-generation)
    /// <![CDATA[
    /// 会員登録時にInsertされる。
    /// 物理削除されることはない
    /// 
    ...
    /// </summary>
    [Seasar.Dao.Attrs.Table("MEMBER_VENDOR_SYNONYM")]
    [Seasar.Dao.Attrs.VersionNoProperty("VersionNo")]
    [System.Serializable]
    public partial class MemberVendorSynonym : EntityDefinedCommonColumn {
        ...
        //                                                                      Table Name
        //                                                                      ==========
        public String TableDbName { get { return "MEMBER_VENDOR_SYNONYM"; } }
        public String TablePropertyName { get { return "MemberVendorSynonym"; } }
        ...
        public override bool Equals(Object other) {
            if (other == null || !(other is MemberVendorSynonym)) { return false; }
            MemberVendorSynonym otherEntity = (MemberVendorSynonym)other;
        ...
        public override String ToString() {
            return "MemberVendorSynonym:" + BuildColumnString() + BuildRelationString();
        }
