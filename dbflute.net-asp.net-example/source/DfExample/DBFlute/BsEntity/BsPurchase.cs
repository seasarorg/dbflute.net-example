...
namespace DfExample.DBFlute.ExEntity {
    ...
    public partial class Purchase : EntityDefinedCommonColumn {
        ...
        //                                                                       =========
        #region Attribute
        /// <summary>PURCHASE_ID: {PK, NotNull, NUMBER(16)}</summary>
        protected long? _purchaseId;

        /// <summary>MEMBER_ID: {UQ, IX+, NotNull, NUMBER(16), FK to MEMBER}</summary>
        protected long? _memberId;

        /// <summary>PRODUCT_ID: {UQ+, IX, NotNull, NUMBER(16), FK to PRODUCT}</summary>
        protected long? _productId;

        /// <summary>PURCHASE_DATETIME: {UQ+, IX, NotNull, DATE(7)}</summary>
        protected DateTime? _purchaseDatetime;

        /// <summary>PURCHASE_COUNT: {NotNull, NUMBER(16)}</summary>
        protected long? _purchaseCount;

        /// <summary>PURCHASE_PRICE: {IX, NotNull, NUMBER(16)}</summary>
        protected long? _purchasePrice;

        /// <summary>PAYMENT_COMPLETE_FLG: {NotNull, NUMBER(1), classification=Flg}</summary>
        ...
        /// <summary>(商品)PRODUCT as 'Product'.</summary>
