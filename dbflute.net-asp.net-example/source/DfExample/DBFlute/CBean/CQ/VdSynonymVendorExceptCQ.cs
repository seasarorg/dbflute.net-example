...
namespace DfExample.DBFlute.CBean.CQ {
    ...
    [System.Serializable]
    public class VdSynonymVendorExceptCQ : BsVdSynonymVendorExceptCQ {
        ...
        public VdSynonymVendorExceptCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
