...
namespace DfExample.DBFlute.CBean.CQ.BS {
    ...
    [System.Serializable]
    public abstract class AbstractBsMemberVendorSynonymCQ : AbstractConditionQuery {
        ...
        public override String getTableDbName() { return "MEMBER_VENDOR_SYNONYM"; }
        public override String getTableSqlName() { return "MEMBER_VENDOR_SYNONYM"; }
        ...
        //                                                                    Scalar Condition
        //                                                                    ================
        public SSQFunction<MemberVendorSynonymCB> Scalar_Equal() {
            return xcreateSSQFunction("=");
        }

        public SSQFunction<MemberVendorSynonymCB> Scalar_NotEqual() {
            return xcreateSSQFunction("<>");
        }

        public SSQFunction<MemberVendorSynonymCB> Scalar_GreaterEqual() {
            return xcreateSSQFunction(">=");
        }

        public SSQFunction<MemberVendorSynonymCB> Scalar_GreaterThan() {
            return xcreateSSQFunction(">");
        }

        public SSQFunction<MemberVendorSynonymCB> Scalar_LessEqual() {
            return xcreateSSQFunction("<=");
        }

        public SSQFunction<MemberVendorSynonymCB> Scalar_LessThan() {
            return xcreateSSQFunction("<");
        }

        protected SSQFunction<MemberVendorSynonymCB> xcreateSSQFunction(String operand) {
            return new SSQFunction<MemberVendorSynonymCB>(delegate(String function, SubQuery<MemberVendorSynonymCB> subQuery) {
                xscalarSubQuery(function, subQuery, operand);
            });
        }

        protected void xscalarSubQuery(String function, SubQuery<MemberVendorSynonymCB> subQuery, String operand) {
            assertObjectNotNull("subQuery<MemberVendorSynonymCB>", subQuery);
            MemberVendorSynonymCB cb = new MemberVendorSynonymCB(); cb.xsetupForScalarCondition(this); subQuery.Invoke(cb);
            String subQueryPropertyName = keepScalarSubQuery(cb.Query()); // for saving query-value.
            registerScalarSubQuery(function, cb.Query(), subQueryPropertyName, operand);
        }
        public abstract String keepScalarSubQuery(MemberVendorSynonymCQ subQuery);
        ...
        public abstract String keepMyselfInScopeSubQuery(MemberVendorSynonymCQ subQuery);
