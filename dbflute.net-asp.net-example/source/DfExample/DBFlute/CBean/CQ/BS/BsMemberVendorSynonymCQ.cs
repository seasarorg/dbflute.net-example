...
namespace DfExample.DBFlute.CBean.CQ.BS {
    ...
    [System.Serializable]
    public class BsMemberVendorSynonymCQ : AbstractBsMemberVendorSynonymCQ {
        ...
        public MemberVendorSynonymCIQ Inline() {
            if (_inlineQuery == null) {
                _inlineQuery = new MemberVendorSynonymCIQ(xgetReferrerQuery(), xgetSqlClause(), xgetAliasName(), xgetNestLevel(), this);
            }
        ...
        public MemberVendorSynonymCIQ On() {
            ...
            MemberVendorSynonymCIQ inlineQuery = Inline();
        ...
        protected String resolveNextRelationPathMemberStatus() {
            return resolveNextRelationPath("MEMBER_VENDOR_SYNONYM", "memberStatus");
        }
        ...
        protected String resolveNextRelationPathVdSynonymMemberWithdrawalAsOne() {
            return resolveNextRelationPath("MEMBER_VENDOR_SYNONYM", "vdSynonymMemberWithdrawalAsOne");
        }
	    ...
	    //                                                                 Scalar SubQuery
	    //                                                                 ===============
	    protected Map<String, MemberVendorSynonymCQ> _scalarSubQueryMap;
	    public Map<String, MemberVendorSynonymCQ> ScalarSubQuery { get { return _scalarSubQueryMap; } }
	    public override String keepScalarSubQuery(MemberVendorSynonymCQ subQuery) {
	        if (_scalarSubQueryMap == null) { _scalarSubQueryMap = new LinkedHashMap<String, MemberVendorSynonymCQ>(); }
        ...
        //                                                         =======================
        protected Map<String, MemberVendorSynonymCQ> _myselfInScopeSubQueryMap;
        public Map<String, MemberVendorSynonymCQ> MyselfInScopeSubQuery { get { return _myselfInScopeSubQueryMap; } }
        public override String keepMyselfInScopeSubQuery(MemberVendorSynonymCQ subQuery) {
            if (_myselfInScopeSubQueryMap == null) { _myselfInScopeSubQueryMap = new LinkedHashMap<String, MemberVendorSynonymCQ>(); }
