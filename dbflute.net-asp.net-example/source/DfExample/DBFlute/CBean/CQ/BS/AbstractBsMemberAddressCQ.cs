...
namespace DfExample.DBFlute.CBean.CQ.BS {
    ...
    public abstract class AbstractBsMemberAddressCQ : AbstractConditionQuery {
        ...
        public void SetMemberAddressId_Equal(long? v) { regMemberAddressId(CK_EQ, v); }
        public void SetMemberAddressId_GreaterThan(long? v) { regMemberAddressId(CK_GT, v); }
        public void SetMemberAddressId_LessThan(long? v) { regMemberAddressId(CK_LT, v); }
        public void SetMemberAddressId_GreaterEqual(long? v) { regMemberAddressId(CK_GE, v); }
        public void SetMemberAddressId_LessEqual(long? v) { regMemberAddressId(CK_LE, v); }
        public void SetMemberAddressId_InScope(IList<long?> ls) { regINS<long?>(CK_INS, cTL<long?>(ls), getCValueMemberAddressId(), "MEMBER_ADDRESS_ID"); }
        public void SetMemberAddressId_NotInScope(IList<long?> ls) { regINS<long?>(CK_NINS, cTL<long?>(ls), getCValueMemberAddressId(), "MEMBER_ADDRESS_ID"); }
