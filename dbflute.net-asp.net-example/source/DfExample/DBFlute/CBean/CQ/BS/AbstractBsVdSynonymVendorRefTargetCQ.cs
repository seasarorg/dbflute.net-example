...
namespace DfExample.DBFlute.CBean.CQ.BS {
    ...
    [System.Serializable]
    public abstract class AbstractBsVdSynonymVendorRefTargetCQ : AbstractConditionQuery {

        public AbstractBsVdSynonymVendorRefTargetCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
            : base(childQuery, sqlClause, aliasName, nestLevel) {}

        public override String getTableDbName() { return "VD_SYNONYM_VENDOR_REF_TARGET"; }
        public override String getTableSqlName() { return "VD_SYNONYM_VENDOR_REF_TARGET"; }
        ...
        public void InScopeVdSynonymVendorTarget(SubQuery<VdSynonymVendorTargetCB> subQuery) {
            ...
            String subQueryPropertyName = keepVendorTargetId_InScopeSubQuery_VdSynonymVendorTarget(cb.Query());
            registerInScopeSubQuery(cb.Query(), "VENDOR_TARGET_ID", "VENDOR_TARGET_ID", subQueryPropertyName);
        }
        public abstract String keepVendorTargetId_InScopeSubQuery_VdSynonymVendorTarget(VdSynonymVendorTargetCQ subQuery);
        public void NotInScopeVdSynonymVendorTarget(SubQuery<VdSynonymVendorTargetCB> subQuery) {
            assertObjectNotNull("subQuery<VdSynonymVendorTargetCB>", subQuery);
            VdSynonymVendorTargetCB cb = new VdSynonymVendorTargetCB(); cb.xsetupForInScopeRelation(this); subQuery.Invoke(cb);
            String subQueryPropertyName = keepVendorTargetId_NotInScopeSubQuery_VdSynonymVendorTarget(cb.Query());
            registerNotInScopeSubQuery(cb.Query(), "VENDOR_TARGET_ID", "VENDOR_TARGET_ID", subQueryPropertyName);
        }
        public abstract String keepVendorTargetId_NotInScopeSubQuery_VdSynonymVendorTarget(VdSynonymVendorTargetCQ subQuery);
        ...
        //                                                                    Scalar Condition
        //                                                                    ================
        public SSQFunction<VdSynonymVendorRefTargetCB> Scalar_Equal() {
            return xcreateSSQFunction("=");
        }

        public SSQFunction<VdSynonymVendorRefTargetCB> Scalar_NotEqual() {
            return xcreateSSQFunction("<>");
        }

        public SSQFunction<VdSynonymVendorRefTargetCB> Scalar_GreaterEqual() {
            return xcreateSSQFunction(">=");
        }

        public SSQFunction<VdSynonymVendorRefTargetCB> Scalar_GreaterThan() {
            return xcreateSSQFunction(">");
        }

        public SSQFunction<VdSynonymVendorRefTargetCB> Scalar_LessEqual() {
            return xcreateSSQFunction("<=");
        }

        public SSQFunction<VdSynonymVendorRefTargetCB> Scalar_LessThan() {
            return xcreateSSQFunction("<");
        }

        protected SSQFunction<VdSynonymVendorRefTargetCB> xcreateSSQFunction(String operand) {
            return new SSQFunction<VdSynonymVendorRefTargetCB>(delegate(String function, SubQuery<VdSynonymVendorRefTargetCB> subQuery) {
                xscalarSubQuery(function, subQuery, operand);
            });
        }

        protected void xscalarSubQuery(String function, SubQuery<VdSynonymVendorRefTargetCB> subQuery, String operand) {
            assertObjectNotNull("subQuery<VdSynonymVendorRefTargetCB>", subQuery);
            VdSynonymVendorRefTargetCB cb = new VdSynonymVendorRefTargetCB(); cb.xsetupForScalarCondition(this); subQuery.Invoke(cb);
            String subQueryPropertyName = keepScalarSubQuery(cb.Query()); // for saving query-value.
            registerScalarSubQuery(function, cb.Query(), subQueryPropertyName, operand);
        }
        public abstract String keepScalarSubQuery(VdSynonymVendorRefTargetCQ subQuery);

        // ===============================================================================
        //                                                                  MySelf InScope
        //                                                                  ==============
        public void MyselfInScope(SubQuery<VdSynonymVendorRefTargetCB> subQuery) {
            assertObjectNotNull("subQuery<VdSynonymVendorRefTargetCB>", subQuery);
        ...
        public abstract String keepMyselfInScopeSubQuery(VdSynonymVendorRefTargetCQ subQuery);
