...
namespace DfExample.DBFlute.CBean.CQ.BS {
    ...
    [System.Serializable]
    public abstract class AbstractBsVdSynonymMemberWithdrawalCQ : AbstractConditionQuery {

        public AbstractBsVdSynonymMemberWithdrawalCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
            : base(childQuery, sqlClause, aliasName, nestLevel) {}

        public override String getTableDbName() { return "VD_SYNONYM_MEMBER_WITHDRAWAL"; }
        public override String getTableSqlName() { return "VD_SYNONYM_MEMBER_WITHDRAWAL"; }
        ...
        public void InScopeMemberVendorSynonym(SubQuery<MemberVendorSynonymCB> subQuery) {
            ...
            String subQueryPropertyName = keepMemberId_InScopeSubQuery_MemberVendorSynonym(cb.Query());
            registerInScopeSubQuery(cb.Query(), "MEMBER_ID", "MEMBER_ID", subQueryPropertyName);
        }
        public abstract String keepMemberId_InScopeSubQuery_MemberVendorSynonym(MemberVendorSynonymCQ subQuery);
        public void NotInScopeMemberVendorSynonym(SubQuery<MemberVendorSynonymCB> subQuery) {
            assertObjectNotNull("subQuery<MemberVendorSynonymCB>", subQuery);
            MemberVendorSynonymCB cb = new MemberVendorSynonymCB(); cb.xsetupForInScopeRelation(this); subQuery.Invoke(cb);
            String subQueryPropertyName = keepMemberId_NotInScopeSubQuery_MemberVendorSynonym(cb.Query());
            registerNotInScopeSubQuery(cb.Query(), "MEMBER_ID", "MEMBER_ID", subQueryPropertyName);
        }
        public abstract String keepMemberId_NotInScopeSubQuery_MemberVendorSynonym(MemberVendorSynonymCQ subQuery);
        ...
        //                                                                    Scalar Condition
        //                                                                    ================
        public SSQFunction<VdSynonymMemberWithdrawalCB> Scalar_Equal() {
            return xcreateSSQFunction("=");
        }

        public SSQFunction<VdSynonymMemberWithdrawalCB> Scalar_NotEqual() {
            return xcreateSSQFunction("<>");
        }

        public SSQFunction<VdSynonymMemberWithdrawalCB> Scalar_GreaterEqual() {
            return xcreateSSQFunction(">=");
        }

        public SSQFunction<VdSynonymMemberWithdrawalCB> Scalar_GreaterThan() {
            return xcreateSSQFunction(">");
        }

        public SSQFunction<VdSynonymMemberWithdrawalCB> Scalar_LessEqual() {
            return xcreateSSQFunction("<=");
        }

        public SSQFunction<VdSynonymMemberWithdrawalCB> Scalar_LessThan() {
            return xcreateSSQFunction("<");
        }

        protected SSQFunction<VdSynonymMemberWithdrawalCB> xcreateSSQFunction(String operand) {
            return new SSQFunction<VdSynonymMemberWithdrawalCB>(delegate(String function, SubQuery<VdSynonymMemberWithdrawalCB> subQuery) {
                xscalarSubQuery(function, subQuery, operand);
            });
        }

        protected void xscalarSubQuery(String function, SubQuery<VdSynonymMemberWithdrawalCB> subQuery, String operand) {
            assertObjectNotNull("subQuery<VdSynonymMemberWithdrawalCB>", subQuery);
            VdSynonymMemberWithdrawalCB cb = new VdSynonymMemberWithdrawalCB(); cb.xsetupForScalarCondition(this); subQuery.Invoke(cb);
            String subQueryPropertyName = keepScalarSubQuery(cb.Query()); // for saving query-value.
            registerScalarSubQuery(function, cb.Query(), subQueryPropertyName, operand);
        }
        public abstract String keepScalarSubQuery(VdSynonymMemberWithdrawalCQ subQuery);

        // ===============================================================================
        //                                                                  MySelf InScope
        //                                                                  ==============
        public void MyselfInScope(SubQuery<VdSynonymMemberWithdrawalCB> subQuery) {
            assertObjectNotNull("subQuery<VdSynonymMemberWithdrawalCB>", subQuery);
        ...
        public abstract String keepMyselfInScopeSubQuery(VdSynonymMemberWithdrawalCQ subQuery);
