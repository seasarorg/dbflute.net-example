...
namespace DfExample.DBFlute.CBean.CQ.BS {
    ...
    public abstract class AbstractBsPurchaseCQ : AbstractConditionQuery {
        ...
        public void SetPurchaseCount_Equal(long? v) { regPurchaseCount(CK_EQ, v); }
        public void SetPurchaseCount_GreaterThan(long? v) { regPurchaseCount(CK_GT, v); }
        public void SetPurchaseCount_LessThan(long? v) { regPurchaseCount(CK_LT, v); }
        public void SetPurchaseCount_GreaterEqual(long? v) { regPurchaseCount(CK_GE, v); }
        public void SetPurchaseCount_LessEqual(long? v) { regPurchaseCount(CK_LE, v); }
        public void SetPurchaseCount_InScope(IList<long?> ls) { regINS<long?>(CK_INS, cTL<long?>(ls), getCValuePurchaseCount(), "PURCHASE_COUNT"); }
        public void SetPurchaseCount_NotInScope(IList<long?> ls) { regINS<long?>(CK_NINS, cTL<long?>(ls), getCValuePurchaseCount(), "PURCHASE_COUNT"); }
        ...
        public void SetPurchasePrice_Equal(long? v) { regPurchasePrice(CK_EQ, v); }
        public void SetPurchasePrice_GreaterThan(long? v) { regPurchasePrice(CK_GT, v); }
        public void SetPurchasePrice_LessThan(long? v) { regPurchasePrice(CK_LT, v); }
        public void SetPurchasePrice_GreaterEqual(long? v) { regPurchasePrice(CK_GE, v); }
        public void SetPurchasePrice_LessEqual(long? v) { regPurchasePrice(CK_LE, v); }
        public void SetPurchasePrice_InScope(IList<long?> ls) { regINS<long?>(CK_INS, cTL<long?>(ls), getCValuePurchasePrice(), "PURCHASE_PRICE"); }
        public void SetPurchasePrice_NotInScope(IList<long?> ls) { regINS<long?>(CK_NINS, cTL<long?>(ls), getCValuePurchasePrice(), "PURCHASE_PRICE"); }
