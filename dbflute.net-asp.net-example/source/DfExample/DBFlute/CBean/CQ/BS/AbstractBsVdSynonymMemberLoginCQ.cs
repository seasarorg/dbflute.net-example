...
namespace DfExample.DBFlute.CBean.CQ.BS {
    ...
    [System.Serializable]
    public abstract class AbstractBsVdSynonymMemberLoginCQ : AbstractConditionQuery {

        public AbstractBsVdSynonymMemberLoginCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
            : base(childQuery, sqlClause, aliasName, nestLevel) {}

        public override String getTableDbName() { return "VD_SYNONYM_MEMBER_LOGIN"; }
        public override String getTableSqlName() { return "VD_SYNONYM_MEMBER_LOGIN"; }
        ...
        //                                                                    Scalar Condition
        //                                                                    ================
        public SSQFunction<VdSynonymMemberLoginCB> Scalar_Equal() {
            return xcreateSSQFunction("=");
        }

        public SSQFunction<VdSynonymMemberLoginCB> Scalar_NotEqual() {
            return xcreateSSQFunction("<>");
        }

        public SSQFunction<VdSynonymMemberLoginCB> Scalar_GreaterEqual() {
            return xcreateSSQFunction(">=");
        }

        public SSQFunction<VdSynonymMemberLoginCB> Scalar_GreaterThan() {
            return xcreateSSQFunction(">");
        }

        public SSQFunction<VdSynonymMemberLoginCB> Scalar_LessEqual() {
            return xcreateSSQFunction("<=");
        }

        public SSQFunction<VdSynonymMemberLoginCB> Scalar_LessThan() {
            return xcreateSSQFunction("<");
        }

        protected SSQFunction<VdSynonymMemberLoginCB> xcreateSSQFunction(String operand) {
            return new SSQFunction<VdSynonymMemberLoginCB>(delegate(String function, SubQuery<VdSynonymMemberLoginCB> subQuery) {
                xscalarSubQuery(function, subQuery, operand);
            });
        }

        protected void xscalarSubQuery(String function, SubQuery<VdSynonymMemberLoginCB> subQuery, String operand) {
            assertObjectNotNull("subQuery<VdSynonymMemberLoginCB>", subQuery);
            VdSynonymMemberLoginCB cb = new VdSynonymMemberLoginCB(); cb.xsetupForScalarCondition(this); subQuery.Invoke(cb);
            String subQueryPropertyName = keepScalarSubQuery(cb.Query()); // for saving query-value.
            registerScalarSubQuery(function, cb.Query(), subQueryPropertyName, operand);
        }
        public abstract String keepScalarSubQuery(VdSynonymMemberLoginCQ subQuery);

        // ===============================================================================
        //                                                                  MySelf InScope
        //                                                                  ==============
        public void MyselfInScope(SubQuery<VdSynonymMemberLoginCB> subQuery) {
            assertObjectNotNull("subQuery<VdSynonymMemberLoginCB>", subQuery);
        ...
        public abstract String keepMyselfInScopeSubQuery(VdSynonymMemberLoginCQ subQuery);
