...
namespace DfExample.DBFlute.CBean.CQ.BS {
    ...
    [System.Serializable]
    public class BsVendorSynonymMemberCQ : AbstractBsVendorSynonymMemberCQ {
        ...
        public VendorSynonymMemberCIQ Inline() {
            if (_inlineQuery == null) {
                _inlineQuery = new VendorSynonymMemberCIQ(xgetReferrerQuery(), xgetSqlClause(), xgetAliasName(), xgetNestLevel(), this);
            }
        ...
        public VendorSynonymMemberCIQ On() {
            ...
            VendorSynonymMemberCIQ inlineQuery = Inline();
        ...
        protected String resolveNextRelationPathMemberStatus() {
            return resolveNextRelationPath("VENDOR_SYNONYM_MEMBER", "memberStatus");
        }
        ...
        protected String resolveNextRelationPathVdSynonymMemberWithdrawalAsOne() {
            return resolveNextRelationPath("VENDOR_SYNONYM_MEMBER", "vdSynonymMemberWithdrawalAsOne");
        }
	    ...
	    //                                                                 Scalar SubQuery
	    //                                                                 ===============
	    protected Map<String, VendorSynonymMemberCQ> _scalarSubQueryMap;
	    public Map<String, VendorSynonymMemberCQ> ScalarSubQuery { get { return _scalarSubQueryMap; } }
	    public override String keepScalarSubQuery(VendorSynonymMemberCQ subQuery) {
	        if (_scalarSubQueryMap == null) { _scalarSubQueryMap = new LinkedHashMap<String, VendorSynonymMemberCQ>(); }
        ...
        //                                                         =======================
        protected Map<String, VendorSynonymMemberCQ> _myselfInScopeSubQueryMap;
        public Map<String, VendorSynonymMemberCQ> MyselfInScopeSubQuery { get { return _myselfInScopeSubQueryMap; } }
        public override String keepMyselfInScopeSubQuery(VendorSynonymMemberCQ subQuery) {
            if (_myselfInScopeSubQueryMap == null) { _myselfInScopeSubQueryMap = new LinkedHashMap<String, VendorSynonymMemberCQ>(); }
