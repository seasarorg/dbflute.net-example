...
namespace DfExample.DBFlute.CBean.CQ.BS {
    ...
    [System.Serializable]
    public abstract class AbstractBsVdSynonymProductCQ : AbstractConditionQuery {

        public AbstractBsVdSynonymProductCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
            : base(childQuery, sqlClause, aliasName, nestLevel) {}

        public override String getTableDbName() { return "VD_SYNONYM_PRODUCT"; }
        public override String getTableSqlName() { return "VD_SYNONYM_PRODUCT"; }
        ...
        public void InScopeVdSynonymProductStatus(SubQuery<VdSynonymProductStatusCB> subQuery) {
            ...
            String subQueryPropertyName = keepProductStatusCode_InScopeSubQuery_VdSynonymProductStatus(cb.Query());
            registerInScopeSubQuery(cb.Query(), "PRODUCT_STATUS_CODE", "PRODUCT_STATUS_CODE", subQueryPropertyName);
        }
        public abstract String keepProductStatusCode_InScopeSubQuery_VdSynonymProductStatus(VdSynonymProductStatusCQ subQuery);
        public void NotInScopeVdSynonymProductStatus(SubQuery<VdSynonymProductStatusCB> subQuery) {
            assertObjectNotNull("subQuery<VdSynonymProductStatusCB>", subQuery);
            VdSynonymProductStatusCB cb = new VdSynonymProductStatusCB(); cb.xsetupForInScopeRelation(this); subQuery.Invoke(cb);
            String subQueryPropertyName = keepProductStatusCode_NotInScopeSubQuery_VdSynonymProductStatus(cb.Query());
            registerNotInScopeSubQuery(cb.Query(), "PRODUCT_STATUS_CODE", "PRODUCT_STATUS_CODE", subQueryPropertyName);
        }
        public abstract String keepProductStatusCode_NotInScopeSubQuery_VdSynonymProductStatus(VdSynonymProductStatusCQ subQuery);
        ...
        //                                                                    Scalar Condition
        //                                                                    ================
        public SSQFunction<VdSynonymProductCB> Scalar_Equal() {
            return xcreateSSQFunction("=");
        }

        public SSQFunction<VdSynonymProductCB> Scalar_NotEqual() {
            return xcreateSSQFunction("<>");
        }

        public SSQFunction<VdSynonymProductCB> Scalar_GreaterEqual() {
            return xcreateSSQFunction(">=");
        }

        public SSQFunction<VdSynonymProductCB> Scalar_GreaterThan() {
            return xcreateSSQFunction(">");
        }

        public SSQFunction<VdSynonymProductCB> Scalar_LessEqual() {
            return xcreateSSQFunction("<=");
        }

        public SSQFunction<VdSynonymProductCB> Scalar_LessThan() {
            return xcreateSSQFunction("<");
        }

        protected SSQFunction<VdSynonymProductCB> xcreateSSQFunction(String operand) {
            return new SSQFunction<VdSynonymProductCB>(delegate(String function, SubQuery<VdSynonymProductCB> subQuery) {
                xscalarSubQuery(function, subQuery, operand);
            });
        }

        protected void xscalarSubQuery(String function, SubQuery<VdSynonymProductCB> subQuery, String operand) {
            assertObjectNotNull("subQuery<VdSynonymProductCB>", subQuery);
            VdSynonymProductCB cb = new VdSynonymProductCB(); cb.xsetupForScalarCondition(this); subQuery.Invoke(cb);
            String subQueryPropertyName = keepScalarSubQuery(cb.Query()); // for saving query-value.
            registerScalarSubQuery(function, cb.Query(), subQueryPropertyName, operand);
        }
        public abstract String keepScalarSubQuery(VdSynonymProductCQ subQuery);

        // ===============================================================================
        //                                                                  MySelf InScope
        //                                                                  ==============
        public void MyselfInScope(SubQuery<VdSynonymProductCB> subQuery) {
            assertObjectNotNull("subQuery<VdSynonymProductCB>", subQuery);
        ...
        public abstract String keepMyselfInScopeSubQuery(VdSynonymProductCQ subQuery);
