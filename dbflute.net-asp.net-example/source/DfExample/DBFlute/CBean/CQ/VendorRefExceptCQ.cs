...
namespace DfExample.DBFlute.CBean.CQ {
    ...
    [System.Serializable]
    public class VendorRefExceptCQ : BsVendorRefExceptCQ {
        ...
        public VendorRefExceptCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
