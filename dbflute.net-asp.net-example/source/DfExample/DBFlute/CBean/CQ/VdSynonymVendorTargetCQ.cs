...
namespace DfExample.DBFlute.CBean.CQ {
    ...
    [System.Serializable]
    public class VdSynonymVendorTargetCQ : BsVdSynonymVendorTargetCQ {
        ...
        public VdSynonymVendorTargetCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
