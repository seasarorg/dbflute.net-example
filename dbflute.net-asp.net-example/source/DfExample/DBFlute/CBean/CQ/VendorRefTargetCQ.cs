...
namespace DfExample.DBFlute.CBean.CQ {
    ...
    [System.Serializable]
    public class VendorRefTargetCQ : BsVendorRefTargetCQ {
        ...
        public VendorRefTargetCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
