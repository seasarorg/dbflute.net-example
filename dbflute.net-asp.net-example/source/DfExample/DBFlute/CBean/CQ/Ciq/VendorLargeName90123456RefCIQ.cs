...
namespace DfExample.DBFlute.CBean.CQ.Ciq {
    ...
    [System.Serializable]
    public class VendorLargeName90123456RefCIQ : AbstractBsVendorLargeName90123456RefCQ {
        ...
        //                                                                     Constructor
        //                                                                     ===========
        public VendorLargeName90123456RefCIQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel, BsVendorLargeName90123456RefCQ myCQ)
        ...
        protected override ConditionValue getCValueVendorLargeName90123RefId() {
            return _myCQ.VendorLargeName90123RefId;
        }


        protected override ConditionValue getCValueVendorLargeName901RefName() {
            return _myCQ.VendorLargeName901RefName;
        }
        ...
        public override String keepVendorLargeName901234567Id_InScopeSubQuery_VendorLargeName901234567890(VendorLargeName901234567890CQ subQuery) {
            return _myCQ.keepVendorLargeName901234567Id_InScopeSubQuery_VendorLargeName901234567890(subQuery);
        }
        ...
        public override String keepVendorLargeName901234567Id_NotInScopeSubQuery_VendorLargeName901234567890(VendorLargeName901234567890CQ subQuery) {
            return _myCQ.keepVendorLargeName901234567Id_NotInScopeSubQuery_VendorLargeName901234567890(subQuery);
        }
