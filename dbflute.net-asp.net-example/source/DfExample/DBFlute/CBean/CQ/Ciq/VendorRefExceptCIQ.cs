...
namespace DfExample.DBFlute.CBean.CQ.Ciq {
    ...
    [System.Serializable]
    public class VendorRefExceptCIQ : AbstractBsVendorRefExceptCQ {

        // ===============================================================================
        //                                                                       Attribute
        //                                                                       =========
        protected BsVendorRefExceptCQ _myCQ;

        // ===============================================================================
        //                                                                     Constructor
        //                                                                     ===========
        public VendorRefExceptCIQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel, BsVendorRefExceptCQ myCQ)
        ...
        public override String keepVendorExceptId_InScopeSubQuery_VendorExcept(VendorExceptCQ subQuery) {
            return _myCQ.keepVendorExceptId_InScopeSubQuery_VendorExcept(subQuery);
        }

        public override String keepVendorExceptId_NotInScopeSubQuery_VendorExcept(VendorExceptCQ subQuery) {
            return _myCQ.keepVendorExceptId_NotInScopeSubQuery_VendorExcept(subQuery);
        }
