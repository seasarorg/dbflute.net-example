...
namespace DfExample.DBFlute.CBean.CQ.Ciq {
    ...
    [System.Serializable]
    public class VdSynonymMemberLoginCIQ : AbstractBsVdSynonymMemberLoginCQ {

        // ===============================================================================
        //                                                                       Attribute
        //                                                                       =========
        protected BsVdSynonymMemberLoginCQ _myCQ;

        // ===============================================================================
        //                                                                     Constructor
        //                                                                     ===========
        public VdSynonymMemberLoginCIQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel, BsVdSynonymMemberLoginCQ myCQ)
        ...
        protected override ConditionValue getCValueMemberLoginId() {
        ...
        public override String keepMemberId_InScopeSubQuery_MemberVendorSynonym(MemberVendorSynonymCQ subQuery) {
            return _myCQ.keepMemberId_InScopeSubQuery_MemberVendorSynonym(subQuery);
        }

        public override String keepMemberId_NotInScopeSubQuery_MemberVendorSynonym(MemberVendorSynonymCQ subQuery) {
            return _myCQ.keepMemberId_NotInScopeSubQuery_MemberVendorSynonym(subQuery);
        }

        protected override ConditionValue getCValueLoginDatetime() {
            return _myCQ.LoginDatetime;
        }


        protected override ConditionValue getCValueMobileLoginFlg() {
            return _myCQ.MobileLoginFlg;
        }


        protected override ConditionValue getCValueLoginMemberStatusCode() {
