...
namespace DfExample.DBFlute.CBean.CQ {
    ...
    [System.Serializable]
    public class VdSynonymProductCQ : BsVdSynonymProductCQ {
        ...
        public VdSynonymProductCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
