...
namespace DfExample.DBFlute.CBean.CQ {
    ...
    [System.Serializable]
    public class VdSynonymVendorRefExceptCQ : BsVdSynonymVendorRefExceptCQ {
        ...
        public VdSynonymVendorRefExceptCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
