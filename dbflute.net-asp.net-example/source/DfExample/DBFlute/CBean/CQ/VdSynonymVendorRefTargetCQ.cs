...
namespace DfExample.DBFlute.CBean.CQ {
    ...
    [System.Serializable]
    public class VdSynonymVendorRefTargetCQ : BsVdSynonymVendorRefTargetCQ {
        ...
        public VdSynonymVendorRefTargetCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel)
