...
namespace DfExample.DBFlute.LibraryDb.AllCommon.Helper
{
    public class LdMapListStringImpl : LdMapListString
    {
        ...
        public Dictionary<String, Object> generateMap(string mapString)
        {
            ...
            if (!"".Equals(_remainderString) && !_endBrace.Equals(_remainderString))
            {
                ...
                throw new DfExample.DBFlute.LibraryDb.AllCommon.JavaLike.IllegalStateException(msg);
            }
            return generatedMap;
        }
        ...
        protected void removePrefix(String prefixString)
        {
            if (_remainderString == null)
            {
                ...
                throw new DfExample.DBFlute.LibraryDb.AllCommon.JavaLike.IllegalArgumentException(msg);
            }
            removeBothSideSpaceAndTabAndNewLine();
        ...
        protected void assertMapString(String mapString)
        {
            if (mapString == null)
            {
                ...
                throw new DfExample.DBFlute.LibraryDb.AllCommon.JavaLike.IllegalArgumentException(msg + "mapString=" + mapString);
            }
        ...
        protected void assertListString(String listString)
        {
            if (listString == null)
            {
                ...
                throw new DfExample.DBFlute.LibraryDb.AllCommon.JavaLike.IllegalArgumentException(msg + "liststring=" + listString);
            }
