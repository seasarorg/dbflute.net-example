...
namespace DfExample.DBFlute.LibraryDb.AllCommon.Dbm.Info {
    ...
    public class LdForeignInfo : LdRelationInfo {

        // ===============================================================================
        //                                                                       Attribute
        //                                                                       =========
        protected String _foreignPropertyName;
        protected LdDBMeta _localDBMeta;
        protected LdDBMeta _foreignDBMeta;
        protected Map<LdColumnInfo, LdColumnInfo> _localForeignColumnInfoMap;
        protected Map<LdColumnInfo, LdColumnInfo> _foreignLocalColumnInfoMap;
        ...
        public LdForeignInfo(String foreignPropertyName, LdDBMeta localDBMeta, LdDBMeta foreignDBMeta
            ...
            Set<LdColumnInfo> keySet = localForeignColumnInfoMap.keySet();
            _foreignLocalColumnInfoMap = new LinkedHashMap<LdColumnInfo, LdColumnInfo>();
            foreach (LdColumnInfo key in localForeignColumnInfoMap.keySet()) {
                LdColumnInfo value = localForeignColumnInfoMap.get(key);
        ...
        public LdColumnInfo FindLocalByForeign(String foreignColumnDbName) {
            LdColumnInfo keyColumnInfo = _foreignDBMeta.FindColumnInfo(foreignColumnDbName);
            LdColumnInfo resultColumnInfo = _foreignLocalColumnInfoMap.get(keyColumnInfo);
        ...
        public override bool Equals(Object obj) {
            if (obj == null || !(obj is LdForeignInfo)) {
                return false;
            }
            LdForeignInfo target = (LdForeignInfo) obj;
        ...
        public LdDBMeta ForeignDBMeta {
            get { return _foreignDBMeta; }
        }

        public Map<LdColumnInfo, LdColumnInfo> LocalForeignColumnInfoMap {
            get { return _localForeignColumnInfoMap; }
        }

        public Map<LdColumnInfo, LdColumnInfo> ForeignLocalColumnInfoMap {
