...
namespace DfExample.DBFlute.LibraryDb.AllCommon.Dbm.Info {
    ...
    public class LdColumnInfo {
        ...
        //                                                                     Constructor
        //                                                                     ===========
        public LdColumnInfo(LdDBMeta dbmeta, String columnDbName, String columnSqlName
        ...
        public override bool Equals(Object obj) {
            if (obj == null || !(obj is LdColumnInfo)) {
                return false;
            }
            LdColumnInfo target = (LdColumnInfo)obj;
        ...
        public List<LdReferrerInfo> ReferrerInfoList { get {
            List<LdReferrerInfo> referrerInfoList = new ArrayList<LdReferrerInfo>();
