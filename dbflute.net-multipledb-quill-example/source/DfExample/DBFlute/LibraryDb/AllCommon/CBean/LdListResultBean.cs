...
using DfExample.DBFlute.LibraryDb.AllCommon.CBean.Grouping;
using DfExample.DBFlute.LibraryDb.AllCommon.CBean.Mapping;

namespace DfExample.DBFlute.LibraryDb.AllCommon.CBean {

    [System.Serializable]
    public class LdListResultBean<ENTITY> : System.Collections.Generic.IList<ENTITY>, System.Collections.IList {
         ...
         */
        public System.Collections.Generic.IList<ROW> GroupingList<ROW>(LdGroupingRowSetupper<ROW, ENTITY> groupingRowSetupper, LdGroupingOption<ENTITY> groupingOption) {
            System.Collections.Generic.IList<ROW> groupingList = new System.Collections.Generic.List<ROW>();
            LdGroupingRowEndDeterminer<ENTITY> rowEndDeterminer = groupingOption.GroupingRowEndDeterminer;
            if (rowEndDeterminer == null) {
                rowEndDeterminer = delegate(LdGroupingRowResource<ENTITY> currentRowResource, ENTITY nextEntity) {
        ...
        //                                                                         =======
        #region Mapping
        public LdListResultBean<DTO> MappingList<DTO>(LdEntityDtoMapper<ENTITY, DTO> entityDtoMapper) {
            LdListResultBean<DTO> mappingList = new LdListResultBean<DTO>();
            foreach (ENTITY entity in _selectedList) {
        ...
        public virtual LdOrderByClause OrderByClause {
