...
namespace DfExample.DBFlute.LibraryDb.AllCommon.CBean.OutsideSql {
    ...
    public class LdOutsideSqlContext {
        ...
        public static LdOutsideSqlContext GetOutsideSqlContextOnThread() {
            return (LdOutsideSqlContext)Thread.GetData(_slot);
        }
        ...
        //                                                                      Unique Key
        //                                                                      ==========
        public static String GenerateSpecifiedOutsideSqlUniqueKey(String methodName, String path, Object pmb, LdOutsideSqlOption option, Type resultType) {
        ...
        public static void ThrowOutsideSqlNotFoundException(String path) {
            ...
            msg = msg + "* * * * * * * * * */";
            throw new DfExample.DBFlute.LibraryDb.AllCommon.Exp.LdOutsideSqlNotFoundException(msg);
        }
        ...
        public String ReadOutsideSql(String sqlFileEncoding, String dbmsSuffix) { // Non Filtered
            ...
            AdditionalAssembly additionalAssemblyProvider = LdDBFluteConfig.GetInstance().AdditionalAssemblyProvider;
        ...
        protected String BuildBehaviorSqlPackageName() {
            LdDBMeta dbmeta = LdDBMetaInstanceHandler.FindDBMeta(_tableDbName);
            String behaviorTypeName = dbmeta.BehaviorTypeName;
            String outsideSqlPackage = LdDBFluteConfig.GetInstance().OutsideSqlPackage;
        ...
        public String FilterAboutOmitDirectoryPackage(String pckge) { // CSharp only
            String omitDirectoryPackage = LdDBFluteConfig.GetInstance().OmitDirectoryPackage;
        ...
        public String FilterAboutOmitResourcePathPackage(String pckge) { // CSharp only
            String omitResourcePathPackage = LdDBFluteConfig.GetInstance().OmitResourcePathPackage;
        ...
        protected String FilterAboutDefaultPackage(String pckge) { // CSharp only
            String defaultPackage = LdDBFluteConfig.GetInstance().DefaultPackage;
        ...
        protected virtual String BuildFileSystemPath(String standardPath) {
            ...
            String omitPathPackage = LdDBFluteConfig.GetInstance().OmitFileSystemPathPackage;
            ...
            String flatDirectory = LdDBFluteConfig.GetInstance().FlatDirectoryPackage;
            ...
            FileSystemPath resolver = LdDBFluteConfig.GetInstance().FileSystemPathResolver;
            if (resolver != null) {
    ...
    public delegate String FileSystemPath(String relativePath, String standardPath, LdOutsideSqlContext context);
}
