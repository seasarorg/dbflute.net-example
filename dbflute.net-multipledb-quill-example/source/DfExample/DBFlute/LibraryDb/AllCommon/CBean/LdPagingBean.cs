...
namespace DfExample.DBFlute.LibraryDb.AllCommon.CBean {
    ...
    /// </summary>
    public interface LdPagingBean : LdFetchNarrowingBean, LdOrderByBean {
        ...
        LdPagingBean FetchFirst(int fetchSize);
        ...
        /// <param name="fetchSize">The size of fetch. (NotMinus & NotZero)</param>
        /// <returns>this. (NotNull)</returns>
        LdPagingBean FetchScope(int fetchStartIndex, int fetchSize);
        ...
        /// <returns>this. (NotNull)</returns>
        LdPagingBean FetchPage(int fetchPageNumber);
