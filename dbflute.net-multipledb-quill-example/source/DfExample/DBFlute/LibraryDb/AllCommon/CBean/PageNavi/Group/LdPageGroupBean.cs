...
using DfExample.DBFlute.LibraryDb.AllCommon.CBean.PageNavi;

namespace DfExample.DBFlute.LibraryDb.AllCommon.CBean.PageNavi.Group {

[System.Serializable]
public class LdPageGroupBean {
    ...
    //                                                                    Page Number List
    //                                                                    ================
    public System.Collections.Generic.IList<LINK> BuildPageNumberLinkList<LINK>(LdPageNumberLinkSetupper<LINK> pageNumberLinkSetupper) where LINK : LdPageNumberLink {
    ...
    public LdPageGroupOption PageGroupOption { get { return _pageGroupOption; } set { _pageGroupOption = value; } }
