...
using DfExample.DBFlute.LibraryDb.AllCommon.CBean.PageNavi.Group;
using DfExample.DBFlute.LibraryDb.AllCommon.CBean.PageNavi.Range;
...
namespace DfExample.DBFlute.LibraryDb.AllCommon.CBean {
    ...
    /// </summary>
    [System.Serializable]
    public class LdPagingResultBean<ENTITY> : LdListResultBean<ENTITY> {
        ...
        public LdPageGroupOption PageGroupOption {
            set {
                InitializePageGroup();
        ...
        public LdPageRangeOption PageRangeOption {
            set {
                InitializePageRange();
