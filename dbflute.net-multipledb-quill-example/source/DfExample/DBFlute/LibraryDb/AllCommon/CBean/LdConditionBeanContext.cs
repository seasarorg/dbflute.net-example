...
namespace DfExample.DBFlute.LibraryDb.AllCommon.CBean {
    ...
    public static class LdConditionBeanContext {
        ...
        public static bool IsTheArgumentConditionBean(Object dtoInstance) {
            if (dtoInstance is LdConditionBean) {
                return true;
            } else {
                return false;
            }
        ...
        public static bool IsTheTypeConditionBean(Type dtoType) {
            if (typeof(LdConditionBean).IsAssignableFrom(dtoType)) {
                return true;
            } else {
                return false;
            }
        ...
        public static void ThrowEntityAlreadyDeletedException(Object searchKey4Log) {
            ...
            msg = msg + ln();
            if (searchKey4Log != null && searchKey4Log is LdConditionBean) {
                LdConditionBean cb = (LdConditionBean)searchKey4Log;
        ...
        public static void ThrowEntityDuplicatedException(String resultCountString, Object searchKey4Log, Exception cause) {
            ...
            msg = msg + "* * * * * * * * * */";
            if (cause != null) {
                throw new LdEntityDuplicatedException(msg, cause);
            } else {
                throw new LdEntityDuplicatedException(msg);
            }
        }

        public static void throwSelectEntityConditionNotFoundException(LdConditionBean cb) {
            String msg = "Look! Read the message below." + ln();
            msg = msg + "/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *" + ln();
            ...
            Map<String, LdConditionKey> invalidQueryColumnMap = cb.SqlClause.getInvalidQueryColumnMap();
            if (invalidQueryColumnMap != null && !invalidQueryColumnMap.isEmpty()) {
                ...
                foreach (String columnFullName in keySet) {
                    LdConditionKey key = invalidQueryColumnMap.get(columnFullName);
            ...
            msg = msg + "* * * * * * * * * */";
            throw new LdSelectEntityConditionNotFoundException(msg);
        }
        ...
        public static String ConvertConditionBean2DisplaySql(LdConditionBean cb) {
            ...
            return LdInternalSqlParser.ConvertTwoWaySql2DisplaySql(twoWaySql, cb);
        }
