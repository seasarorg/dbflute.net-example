...
namespace DfExample.DBFlute.LibraryDb.AllCommon.CBean {
    ...
    [System.Serializable]
    public abstract class LdAbstractConditionBean : LdConditionBean {
        ...
        private LdUnionQuery<LdConditionBean> _unionQuerySynchronizer;
        ...
        //                                                                     Constructor
        //                                                                     ===========
        public LdAbstractConditionBean() {
            LdDBMeta dbmeta = LdDBMetaInstanceHandler.FindDBMeta(TableDbName);
            _sqlClause = new LdSqlClauseMySql(dbmeta.TableSqlName);
        }
        ...
        //                                                                       SqlClause
        //                                                                       =========
        public LdSqlClause SqlClause { get { return _sqlClause; } }
        public String GetClause() { return this.SqlClause.getClause(); }

        // ===============================================================================
        //                                                                           Query
        //                                                                           =====
        public abstract LdConditionQuery LocalCQ { get; }
        ...
        //                                                   =============================
        public LdOrderByClause SqlComponentOfOrderByClause {
        ...
        public abstract LdConditionBean AddOrderBy_PK_Asc();
        public abstract LdConditionBean AddOrderBy_PK_Desc();
        ...
        //                                                                     ColumnQuery
        //                                                                     ===========
        protected void xcolqy<CB>(CB leftCB, CB rightCB, LdSpecifyQuery<CB> leftSp,
                LdSpecifyQuery<CB> rightSp, String operand) where CB : LdConditionBean {
            // specify left column
        ...
        //                                                                    OrScopeQuery
        //                                                                    ============
        protected void xorQ<CB>(CB cb, LdOrQuery<CB> orQuery) where CB : LdConditionBean {
        ...
        public LdStatementConfig StatementConfig { get {
        ...
        public virtual String ToDisplaySql() {
            return LdConditionBeanContext.ConvertConditionBean2DisplaySql(this);
        }
        ...
        //                                                              Query Synchronizer
        //                                                              ==================
        protected void xsyncUQ(LdConditionBean unionCB) { // synchronizeUnionQuery()
            if (_unionQuerySynchronizer != null) {
                _unionQuerySynchronizer.Invoke(unionCB);
            }
        }

        public void xregisterUnionQuerySynchronizer(LdUnionQuery<LdConditionBean> unionQuerySynchronizer) {
        ...
        public void xsetupForUnion(LdConditionBean mainCB) {
            xinheritSubQueryInfo(mainCB.LocalCQ);
            _forUnion = true;
        }

        public void xsetupForExistsReferrer(LdConditionQuery mainCQ) {
            xprepareSubQueryInfo(mainCQ);
            _forExistsReferrer = true;
        }

        public void xsetupForInScopeRelation(LdConditionQuery mainCQ) {
            xprepareSubQueryInfo(mainCQ);
            _forInScopeRelation = true;
        }

        public void xsetupForDerivedReferrer(LdConditionQuery mainCQ) {
            xprepareSubQueryInfo(mainCQ);
        ...
        public void xsetupForScalarCondition(LdConditionQuery mainCQ) {
            xprepareSubQueryInfo(mainCQ);
        ...
        protected void xinheritSubQueryInfo(LdConditionQuery mainCQ) {
            if (mainCQ.xgetSqlClause().isForSubQuery()) {
                this.SqlClause.setupForSubQuery(mainCQ.xgetSqlClause().getSubQueryLevel()); // inherited
            }
        }

        protected void xprepareSubQueryInfo(LdConditionQuery mainCQ) {
        ...
        protected delegate LdConditionQuery SsCall();
    ...
    // [DBFlute-0.7.4]
    public abstract class AbstractSpecification<CQ> where CQ : LdConditionQuery {
        ...
        protected AbstractSpecification(LdConditionBean baseCB, HpSpQyCall<CQ> qyCall
        ...
        protected void throwScalarSubQueryInvalidForeignSpecificationException(String foreignPropertyName) {
            LdConditionBeanContext.ThrowScalarSubQueryInvalidForeignSpecificationException(foreignPropertyName);
        }
    ...
    public interface HpSpQyCall<CQ> where CQ : LdConditionQuery {
        bool has(); 
        CQ qy(); 
    }

    public class HpColQyOperand<CB> where CB : LdConditionBean {
        ...
        public void Equal(LdSpecifyQuery<CB> rightSpecifyQuery) {
            _handler.Invoke(rightSpecifyQuery, "=");
        }

        public void NotEqual(LdSpecifyQuery<CB> rightSpecifyQuery) {
            _handler.Invoke(rightSpecifyQuery, "<>");
        }

        public void GreaterThan(LdSpecifyQuery<CB> rightSpecifyQuery) {
            _handler.Invoke(rightSpecifyQuery, ">");
        }

        public void GreaterEqual(LdSpecifyQuery<CB> rightSpecifyQuery) {
            _handler.Invoke(rightSpecifyQuery, ">=");
        }

        public void LessThan(LdSpecifyQuery<CB> rightSpecifyQuery) {
            _handler.Invoke(rightSpecifyQuery, "<");
        }

        public void LessEqual(LdSpecifyQuery<CB> rightSpecifyQuery) {
            _handler.Invoke(rightSpecifyQuery, "<=");
        }
    }

    public delegate void HpColQyHandler<CB>(LdSpecifyQuery<CB> rightSp, String operand) where CB : LdConditionBean;
    ...
    public class RAFunction<REFERRER_CB, LOCAL_CQ> where REFERRER_CB : LdConditionBean where LOCAL_CQ : LdConditionQuery {
        protected LdConditionBean _baseCB;
        protected LOCAL_CQ _localCQ;
        protected RAQSetupper<REFERRER_CB, LOCAL_CQ> _querySetupper;

        public RAFunction(LdConditionBean baseCB, LOCAL_CQ localCQ, RAQSetupper<REFERRER_CB, LOCAL_CQ> querySetupper) {
            _baseCB = baseCB;
            _localCQ = localCQ;
        ...
        protected void assertAliasName(String aliasName) {
            ...
            LdDBMeta dbmeta = LdDBMetaInstanceHandler.FindDBMeta(_baseCB.TableDbName);
    ...
    public delegate void RAQSetupper<REFERRER_CB, LOCAL_CQ>(String function, LdSubQuery<REFERRER_CB> subQuery, LOCAL_CQ cq, String aliasName)
            where REFERRER_CB : LdConditionBean where LOCAL_CQ : LdConditionQuery;
