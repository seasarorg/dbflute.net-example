...
[System.Serializable]
public class LdSqlClauseOracle : LdAbstractSqlClause {
    ...
    public override LdSqlClause lockForUpdate() {
        LdDBMeta dbmeta = LdDBMetaInstanceHandler.FindDBMeta(_tableName);
    ...
    //                                                                 Database Dependency
    //                                                                 ===================
    public virtual LdSqlClause lockForUpdateNoWait() {
        lockForUpdate();
        _lockSqlSuffix = _lockSqlSuffix + " nowait";
        return this;
    }

    public virtual LdSqlClause lockForUpdateWait(int waitSec) {
        lockForUpdate();
