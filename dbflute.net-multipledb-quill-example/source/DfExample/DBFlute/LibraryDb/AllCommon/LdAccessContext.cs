...
namespace DfExample.DBFlute.LibraryDb.AllCommon {
    ...
    public class LdAccessContext {
        ...
        public static LdAccessContext GetAccessContextOnThread() {
            return (LdAccessContext)Thread.GetData(_accessContextSlot);
        }

        public static void SetAccessContextOnThread(LdAccessContext context) {
            if (context == null) {
		...
		public static DateTime? GetAccessTimestampOnThread() {
            if (IsExistAccessContextOnThread()) {
                LdAccessContext userContextOnThread = GetAccessContextOnThread();
