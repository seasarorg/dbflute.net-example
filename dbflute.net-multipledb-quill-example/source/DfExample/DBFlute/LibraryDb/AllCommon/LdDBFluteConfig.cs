...
public class LdDBFluteConfig {
    ...
    private static readonly LdDBFluteConfig _instance = new LdDBFluteConfig();
    ...
    protected String _outsideSqlPackage = "DfExample.DBFlute.LibraryDb";
    ...
    //                                                            ========================
    public LdStatementConfig DefaultStatementConfig {
        get {
