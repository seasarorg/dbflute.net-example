...
namespace DfExample.DBFlute.LibraryDb.AllCommon.S2Dao {
     ...
     */
    public class LdS2DaoSelectDynamicCommand : SelectDynamicCommand {
        ...
        //                                                                     Constructor
        //                                                                     ===========
        public LdS2DaoSelectDynamicCommand(IDataSource dataSource, ICommandFactory commandFactory
        ...
        protected override ISqlParser CreateSqlParser(string sqlString) {
            return new LdInternalSqlParser(sqlString, true);
        }

        // -------------------------------------------------
        //                                         Extension
        //                                         ---------
        protected LdS2DaoSelectDynamicCommand CreateMySelectDynamicCommand() {
            return new LdS2DaoSelectDynamicCommand(DataSource, CommandFactory, dataReaderHandler, dataReaderFactory);
        }
        ...
        public override object Execute(object[] args) {
            ...
            LdInternalBasicSelectHandler selectHandler = CreateBasicSelectHandler(finalClause, this.dataReaderHandler);
        ...
        protected virtual object ExecuteDefault(object[] args) {
            ...
            LdInternalBasicSelectHandler selectHandler = CreateBasicSelectHandler(ctx.Sql, specifiedDataReaderHandler);
        ...
        protected Object ExecuteOutsideSqlAsDynamic(Object[] args, LdOutsideSqlContext outsideSqlContext) {
            ...
            LdS2DaoSelectDynamicCommand outsideSqlCommand = CreateMySelectDynamicCommand();
        ...
        protected virtual object[] FilterArgumentsForDataReaderHandler(object[] args) {
            ...
            object[] filteredArgs;
            if (args[args.Length - 1] is DfExample.DBFlute.LibraryDb.AllCommon.Ado.LdCursorHandler) {
        ...
        protected IDataReaderHandler FindSpecifiedDataReaderHandler(object[] args) {
            ...
            if (args[args.Length-1] is DfExample.DBFlute.LibraryDb.AllCommon.Ado.LdCursorHandler) {
                DfExample.DBFlute.LibraryDb.AllCommon.Ado.LdCursorHandler cursorHandler = (DfExample.DBFlute.LibraryDb.AllCommon.Ado.LdCursorHandler)args[args.Length-1];
        ...
        protected String SetupRealClause(Object[] args, IList<Object> bindVariableList, IList<Type> bindVariableTypeList, IList<String> bindVariableNameList) {
            ...
            {
                LdS2DaoSelectDynamicCommand dynamicCommand = CreateMySelectDynamicCommand();
        ...
        protected LdInternalBasicSelectHandler CreateBasicSelectHandler(String realSql, IDataReaderHandler specifiedDataReaderHandler) {
            return new LdInternalBasicSelectHandler(DataSource, realSql, specifiedDataReaderHandler, CommandFactory, dataReaderFactory);
        }
        ...
        protected class DataReaderCursol : IDataReaderHandler {
            protected DfExample.DBFlute.LibraryDb.AllCommon.Ado.LdCursorHandler _cursorHandler;
            public DataReaderCursol(DfExample.DBFlute.LibraryDb.AllCommon.Ado.LdCursorHandler cursorHandler) {
