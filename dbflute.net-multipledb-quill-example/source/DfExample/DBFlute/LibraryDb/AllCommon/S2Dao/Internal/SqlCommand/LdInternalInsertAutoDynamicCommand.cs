...
namespace DfExample.DBFlute.LibraryDb.AllCommon.S2Dao.Internal.SqlCommand {
    ...
    public class LdInternalInsertAutoDynamicCommand : AbstractSqlCommand {
        ...
        //                                                                     Constructor
        //                                                                     ===========
        public LdInternalInsertAutoDynamicCommand(IDataSource dataSource, ICommandFactory commandFactory,
        ...
        public override Object Execute(object[] args) {
            ...
            LdInternalAbstractAutoHandler handler = CreateAutoHandler(DataSource, CommandFactory, bmd, propertyTypes);
        ...
        protected virtual LdInternalAbstractAutoHandler CreateAutoHandler(IDataSource dataSource, ICommandFactory commandFactory, 
            IBeanMetaData beanMetaData, IPropertyType[] propertyTypes) {
            return new LdInternalInsertAutoHandler(dataSource, commandFactory, beanMetaData, propertyTypes);
        }
