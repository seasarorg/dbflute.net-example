...
namespace DfExample.DBFlute.LibraryDb.AllCommon.S2Dao.Internal.SqlParser {

    public class LdInternalSqlParser : ISqlParser {
        ...
        protected readonly LdInternalSqlTokenizer _tokenizer;
        protected readonly System.Collections.Stack _nodeStack = new System.Collections.Stack();

        // ===============================================================================
        //                                                                     Constructor
        //                                                                     ===========
        public LdInternalSqlParser(String sql, bool blockNullParameter) {
            sql = sql.Trim();
            if (sql.EndsWith(";")) {
            ...
            _tokenizer = new LdInternalSqlTokenizer(sql);
        }
    	...
    	public static String ConvertTwoWaySql2DisplaySql(String twoWaySql, String[] argNames, Type[] argTypes, Object[] args) {
    		...
    		{
                LdInternalSqlParser parser = new LdInternalSqlParser(twoWaySql, false);
    		...
    		return LdInternalBindVariableUtil.GetCompleteSql(preparedSql, context.BindVariables);
    	}
    ...
    public class InternalValueAndTypeSetuper {
        ...
        public void SetupValueAndType(InternalValueAndType valueAndType) {
            ...
            for (int pos = 1; pos < _names.Length; ++pos) {
                ...
                if (pos == 1 && typeof(LdMapParameterBean).IsAssignableFrom(type)) {
                    LdMapParameterBean pmb = (LdMapParameterBean)value;
        ...
        // for OutsideSql
        protected bool IsLastLoop4LikeSearch(int pos, LdLikeSearchOption likeSearchOption) {
        ...
        // for OutsideSql
        protected LdLikeSearchOption GetLikeSearchOption(Type type, String currentName, Object resourceBean) {
            PropertyInfo pi = type.GetProperty(currentName + "InternalLikeSearchOption");
            LdLikeSearchOption option = (LdLikeSearchOption)pi.GetValue(resourceBean, null);
			if (option == null) {
