...
using DfExample.DBFlute.LibraryDb.AllCommon.S2Dao.Internal.Util;
...
namespace DfExample.DBFlute.LibraryDb.AllCommon.S2Dao.Internal.SqlHandler {
    ...
    public class LdInternalBasicHandler {
        ...
        //                                                                     Constructor
        //                                                                     ===========
        public LdInternalBasicHandler(IDataSource ds, String sql, ICommandFactory commandFactory) {
            DataSource = ds;
            Sql = sql;
        ...
        protected virtual void LogSql(Object[] args, Type[] argTypes) {
            // [SqlLogHandler]
            LdSqlLogHandler sqlLogHandler = GetSqlLogHander();
            ...
            // [SqlLogRegistry]
            LdInternalSqlLogRegistry sqlLogRegistry = LdInternalSqlLogRegistryLocator.Instance;
        ...
        protected virtual String GetCompleteSql(Object[] args) {
            return LdInternalBindVariableUtil.GetCompleteSql(_sql, args);
        }

        protected virtual LdSqlLogHandler GetSqlLogHander() {
            if (!LdCallbackContext.IsExistCallbackContextOnThread()) {
                return null;
            }
            return LdCallbackContext.GetCallbackContextOnThread().SqlLogHandler;
        }
        ...
        protected virtual LdInternalSqlLog CreateInternalSqlLog(String displaySql, Object[] args, Type[] argTypes) {
            LdInternalSqlLog sqlLog = new LdInternalSqlLog();
        ...
        protected virtual String GetBindVariableText(Object bindVariable) {
            return LdInternalBindVariableUtil.GetBindVariableText(bindVariable);
        }
    ...
    public class DbExceptionHandler {
        ...
        public void HandleDbException(Exception e, IDbCommand cmd, bool uniqueConstraintValid, String displaySql) {
            ...
            //     ThrowEntityAlreadyExistsException(e, cmd, resource);
            // }
            if (e is LdDangerousResultSizeException) {
        ...
        protected bool IsUniqueConstraintException(DbException e) {
            // [UnderReview]: How do I get unique constraint on ADO.NET?
            // return LdConditionBeanContext.IsUniqueConstraintException(ExtractSQLState(e), e.ErrorCode);
            return false;
        }
        ...
        protected String ExtractBehaviorInvokeName() {
            Object behaviorInvokeName = LdInternalMapContext.GetObject("df:BehaviorInvokeName");
            if (behaviorInvokeName == null) {
                return null;
            }
            Object clientInvokeName = LdInternalMapContext.GetObject("df:ClientInvokeName");
            Object byPassInvokeName = LdInternalMapContext.GetObject("df:ByPassInvokeName");
            StringBuilder sb = new StringBuilder();
