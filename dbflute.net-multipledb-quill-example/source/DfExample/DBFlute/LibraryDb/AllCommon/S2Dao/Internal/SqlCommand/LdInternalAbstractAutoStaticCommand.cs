...
namespace DfExample.DBFlute.LibraryDb.AllCommon.S2Dao.Internal.SqlCommand {
    ...
    public abstract class LdInternalAbstractAutoStaticCommand : AbstractStaticCommand {
        ...
        //                                                                     Constructor
        //                                                                     ===========
        public LdInternalAbstractAutoStaticCommand(IDataSource dataSource,
        ...
        public override Object Execute(object[] args) {
            ...
            if (IsCheckSingleRowUpdate && rows != 1) throw new LdEntityAlreadyUpdatedException(args[0], rows);
            return rows;
        }
