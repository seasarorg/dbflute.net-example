...
namespace DfExample.DBFlute.LibraryDb.AllCommon.S2Dao.Internal.SqlCommand {
    ...
    public class LdInternalUpdateAutoDynamicCommand : AbstractSqlCommand {
        ...
        //                                                                     Constructor
        //                                                                     ===========
        public LdInternalUpdateAutoDynamicCommand(IDataSource dataSource, ICommandFactory commandFactory,
        ...
        public override object Execute(object[] args) {
            ...
            LdInternalAbstractAutoHandler handler = CreateInternalAutoHandler(DataSource, CommandFactory, bmd, propertyTypes);
        ...
        protected virtual LdInternalAbstractAutoHandler CreateInternalAutoHandler(IDataSource dataSource, ICommandFactory commandFactory, 
            IBeanMetaData beanMetaData, IPropertyType[] propertyTypes) {
            LdInternalUpdateAutoHandler handler = new LdInternalUpdateAutoHandler(dataSource, commandFactory, beanMetaData, propertyTypes);
