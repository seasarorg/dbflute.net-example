...
namespace DfExample.DBFlute.LibraryDb.AllCommon.S2Dao.Internal.RsHandler {
    ...
    public class LdInternalBeanListMetaDataResultSetHandler : LdInternalAbstractBeanMetaDataResultSetHandler {

        // ===============================================================================
        //                                                                     Constructor
        //                                                                     ===========
        public LdInternalBeanListMetaDataResultSetHandler(IBeanMetaData beanMetaData, IRowCreator rowCreator, IRelationRowCreator relationRowCreator)
