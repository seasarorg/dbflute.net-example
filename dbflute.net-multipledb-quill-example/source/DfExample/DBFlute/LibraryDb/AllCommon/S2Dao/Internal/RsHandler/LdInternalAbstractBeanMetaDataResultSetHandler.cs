...
namespace DfExample.DBFlute.LibraryDb.AllCommon.S2Dao.Internal.RsHandler {
    ...
    public abstract class LdInternalAbstractBeanMetaDataResultSetHandler : IDataReaderHandler {
        ...
        //                                                                     Constructor
        //                                                                     ===========
        public LdInternalAbstractBeanMetaDataResultSetHandler(IBeanMetaData beanMetaData, IRowCreator rowCreator, IRelationRowCreator relationRowCreator) {
        ...
        protected virtual void PostCreateRow(Object row, IBeanMetaData bmd) {
            if (row is LdEntity) { // DBFlute Target
