...
namespace DfExample.DBFlute.LibraryDb.AllCommon.S2Dao {
    ...
    public class LdFetchNarrowingResultSetWrapper : System.Data.IDataReader {
        ...
        //                                                                     Constructor
        //                                                                     ===========
        public LdFetchNarrowingResultSetWrapper(System.Data.IDataReader dataReader, LdFetchNarrowingBean fetchNarrowingBean
        ...
        protected void throwDangerousResultSizeException(int safetyMaxResultSize) {
            ...
            msg = msg + ln();
            if (_fetchNarrowingBean is LdConditionBean) {
                msg = msg + "[Display SQL]" + ln();
                msg = msg + ((LdConditionBean) _fetchNarrowingBean).ToDisplaySql() + ln();
            } else {
                msg = msg + "[Fetch Bean]" + ln();
                msg = msg + _fetchNarrowingBean + ln();
            }
            msg = msg + "* * * * * * * * * */";
            throw new LdDangerousResultSizeException(msg, safetyMaxResultSize);
        }
