...
namespace DfExample.DBFlute.LibraryDb.AllCommon.S2Dao {
    ...
    public class LdS2DaoMetaDataFactoryImpl : Seasar.Dao.IDaoMetaDataFactory {
        ...
        //                                                                     Constructor
        //                                                                     ===========
        public LdS2DaoMetaDataFactoryImpl(IDataSource dataSource,
        ...
        protected void HandleSqlLogRegistry() {
            if (LdDBFluteConfig.GetInstance().IsUseSqlLogRegistry) {
                ...
                LdInternalSqlLogRegistryLocator.Instance = new LdInternalSqlLogRegistry();
                ...
                if (LdInternalSqlLogRegistryLocator.Instance != null) {
                    LdInternalSqlLogRegistryLocator.Instance = null;
                }
            }
        }
        ...
        protected virtual IDaoMetaData CreateDaoMetaData(Type daoType) {
            LdS2DaoMetaDataExtension dmd = NewDaoMetaDataExtension();
            dmd.DaoType = daoType;
        ...
        protected virtual LdS2DaoMetaDataExtension NewDaoMetaDataExtension() {
            return new LdS2DaoMetaDataExtension();
        }
    ...
    public class InternalRowCreator : RowCreatorImpl {
        ...
        public LdDBMeta DBMeta { set { _dbmeta = value; } }
        ...
        protected static LdDBMeta FindDBMetaByClass(Type beanClass) {
            Object instance = NewInstance(beanClass);
            if (!(instance is LdEntity)) {
                return null;
            }
            return ((LdEntity)instance).DBMeta;
        }
		...
		public static LdDBMeta FindCachedDBMeta(Object row) {
		    return DBMetaCacheHandler.FindDBMeta(row);
        }

		public static LdDBMeta FindCachedDBMeta(Type rowType, String tableName) {
	...
	public class DBMetaCacheHandler {
		...
		public static LdDBMeta FindDBMeta(Object row) {
			...
			LdEntity entity = (LdEntity)row;
            LdDBMeta dbmeta = FindCachedDBMeta(entity.GetType());
			if (dbmeta != null) {
			    return dbmeta;
			}
        ...
        public static LdDBMeta FindDBMeta(Type rowType, String tableName) {
            LdDBMeta dbmeta = FindCachedDBMeta(rowType);
            if (dbmeta != null) {
                return dbmeta;
            }
            try {
                dbmeta = LdDBMetaInstanceHandler.FindDBMeta(tableName);
        ...
        protected static LdDBMeta FindCachedDBMeta(Type rowType) {
            System.Collections.Generic.IDictionary<Type, LdDBMeta> dbmetaCache = FindDBMetaCache();
            if (dbmetaCache == null) {
                dbmetaCache = new System.Collections.Generic.Dictionary<Type, LdDBMeta>();
        ...
        protected static void CacheDBMeta(Type type, LdDBMeta dbmeta) {
            System.Collections.Generic.IDictionary<Type, LdDBMeta> dbmetaCache = FindDBMetaCache();
            dbmetaCache.Add(type, dbmeta);
        }
        
        protected static System.Collections.Generic.IDictionary<Type, LdDBMeta> FindDBMetaCache() {
            return (System.Collections.Generic.IDictionary<Type, LdDBMeta>)LdInternalMapContext.GetObject(DBMETA_CACHE_KEY);
        }
	}
    ...
    public class InternalRelationRowCreator : RelationRowCreatorImpl {
        ...
        protected override void SetupRelationKeyValue(RelationRowCreationResource res) {
            ...
            LdDBMeta dbmeta = FindDBMeta(bmd.BeanType, bmd.TableName);
        ...
        protected LdDBMeta FindDBMeta(Type rowType, String tableName) {
        ...
        protected override void RegisterRelationValue(RelationRowCreationResource res, String columnName) {
            ...
            if (value != null) {
				...
				LdDBMeta dbmeta = FindDBMeta(res.Row);
    ...
    public class InternalDataReaderHandlerFactory : IDataReaderHandlerFactory {
        ...
        protected virtual IDataReaderHandler CreateBeanArrayMetaDataDataReaderHandler(IBeanMetaData bmd) {
            ...
            return new LdInternalBeanArrayMetaDataResultSetHandler(bmd, rowCreator, relationRowCreator);
        }
        ...
        protected virtual IDataReaderHandler CreateBeanGenericListMetaDataDataReaderHandler(IBeanMetaData bmd) {
            InternalRowCreator rowCreator = CreateInternalRowCreator(bmd);
            InternalRelationRowCreator relationRowCreator = CreateInternalRelationRowCreator(bmd);
            return new LdInternalBeanGenericListMetaDataResultSetHandler(bmd, rowCreator, relationRowCreator);
        }
