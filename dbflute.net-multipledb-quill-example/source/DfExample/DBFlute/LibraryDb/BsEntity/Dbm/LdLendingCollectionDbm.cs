...
namespace DfExample.DBFlute.LibraryDb.BsEntity.Dbm {
    ...
    public class LdLendingCollectionDbm : LdAbstractDBMeta {

        public static readonly Type ENTITY_TYPE = typeof(LdLendingCollection);

        private static readonly LdLendingCollectionDbm _instance = new LdLendingCollectionDbm();
        ...
        public override String TablePropertyName { get { return "LendingCollection"; } }
        public override String TableSqlName { get { return "lending_collection"; } }
        ...
        protected LdColumnInfo _columnReturnLimitDate;
        ...
        public LdColumnInfo ColumnReturnLimitDate { get { return _columnReturnLimitDate; } }
        ...
        protected void InitializeColumnInfo() {
            _columnLibraryId = cci("LIBRARY_ID", "LIBRARY_ID", null, null, true, "LibraryId", typeof(int?), true, "INT", 10, 0, false, OptimisticLockType.NONE, null, "lending,libraryUser", null);
            _columnLbUserId = cci("LB_USER_ID", "LB_USER_ID", null, null, true, "LbUserId", typeof(int?), true, "INT", 10, 0, false, OptimisticLockType.NONE, null, "lending,libraryUser", null);
            _columnLendingDate = cci("LENDING_DATE", "LENDING_DATE", null, null, true, "LendingDate", typeof(DateTime?), true, "DATETIME", 19, 0, false, OptimisticLockType.NONE, null, "lending", null);
            ...
            _columnReturnLimitDate = cci("RETURN_LIMIT_DATE", "RETURN_LIMIT_DATE", null, null, true, "ReturnLimitDate", typeof(DateTime?), false, "DATETIME", 19, 0, false, OptimisticLockType.NONE, null, null, null);
        ...
        protected void InitializeColumnInfoList() {
            ...
            _columnInfoList.add(ColumnReturnLimitDate);
        ...
        public LdForeignInfo ForeignCollection { get {
            ...
            return cfi("Collection", this, LdCollectionDbm.GetInstance(), map, 0, false, false);
        }}
        public LdForeignInfo ForeignLending { get {
            Map<LdColumnInfo, LdColumnInfo> map = new LinkedHashMap<LdColumnInfo, LdColumnInfo>();
            ...
            return cfi("Lending", this, LdLendingDbm.GetInstance(), map, 1, false, false);
        }}
        public LdForeignInfo ForeignLibraryUser { get {
            ...
            return cfi("LibraryUser", this, LdLibraryUserDbm.GetInstance(), map, 2, false, false);
        }}
        ...
        //                                             Table
        //                                             -----
        public static readonly String TABLE_DB_NAME = "lending_collection";
        public static readonly String TABLE_PROPERTY_NAME = "LendingCollection";
        ...
        public static readonly String DB_NAME_RETURN_LIMIT_DATE = "RETURN_LIMIT_DATE";
        ...
        public static readonly String PROPERTY_NAME_RETURN_LIMIT_DATE = "ReturnLimitDate";
        ...
        public static readonly String FOREIGN_PROPERTY_NAME_Lending = "Lending";
        ...
        static LdLendingCollectionDbm() {
            {
                ...
                map.put(DB_NAME_RETURN_LIMIT_DATE.ToLower(), PROPERTY_NAME_RETURN_LIMIT_DATE);
...

            {
                ...
                map.put(PROPERTY_NAME_RETURN_LIMIT_DATE.ToLower(), DB_NAME_RETURN_LIMIT_DATE);
        ...
        //                                                                       Type Name
        //                                                                       =========
        public override String EntityTypeName { get { return "DfExample.DBFlute.LibraryDb.ExEntity.LdLendingCollection"; } }
        public override String DaoTypeName { get { return "DfExample.DBFlute.LibraryDb.ExDao.LdLendingCollectionDao"; } }
        public override String ConditionBeanTypeName { get { return "DfExample.DBFlute.LibraryDb.CBean.LdLendingCollectionCB"; } }
        public override String BehaviorTypeName { get { return "DfExample.DBFlute.LibraryDb.ExBhv.LdLendingCollectionBhv"; } }
        ...
        //                                                           =====================
        protected Map<String, EntityPropertySetupper<LdLendingCollection>> _entityPropertySetupperMap = new LinkedHashMap<String, EntityPropertySetupper<LdLendingCollection>>();
        ...
        protected void InitializeEntityPropertySetupper() {
            ...
            RegisterEntityPropertySetupper("RETURN_LIMIT_DATE", "ReturnLimitDate", new EntityPropertyReturnLimitDateSetupper(), _entityPropertySetupperMap);
        ...
        public override void SetupEntityProperty(String propertyName, Object entity, Object value) {
            EntityPropertySetupper<LdLendingCollection> callback = _entityPropertySetupperMap.get(propertyName);
            callback.Setup((LdLendingCollection)entity, value);
        }

        public class EntityPropertyLibraryIdSetupper : EntityPropertySetupper<LdLendingCollection> {
            public void Setup(LdLendingCollection entity, Object value) { entity.LibraryId = (value != null) ? (int?)value : null; }
        }
        public class EntityPropertyLbUserIdSetupper : EntityPropertySetupper<LdLendingCollection> {
            public void Setup(LdLendingCollection entity, Object value) { entity.LbUserId = (value != null) ? (int?)value : null; }
        }
        public class EntityPropertyLendingDateSetupper : EntityPropertySetupper<LdLendingCollection> {
            public void Setup(LdLendingCollection entity, Object value) { entity.LendingDate = (value != null) ? (DateTime?)value : null; }
        }
        public class EntityPropertyCollectionIdSetupper : EntityPropertySetupper<LdLendingCollection> {
            public void Setup(LdLendingCollection entity, Object value) { entity.CollectionId = (value != null) ? (int?)value : null; }
        }
        public class EntityPropertyReturnLimitDateSetupper : EntityPropertySetupper<LdLendingCollection> {
            public void Setup(LdLendingCollection entity, Object value) { entity.ReturnLimitDate = (value != null) ? (DateTime?)value : null; }
        }
        public class EntityPropertyRUserSetupper : EntityPropertySetupper<LdLendingCollection> {
            public void Setup(LdLendingCollection entity, Object value) { entity.RUser = (value != null) ? (String)value : null; }
        }
        public class EntityPropertyRModuleSetupper : EntityPropertySetupper<LdLendingCollection> {
            public void Setup(LdLendingCollection entity, Object value) { entity.RModule = (value != null) ? (String)value : null; }
        }
        public class EntityPropertyRTimestampSetupper : EntityPropertySetupper<LdLendingCollection> {
            public void Setup(LdLendingCollection entity, Object value) { entity.RTimestamp = (value != null) ? (DateTime?)value : null; }
        }
        public class EntityPropertyUUserSetupper : EntityPropertySetupper<LdLendingCollection> {
            public void Setup(LdLendingCollection entity, Object value) { entity.UUser = (value != null) ? (String)value : null; }
        }
        public class EntityPropertyUModuleSetupper : EntityPropertySetupper<LdLendingCollection> {
            public void Setup(LdLendingCollection entity, Object value) { entity.UModule = (value != null) ? (String)value : null; }
        }
        public class EntityPropertyUTimestampSetupper : EntityPropertySetupper<LdLendingCollection> {
            public void Setup(LdLendingCollection entity, Object value) { entity.UTimestamp = (value != null) ? (DateTime?)value : null; }
        }
    }
}
