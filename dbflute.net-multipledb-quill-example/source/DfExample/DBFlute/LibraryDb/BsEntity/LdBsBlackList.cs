...
namespace DfExample.DBFlute.LibraryDb.ExEntity {
    ...
    /// <summary>
    /// The entity of black_list as TABLE. (partial class for auto-generation)
    /// <![CDATA[
    /// [primary-key]
    ///     BLACK_LIST_ID
    /// 
    ...
    /// </summary>
    [Seasar.Dao.Attrs.Table("black_list")]
    [Seasar.Dao.Attrs.TimestampProperty("UTimestamp")]
    [System.Serializable]
    public partial class LdBlackList : LdEntityDefinedCommonColumn {

        // ===============================================================================
        //                                                                       Attribute
        //                                                                       =========
        #region Attribute
        /// <summary>BLACK_LIST_ID: {PK, ID, NotNull, INT(10)}</summary>
        protected int? _blackListId;

        /// <summary>LB_USER_ID: {UQ, NotNull, INT(10), FK to lb_user}</summary>
        protected int? _lbUserId;

        /// <summary>BLACK_RANK: {NotNull, CHAR(3)}</summary>
        ...
        //                                                                      Table Name
        //                                                                      ==========
        public String TableDbName { get { return "black_list"; } }
        public String TablePropertyName { get { return "BlackList"; } }
        ...
        protected IList<LdBlackAction> _blackActionList;

        /// <summary>black_action as 'BlackActionList'.</summary>
        public IList<LdBlackAction> BlackActionList {
            get { if (_blackActionList == null) { _blackActionList = new List<LdBlackAction>(); } return _blackActionList; }
            set { _blackActionList = value; }
        }
        ...
        public override bool Equals(Object other) {
            if (other == null || !(other is LdBlackList)) { return false; }
            LdBlackList otherEntity = (LdBlackList)other;
            if (!xSV(this.BlackListId, otherEntity.BlackListId)) { return false; }
            return true;
        }
        ...
        public override int GetHashCode() {
            int result = 17;
            result = xCH(result, _blackListId);
            return result;
        }
        ...
        public override String ToString() {
            return "LdBlackList:" + BuildColumnString() + BuildRelationString();
        }
        ...
        public virtual String ToStringWithRelation() {
            ...
            if (_blackActionList != null) { foreach (LdEntity e in _blackActionList)
        ...
        protected virtual String BuildColumnString() {
            ...
            sb.Append(c).Append(this.BlackRank);
        ...
        protected virtual String BuildRelationString() {
            ...
            if (_blackActionList != null && _blackActionList.Count > 0)
        ...
        /// <summary>BLACK_RANK: {NotNull, CHAR(3)}</summary>
        [Seasar.Dao.Attrs.Column("BLACK_RANK")]
        public String BlackRank {
            get { return _blackRank; }
            set {
