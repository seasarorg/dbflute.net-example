...
namespace DfExample.DBFlute.LibraryDb.ExEntity {
    ...
    [System.Serializable]
    public partial class LdMyselfCheck : LdEntity {
        ...
        public override bool Equals(Object other) {
            if (other == null || !(other is LdMyselfCheck)) { return false; }
            LdMyselfCheck otherEntity = (LdMyselfCheck)other;
        ...
        public override String ToString() {
            return "LdMyselfCheck:" + BuildColumnString() + BuildRelationString();
        }
