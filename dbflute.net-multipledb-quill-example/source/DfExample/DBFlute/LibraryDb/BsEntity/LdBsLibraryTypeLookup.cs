...
namespace DfExample.DBFlute.LibraryDb.ExEntity {
    ...
    /// <summary>
    /// The entity of library_type_lookup as TABLE. (partial class for auto-generation)
    /// <![CDATA[
    /// [primary-key]
    ///     LIBRARY_TYPE_CODE
    /// 
    ...
    /// </summary>
    [Seasar.Dao.Attrs.Table("library_type_lookup")]
    [Seasar.Dao.Attrs.TimestampProperty("UTimestamp")]
    [System.Serializable]
    public partial class LdLibraryTypeLookup : LdEntityDefinedCommonColumn {

        // ===============================================================================
        //                                                                       Attribute
        //                                                                       =========
        #region Attribute
        /// <summary>LIBRARY_TYPE_CODE: {PK, NotNull, CHAR(3)}</summary>
        protected String _libraryTypeCode;

        /// <summary>LIBRARY_TYPE_NAME: {NotNull, VARCHAR(80)}</summary>
        ...
        //                                                                      Table Name
        //                                                                      ==========
        public String TableDbName { get { return "library_type_lookup"; } }
        public String TablePropertyName { get { return "LibraryTypeLookup"; } }
        ...
        protected IList<LdLibrary> _libraryList;

        /// <summary>library as 'LibraryList'.</summary>
        public IList<LdLibrary> LibraryList {
            get { if (_libraryList == null) { _libraryList = new List<LdLibrary>(); } return _libraryList; }
        ...
        public override bool Equals(Object other) {
            if (other == null || !(other is LdLibraryTypeLookup)) { return false; }
            LdLibraryTypeLookup otherEntity = (LdLibraryTypeLookup)other;
            if (!xSV(this.LibraryTypeCode, otherEntity.LibraryTypeCode)) { return false; }
            return true;
        }
        ...
        public override int GetHashCode() {
            int result = 17;
            result = xCH(result, _libraryTypeCode);
            return result;
        }
        ...
        public override String ToString() {
            return "LdLibraryTypeLookup:" + BuildColumnString() + BuildRelationString();
        }
        ...
        public virtual String ToStringWithRelation() {
            ...
            sb.Append(ToString());
            String l = "\n  ";
            if (_libraryList != null) { foreach (LdEntity e in _libraryList)
        ...
        protected virtual String BuildColumnString() {
            ...
            sb.Append(c).Append(this.LibraryTypeName);
        ...
        protected virtual String BuildRelationString() {
            StringBuilder sb = new StringBuilder();
            String c = ",";
            if (_libraryList != null && _libraryList.Count > 0)
