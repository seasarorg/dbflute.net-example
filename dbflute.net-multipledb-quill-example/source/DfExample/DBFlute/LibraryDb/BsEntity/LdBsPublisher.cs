...
namespace DfExample.DBFlute.LibraryDb.ExEntity {
    ...
    /// <summary>
    /// The entity of publisher as TABLE. (partial class for auto-generation)
    /// <![CDATA[
    /// [primary-key]
    ///     PUBLISHER_ID
    /// 
    ...
    /// </summary>
    [Seasar.Dao.Attrs.Table("publisher")]
    [Seasar.Dao.Attrs.TimestampProperty("UTimestamp")]
    [System.Serializable]
    public partial class LdPublisher : LdEntityDefinedCommonColumn {

        // ===============================================================================
        //                                                                       Attribute
        //                                                                       =========
        #region Attribute
        /// <summary>PUBLISHER_ID: {PK, ID, NotNull, INT(10)}</summary>
        protected int? _publisherId;

        /// <summary>PUBLISHER_NAME: {NotNull, VARCHAR(80)}</summary>
        ...
        //                                                                      Table Name
        //                                                                      ==========
        public String TableDbName { get { return "publisher"; } }
        public String TablePropertyName { get { return "Publisher"; } }
        ...
        public override bool Equals(Object other) {
            if (other == null || !(other is LdPublisher)) { return false; }
            LdPublisher otherEntity = (LdPublisher)other;
            if (!xSV(this.PublisherId, otherEntity.PublisherId)) { return false; }
            return true;
        }
        ...
        public override int GetHashCode() {
            int result = 17;
            result = xCH(result, _publisherId);
            return result;
        }
        ...
        public override String ToString() {
            return "LdPublisher:" + BuildColumnString() + BuildRelationString();
        }
        ...
        protected virtual String BuildColumnString() {
            ...
            sb.Append(c).Append(this.PublisherName);
        ...
        /// <summary>PUBLISHER_NAME: {NotNull, VARCHAR(80)}</summary>
        [Seasar.Dao.Attrs.Column("PUBLISHER_NAME")]
