...
namespace DfExample.DBFlute.LibraryDb.CBean.CQ.BS {
    ...
    [System.Serializable]
    public abstract class LdAbstractBsGarbagePlusCQ : LdAbstractConditionQuery {
        ...
        public override String getTableDbName() { return "garbage_plus"; }
        public override String getTableSqlName() { return "garbage_plus"; }
