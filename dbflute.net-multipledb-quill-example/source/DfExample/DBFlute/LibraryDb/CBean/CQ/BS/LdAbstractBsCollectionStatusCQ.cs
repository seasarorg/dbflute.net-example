...
namespace DfExample.DBFlute.LibraryDb.CBean.CQ.BS {
    ...
    [System.Serializable]
    public abstract class LdAbstractBsCollectionStatusCQ : LdAbstractConditionQuery {
        ...
        public override String getTableDbName() { return "collection_status"; }
        public override String getTableSqlName() { return "collection_status"; }
        ...
        public void InScopeCollectionStatusLookup(LdSubQuery<LdCollectionStatusLookupCB> subQuery) {
            ...
            String subQueryPropertyName = keepCollectionStatusCode_InScopeSubQuery_CollectionStatusLookup(cb.Query());
            registerInScopeSubQuery(cb.Query(), "COLLECTION_STATUS_CODE", "COLLECTION_STATUS_CODE", subQueryPropertyName);
        }
        public abstract String keepCollectionStatusCode_InScopeSubQuery_CollectionStatusLookup(LdCollectionStatusLookupCQ subQuery);
        public void NotInScopeCollectionStatusLookup(LdSubQuery<LdCollectionStatusLookupCB> subQuery) {
            assertObjectNotNull("subQuery<LdCollectionStatusLookupCB>", subQuery);
            LdCollectionStatusLookupCB cb = new LdCollectionStatusLookupCB(); cb.xsetupForInScopeRelation(this); subQuery.Invoke(cb);
            String subQueryPropertyName = keepCollectionStatusCode_NotInScopeSubQuery_CollectionStatusLookup(cb.Query());
            registerNotInScopeSubQuery(cb.Query(), "COLLECTION_STATUS_CODE", "COLLECTION_STATUS_CODE", subQueryPropertyName);
        }
        public abstract String keepCollectionStatusCode_NotInScopeSubQuery_CollectionStatusLookup(LdCollectionStatusLookupCQ subQuery);
        ...
        public SSQFunction<LdCollectionStatusCB> Scalar_NotEqual() {
            return xcreateSSQFunction("<>");
        }
        ...
        protected SSQFunction<LdCollectionStatusCB> xcreateSSQFunction(String operand) {
            return new SSQFunction<LdCollectionStatusCB>(delegate(String function, LdSubQuery<LdCollectionStatusCB> subQuery) {
        ...
        protected void xscalarSubQuery(String function, LdSubQuery<LdCollectionStatusCB> subQuery, String operand) {
            ...
            LdCollectionStatusCB cb = new LdCollectionStatusCB(); cb.xsetupForScalarCondition(this); subQuery.Invoke(cb);
        ...
        //                                                                  MySelf InScope
        //                                                                  ==============
        public void MyselfInScope(LdSubQuery<LdCollectionStatusCB> subQuery) {
            assertObjectNotNull("subQuery<LdCollectionStatusCB>", subQuery);
            LdCollectionStatusCB cb = new LdCollectionStatusCB(); cb.xsetupForInScopeRelation(this); subQuery.Invoke(cb);
            String subQueryPropertyName = keepMyselfInScopeSubQuery(cb.Query()); // for saving query-value.
            registerInScopeSubQuery(cb.Query(), "COLLECTION_ID", "COLLECTION_ID", subQueryPropertyName);
        }
        public abstract String keepMyselfInScopeSubQuery(LdCollectionStatusCQ subQuery);
