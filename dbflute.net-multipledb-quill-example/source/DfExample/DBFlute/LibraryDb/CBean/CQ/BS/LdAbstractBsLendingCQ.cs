...
namespace DfExample.DBFlute.LibraryDb.CBean.CQ.BS {
    ...
    [System.Serializable]
    public abstract class LdAbstractBsLendingCQ : LdAbstractConditionQuery {

        public LdAbstractBsLendingCQ(LdConditionQuery childQuery, LdSqlClause sqlClause, String aliasName, int nestLevel)
            : base(childQuery, sqlClause, aliasName, nestLevel) {}

        public override String getTableDbName() { return "lending"; }
        public override String getTableSqlName() { return "lending"; }
