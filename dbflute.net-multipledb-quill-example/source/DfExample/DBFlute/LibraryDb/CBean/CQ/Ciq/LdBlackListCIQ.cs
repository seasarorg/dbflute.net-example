...
namespace DfExample.DBFlute.LibraryDb.CBean.CQ.Ciq {
    ...
    [System.Serializable]
    public class LdBlackListCIQ : LdAbstractBsBlackListCQ {
        ...
        public override String keepBlackListId_ExistsSubQuery_BlackActionList(LdBlackActionCQ subQuery) {
            ...
            // _myCQ.keepBlackListId_ExistsSubQuery_BlackActionList(subQuery);
        }

        public override String keepBlackListId_NotExistsSubQuery_BlackActionList(LdBlackActionCQ subQuery) {
            throw new SystemException("NotExistsSubQuery at inline() is unsupported! Sorry!");
            // _myCQ.keepBlackListId_NotExistsSubQuery_BlackActionList(subQuery);
        }
        ...
        protected override LdConditionValue getCValueBlackRank() {
            return _myCQ.BlackRank;
        }
