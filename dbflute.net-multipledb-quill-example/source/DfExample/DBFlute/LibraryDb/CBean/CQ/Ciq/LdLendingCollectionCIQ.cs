...
namespace DfExample.DBFlute.LibraryDb.CBean.CQ.Ciq {
    ...
    [System.Serializable]
    public class LdLendingCollectionCIQ : LdAbstractBsLendingCollectionCQ {
        ...
        protected override LdConditionValue getCValueReturnLimitDate() {
            return _myCQ.ReturnLimitDate;
        }
