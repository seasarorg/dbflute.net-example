...
namespace DfExample.DBFlute.LibraryDb.CBean.CQ.Ciq {
    ...
    [System.Serializable]
    public class LdBlackActionLookupCIQ : LdAbstractBsBlackActionLookupCQ {
        ...
        public override String keepBlackActionCode_ExistsSubQuery_BlackActionList(LdBlackActionCQ subQuery) {
            ...
            // _myCQ.keepBlackActionCode_ExistsSubQuery_BlackActionList(subQuery);
        }

        public override String keepBlackActionCode_NotExistsSubQuery_BlackActionList(LdBlackActionCQ subQuery) {
            throw new SystemException("NotExistsSubQuery at inline() is unsupported! Sorry!");
            // _myCQ.keepBlackActionCode_NotExistsSubQuery_BlackActionList(subQuery);
        }
        ...
        protected override LdConditionValue getCValueBlackActionName() {
            return _myCQ.BlackActionName;
        }
