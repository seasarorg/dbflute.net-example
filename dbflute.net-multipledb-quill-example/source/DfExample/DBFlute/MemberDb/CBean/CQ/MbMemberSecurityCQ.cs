...
namespace DfExample.DBFlute.MemberDb.CBean.CQ {
    ...
    [System.Serializable]
    public class MbMemberSecurityCQ : MbBsMemberSecurityCQ {
        ...
        public MbMemberSecurityCQ(MbConditionQuery childQuery, MbSqlClause sqlClause, String aliasName, int nestLevel)
