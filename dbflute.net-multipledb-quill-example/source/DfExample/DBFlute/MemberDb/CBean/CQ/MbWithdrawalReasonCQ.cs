...
namespace DfExample.DBFlute.MemberDb.CBean.CQ {
    ...
    [System.Serializable]
    public class MbWithdrawalReasonCQ : MbBsWithdrawalReasonCQ {
        ...
        public MbWithdrawalReasonCQ(MbConditionQuery childQuery, MbSqlClause sqlClause, String aliasName, int nestLevel)
