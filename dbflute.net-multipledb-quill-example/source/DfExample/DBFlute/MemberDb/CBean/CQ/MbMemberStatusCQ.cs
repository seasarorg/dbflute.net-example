...
namespace DfExample.DBFlute.MemberDb.CBean.CQ {
    ...
    [System.Serializable]
    public class MbMemberStatusCQ : MbBsMemberStatusCQ {
        ...
        public MbMemberStatusCQ(MbConditionQuery childQuery, MbSqlClause sqlClause, String aliasName, int nestLevel)
