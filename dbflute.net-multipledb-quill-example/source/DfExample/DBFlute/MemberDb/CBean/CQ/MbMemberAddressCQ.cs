...
namespace DfExample.DBFlute.MemberDb.CBean.CQ {
    ...
    [System.Serializable]
    public class MbMemberAddressCQ : MbBsMemberAddressCQ {
        ...
        public MbMemberAddressCQ(MbConditionQuery childQuery, MbSqlClause sqlClause, String aliasName, int nestLevel)
