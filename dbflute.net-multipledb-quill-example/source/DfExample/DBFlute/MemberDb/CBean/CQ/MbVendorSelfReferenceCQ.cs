...
namespace DfExample.DBFlute.MemberDb.CBean.CQ {
    ...
    [System.Serializable]
    public class MbVendorSelfReferenceCQ : MbBsVendorSelfReferenceCQ {
        ...
        public MbVendorSelfReferenceCQ(MbConditionQuery childQuery, MbSqlClause sqlClause, String aliasName, int nestLevel)
