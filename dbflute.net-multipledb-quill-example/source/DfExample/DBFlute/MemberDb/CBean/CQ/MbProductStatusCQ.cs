...
namespace DfExample.DBFlute.MemberDb.CBean.CQ {
    ...
    [System.Serializable]
    public class MbProductStatusCQ : MbBsProductStatusCQ {
        ...
        public MbProductStatusCQ(MbConditionQuery childQuery, MbSqlClause sqlClause, String aliasName, int nestLevel)
