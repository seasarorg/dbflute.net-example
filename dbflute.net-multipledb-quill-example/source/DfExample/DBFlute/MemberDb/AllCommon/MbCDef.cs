...
namespace DfExample.DBFlute.MemberDb.AllCommon {
    ...
    public static class MbCDef {
        ...
        public class Flg {
            /** はい: 有効を示す */
            public static readonly Flg True = new Flg("1", "True", "はい");
            /** いいえ: 無効を示す */
            public static readonly Flg False = new Flg("0", "False", "いいえ");
        ...
        public class MemberStatus {
            /** 仮会員: 仮会員を示す */
            public static readonly MemberStatus Provisional = new MemberStatus("PRV", "Provisional", "仮会員");
            /** 正式会員: 正式会員を示す */
            public static readonly MemberStatus Formalized = new MemberStatus("FML", "Formalized", "正式会員");
            /** 退会会員: 退会会員を示す */
            public static readonly MemberStatus Withdrawal = new MemberStatus("WDL", "Withdrawal", "退会会員");
