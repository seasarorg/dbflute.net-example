...
namespace DfExample.DBFlute.MemberDb.AllCommon.S2Dao.Internal.RsHandler {
    ...
    public class MbInternalBeanListMetaDataResultSetHandler : MbInternalAbstractBeanMetaDataResultSetHandler {

        // ===============================================================================
        //                                                                     Constructor
        //                                                                     ===========
        public MbInternalBeanListMetaDataResultSetHandler(IBeanMetaData beanMetaData, IRowCreator rowCreator, IRelationRowCreator relationRowCreator)
