...
namespace DfExample.DBFlute.MemberDb.AllCommon.S2Dao.Internal.RsHandler {
    ...
    public abstract class MbInternalAbstractBeanMetaDataResultSetHandler : IDataReaderHandler {
        ...
        //                                                                     Constructor
        //                                                                     ===========
        public MbInternalAbstractBeanMetaDataResultSetHandler(IBeanMetaData beanMetaData, IRowCreator rowCreator, IRelationRowCreator relationRowCreator) {
        ...
        protected virtual void PostCreateRow(Object row, IBeanMetaData bmd) {
            if (row is MbEntity) { // DBFlute Target
                ((MbEntity)row).ClearModifiedPropertyNames();
