...
namespace DfExample.DBFlute.MemberDb.AllCommon.S2Dao.Internal.SqlCommand {
    ...
    public class MbInternalInsertAutoDynamicCommand : AbstractSqlCommand {
        ...
        //                                                                     Constructor
        //                                                                     ===========
        public MbInternalInsertAutoDynamicCommand(IDataSource dataSource, ICommandFactory commandFactory,
        ...
        public override Object Execute(object[] args) {
            ...
            MbInternalAbstractAutoHandler handler = CreateAutoHandler(DataSource, CommandFactory, bmd, propertyTypes);
        ...
        protected virtual MbInternalAbstractAutoHandler CreateAutoHandler(IDataSource dataSource, ICommandFactory commandFactory, 
            IBeanMetaData beanMetaData, IPropertyType[] propertyTypes) {
            return new MbInternalInsertAutoHandler(dataSource, commandFactory, beanMetaData, propertyTypes);
        }
