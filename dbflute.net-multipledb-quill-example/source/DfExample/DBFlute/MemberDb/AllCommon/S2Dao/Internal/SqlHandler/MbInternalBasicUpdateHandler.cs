...
namespace DfExample.DBFlute.MemberDb.AllCommon.S2Dao.Internal.SqlHandler {
    ...
    public class MbInternalBasicUpdateHandler : MbInternalBasicHandler {
        ...
        //                                                                     Constructor
        //                                                                     ===========
        public MbInternalBasicUpdateHandler(IDataSource dataSource, string sql, ICommandFactory commandFactory)
