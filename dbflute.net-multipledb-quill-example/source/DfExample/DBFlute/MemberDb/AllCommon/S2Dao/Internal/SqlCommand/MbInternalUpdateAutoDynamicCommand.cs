...
namespace DfExample.DBFlute.MemberDb.AllCommon.S2Dao.Internal.SqlCommand {
    ...
    public class MbInternalUpdateAutoDynamicCommand : AbstractSqlCommand {
        ...
        //                                                                     Constructor
        //                                                                     ===========
        public MbInternalUpdateAutoDynamicCommand(IDataSource dataSource, ICommandFactory commandFactory,
        ...
        public override object Execute(object[] args) {
            ...
            MbInternalAbstractAutoHandler handler = CreateInternalAutoHandler(DataSource, CommandFactory, bmd, propertyTypes);
        ...
        protected virtual MbInternalAbstractAutoHandler CreateInternalAutoHandler(IDataSource dataSource, ICommandFactory commandFactory, 
            IBeanMetaData beanMetaData, IPropertyType[] propertyTypes) {
            MbInternalUpdateAutoHandler handler = new MbInternalUpdateAutoHandler(dataSource, commandFactory, beanMetaData, propertyTypes);
