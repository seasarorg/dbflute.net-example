...
namespace DfExample.DBFlute.MemberDb.AllCommon.S2Dao.Internal.SqlCommand {
    ...
    public class MbInternalUpdateModifiedOnlyCommand : MbInternalUpdateAutoDynamicCommand {
        ...
        //                                                                     Constructor
        //                                                                     ===========
        public MbInternalUpdateModifiedOnlyCommand(IDataSource dataSource, ICommandFactory commandFactory,
