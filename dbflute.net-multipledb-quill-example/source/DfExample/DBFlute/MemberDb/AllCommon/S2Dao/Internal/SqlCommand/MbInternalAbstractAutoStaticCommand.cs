...
namespace DfExample.DBFlute.MemberDb.AllCommon.S2Dao.Internal.SqlCommand {
    ...
    public abstract class MbInternalAbstractAutoStaticCommand : AbstractStaticCommand {
        ...
        //                                                                     Constructor
        //                                                                     ===========
        public MbInternalAbstractAutoStaticCommand(IDataSource dataSource,
        ...
        public override Object Execute(object[] args) {
            MbInternalAbstractAutoHandler handler = CreateAutoHandler();
            handler.Sql = Sql;
            handler.LoggingMessageSqlArgs = args;
            int rows = handler.Execute(args);
            if (IsCheckSingleRowUpdate && rows != 1) throw new MbEntityAlreadyUpdatedException(args[0], rows);
            return rows;
        }

        protected abstract MbInternalAbstractAutoHandler CreateAutoHandler();
