...
namespace DfExample.DBFlute.MemberDb.AllCommon.S2Dao {
    ...
    public class MbS2DaoMetaDataFactoryImpl : Seasar.Dao.IDaoMetaDataFactory {
        ...
        //                                                                     Constructor
        //                                                                     ===========
        public MbS2DaoMetaDataFactoryImpl(IDataSource dataSource,
        ...
        protected void HandleSqlLogRegistry() {
            if (MbDBFluteConfig.GetInstance().IsUseSqlLogRegistry) {
                ...
                MbInternalSqlLogRegistryLocator.Instance = new MbInternalSqlLogRegistry();
                ...
                if (MbInternalSqlLogRegistryLocator.Instance != null) {
                    MbInternalSqlLogRegistryLocator.Instance = null;
                }
            }
        }
        ...
        protected virtual IDaoMetaData CreateDaoMetaData(Type daoType) {
            MbS2DaoMetaDataExtension dmd = NewDaoMetaDataExtension();
            dmd.DaoType = daoType;
        ...
        protected virtual MbS2DaoMetaDataExtension NewDaoMetaDataExtension() {
            return new MbS2DaoMetaDataExtension();
        }
    ...
    public class InternalRowCreator : RowCreatorImpl {
        ...
        public MbDBMeta DBMeta { set { _dbmeta = value; } }
        ...
        protected static MbDBMeta FindDBMetaByClass(Type beanClass) {
            Object instance = NewInstance(beanClass);
            if (!(instance is MbEntity)) {
                return null;
            }
            return ((MbEntity)instance).DBMeta;
        }
		...
		public static MbDBMeta FindCachedDBMeta(Object row) {
		    return DBMetaCacheHandler.FindDBMeta(row);
        }

		public static MbDBMeta FindCachedDBMeta(Type rowType, String tableName) {
	...
	public class DBMetaCacheHandler {
		...
		public static MbDBMeta FindDBMeta(Object row) {
		    if (!(row is MbEntity)) {
			    return null;
			}
			MbEntity entity = (MbEntity)row;
            MbDBMeta dbmeta = FindCachedDBMeta(entity.GetType());
			if (dbmeta != null) {
			    return dbmeta;
			}
        ...
        public static MbDBMeta FindDBMeta(Type rowType, String tableName) {
            MbDBMeta dbmeta = FindCachedDBMeta(rowType);
            if (dbmeta != null) {
                return dbmeta;
            }
            try {
                dbmeta = MbDBMetaInstanceHandler.FindDBMeta(tableName);
        ...
        protected static MbDBMeta FindCachedDBMeta(Type rowType) {
            System.Collections.Generic.IDictionary<Type, MbDBMeta> dbmetaCache = FindDBMetaCache();
            if (dbmetaCache == null) {
                dbmetaCache = new System.Collections.Generic.Dictionary<Type, MbDBMeta>();
                MbInternalMapContext.SetObject(DBMETA_CACHE_KEY, dbmetaCache);
            }
        ...
        protected static void CacheDBMeta(MbEntity entity, MbDBMeta dbmeta) {
            CacheDBMeta(entity.GetType(), dbmeta);
        }
        
        protected static void CacheDBMeta(Type type, MbDBMeta dbmeta) {
            System.Collections.Generic.IDictionary<Type, MbDBMeta> dbmetaCache = FindDBMetaCache();
            dbmetaCache.Add(type, dbmeta);
        }
        
        protected static System.Collections.Generic.IDictionary<Type, MbDBMeta> FindDBMetaCache() {
            return (System.Collections.Generic.IDictionary<Type, MbDBMeta>)MbInternalMapContext.GetObject(DBMETA_CACHE_KEY);
        }
	}
    ...
    public class InternalRelationRowCreator : RelationRowCreatorImpl {
        ...
        protected override void SetupRelationKeyValue(RelationRowCreationResource res) {
            ...
            MbDBMeta dbmeta = FindDBMeta(bmd.BeanType, bmd.TableName);
        ...
        protected Object CreateRelationRowInstance(MbDBMeta dbmeta) {
            if (dbmeta != null) {
        ...
        protected MbDBMeta FindDBMeta(Type rowType, String tableName) {
        ...
        protected override void RegisterRelationValue(RelationRowCreationResource res, String columnName) {
            ...
            if (value != null) {
				...
				MbDBMeta dbmeta = FindDBMeta(res.Row);
		...
		protected MbDBMeta FindDBMeta(Object row) {
        ...
        protected bool HasConditionBean(RelationRowCreationResource res) {
            return MbConditionBeanContext.IsExistConditionBeanOnThread();
        }
    ...
    public class InternalDataReaderHandlerFactory : IDataReaderHandlerFactory {
        ...
        protected virtual IDataReaderHandler CreateBeanArrayMetaDataDataReaderHandler(IBeanMetaData bmd) {
            ...
            return new MbInternalBeanArrayMetaDataResultSetHandler(bmd, rowCreator, relationRowCreator);
        }
        ...
        protected virtual IDataReaderHandler CreateBeanGenericListMetaDataDataReaderHandler(IBeanMetaData bmd) {
            InternalRowCreator rowCreator = CreateInternalRowCreator(bmd);
            InternalRelationRowCreator relationRowCreator = CreateInternalRelationRowCreator(bmd);
            return new MbInternalBeanGenericListMetaDataResultSetHandler(bmd, rowCreator, relationRowCreator);
        }
