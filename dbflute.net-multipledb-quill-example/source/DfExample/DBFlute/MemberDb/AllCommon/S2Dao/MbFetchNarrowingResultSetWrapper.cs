...
namespace DfExample.DBFlute.MemberDb.AllCommon.S2Dao {
    ...
    public class MbFetchNarrowingResultSetWrapper : System.Data.IDataReader {
        ...
        //                                                                     Constructor
        //                                                                     ===========
        public MbFetchNarrowingResultSetWrapper(System.Data.IDataReader dataReader, MbFetchNarrowingBean fetchNarrowingBean
        ...
        protected void throwDangerousResultSizeException(int safetyMaxResultSize) {
            ...
            msg = msg + ln();
            if (_fetchNarrowingBean is MbConditionBean) {
                msg = msg + "[Display SQL]" + ln();
                msg = msg + ((MbConditionBean) _fetchNarrowingBean).ToDisplaySql() + ln();
            } else {
                msg = msg + "[Fetch Bean]" + ln();
                msg = msg + _fetchNarrowingBean + ln();
            }
            msg = msg + "* * * * * * * * * */";
            throw new MbDangerousResultSizeException(msg, safetyMaxResultSize);
        }
