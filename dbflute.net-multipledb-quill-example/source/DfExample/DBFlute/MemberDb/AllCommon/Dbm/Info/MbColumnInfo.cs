...
namespace DfExample.DBFlute.MemberDb.AllCommon.Dbm.Info {
    ...
    public class MbColumnInfo {
        ...
        //                                                                     Constructor
        //                                                                     ===========
        public MbColumnInfo(MbDBMeta dbmeta, String columnDbName, String columnSqlName
        ...
        public override bool Equals(Object obj) {
            if (obj == null || !(obj is MbColumnInfo)) {
                return false;
            }
            MbColumnInfo target = (MbColumnInfo)obj;
        ...
        public List<MbReferrerInfo> ReferrerInfoList { get {
            List<MbReferrerInfo> referrerInfoList = new ArrayList<MbReferrerInfo>();
