...
using DfExample.DBFlute.MemberDb.AllCommon.CBean.PageNavi;

namespace DfExample.DBFlute.MemberDb.AllCommon.CBean.PageNavi.Group {

[System.Serializable]
public class MbPageGroupBean {
    ...
    //                                                                    Page Number List
    //                                                                    ================
    public System.Collections.Generic.IList<LINK> BuildPageNumberLinkList<LINK>(MbPageNumberLinkSetupper<LINK> pageNumberLinkSetupper) where LINK : MbPageNumberLink {
    ...
    public MbPageGroupOption PageGroupOption { get { return _pageGroupOption; } set { _pageGroupOption = value; } }
