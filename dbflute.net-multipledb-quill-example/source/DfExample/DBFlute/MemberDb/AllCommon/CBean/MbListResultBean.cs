...
using DfExample.DBFlute.MemberDb.AllCommon.CBean.Grouping;
using DfExample.DBFlute.MemberDb.AllCommon.CBean.Mapping;

namespace DfExample.DBFlute.MemberDb.AllCommon.CBean {

    [System.Serializable]
    public class MbListResultBean<ENTITY> : System.Collections.Generic.IList<ENTITY>, System.Collections.IList {
         ...
         */
        public System.Collections.Generic.IList<ROW> GroupingList<ROW>(MbGroupingRowSetupper<ROW, ENTITY> groupingRowSetupper, MbGroupingOption<ENTITY> groupingOption) {
            System.Collections.Generic.IList<ROW> groupingList = new System.Collections.Generic.List<ROW>();
            MbGroupingRowEndDeterminer<ENTITY> rowEndDeterminer = groupingOption.GroupingRowEndDeterminer;
            if (rowEndDeterminer == null) {
                rowEndDeterminer = delegate(MbGroupingRowResource<ENTITY> currentRowResource, ENTITY nextEntity) {
                    return currentRowResource.IsSizeUpBreakCount;
                }; // as Default
            }
            MbGroupingRowResource<ENTITY> rowResource = new MbGroupingRowResource<ENTITY>();
            ...
            foreach (ENTITY entity in _selectedList) {
                ...
                if (rowEndDeterminer.Invoke(rowResource, nextElement)) { // Determine the row end!
                    ...
                    // Initialize!
                    rowResource = new MbGroupingRowResource<ENTITY>();
                    rowElementIndex = 0;
                    ++allElementIndex;
                    continue;
                }
        ...
        //                                                                         =======
        #region Mapping
        public MbListResultBean<DTO> MappingList<DTO>(MbEntityDtoMapper<ENTITY, DTO> entityDtoMapper) {
            MbListResultBean<DTO> mappingList = new MbListResultBean<DTO>();
            foreach (ENTITY entity in _selectedList) {
        ...
        public virtual MbOrderByClause OrderByClause {
