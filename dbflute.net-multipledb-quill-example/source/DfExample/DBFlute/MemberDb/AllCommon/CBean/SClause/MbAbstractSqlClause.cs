...
// JavaLike
[System.Serializable]
public abstract class MbAbstractSqlClause : MbSqlClause {
    ...
    protected MbOrderByClause _orderByClause = new MbOrderByClause();
    ...
    // protected List<MbWhereClauseSimpleFilter> _whereClauseSimpleFilterList;
    ...
    protected Map<String, MbConditionKey> _invalidQueryColumnMap;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public MbAbstractSqlClause(String tableName) {
        if (tableName == null) {
    ...
    public String getSelectClause() {
        ...
        // - - - - - - - - - -/
        StringBuilder sb = new StringBuilder();
        MbDBMeta dbmeta = getDBMeta();
        List<MbColumnInfo> columnInfoList = dbmeta.ColumnInfoList;
        ...
        foreach (MbColumnInfo columnInfo in columnInfoList) {
    ...
    protected String getLeftOuterJoinClause() {
        ...
        for (Iterator<String> ite = _outerJoinMap.keySet().iterator(); ite.hasNext(); ) {
            ...
            MbDBMeta foreignDBMeta = findDBMeta(foreignTableDbName);
    ...
    protected Map<String, SelectedSelectColumnInfo> createSelectedSelectColumnInfo(String foreignTableAliasName
                                                                                 ...
                                                                                 , String foreignPropertyName
                                                                                 , String localRelationPath) {
        MbDBMeta dbmeta = findDBMeta(localTableName);
        MbForeignInfo foreignInfo = dbmeta.FindForeignInfo(foreignPropertyName);
        ...
        MbDBMeta foreignDBMeta = foreignInfo.ForeignDBMeta;
        foreach (MbColumnInfo columnInfo in foreignDBMeta.ColumnInfoList) {
            String columnDbName = columnInfo.ColumnDbName;
            String columnSqlName = columnInfo.ColumnSqlName;
    ...
    public MbSqlClause makeInnerJoinEffective() {
        _innerJoinEffective = true;
        return this;
    }

    public MbSqlClause backToOuterJoin() {
    ...
    //                                                                               Where
    //                                                                               =====
    public void registerWhereClause(String columnFullName, MbConditionKey key, MbConditionValue value) {
    ...
    public void registerWhereClause(String columnFullName, MbConditionKey key, MbConditionValue value, MbConditionOption option) {
        assertStringNotNullAndNotTrimmedEmpty("columnFullName", columnFullName);
    ...
    protected void doRegisterWhereClause(List<String> clauseList, String columnName, MbConditionKey key,
            MbConditionValue value) {
        key.addWhereClause(clauseList, columnName, value);
        markOrScopeQueryAndPart(clauseList);
    }

    protected void doRegisterWhereClause(List<String> clauseList, String columnName, MbConditionKey key,
            MbConditionValue value, MbConditionOption option) {
    ...
    //                                                                         InlineWhere
    //                                                                         ===========
    public void registerBaseTableInlineWhereClause(String columnName, MbConditionKey key, MbConditionValue value) {
    ...
    public void registerBaseTableInlineWhereClause(String columnName, MbConditionKey key, MbConditionValue value, MbConditionOption option) {
        assertStringNotNullAndNotTrimmedEmpty("columnName", columnName);
    ...
    public void registerOuterJoinInlineWhereClause(String aliasName, String columnName, MbConditionKey key, MbConditionValue value, bool onClause) {
    ...
    public void registerOuterJoinInlineWhereClause(String aliasName, String columnName, MbConditionKey key, MbConditionValue value, MbConditionOption option, bool onClause) {
        assertNotYetOuterJoin(aliasName);
        assertStringNotNullAndNotTrimmedEmpty("columnName", columnName);
        List<String> clauseList = getOuterJoinInlineWhereClauseList4Register(aliasName, onClause);
        String realColumnName = (onClause ? aliasName + "." : "") + columnName;
    ...
    //                                                                             OrderBy
    //                                                                             =======
    public MbOrderByClause getSqlComponentOfOrderByClause() {
        return _orderByClause;
    }

    public MbSqlClause clearOrderBy() {
        _orderByEffective = false;
        _orderByClause.clear();
        return this;
    }

    public MbSqlClause ignoreOrderBy() {
        _orderByEffective = false;
        return this;
    }

    public MbSqlClause makeOrderByEffective() {
    ...
    public void registerOrderBy(String orderByProperty, String registeredOrderByProperty, bool ascOrDesc) {
        try {
            ...
            for (Iterator<String> ite = orderByList.iterator(); ite.hasNext(); ) {
                ...
                MbOrderByElement element = new MbOrderByElement();
     ...
     * @return this. (NotNull)
     */
    public MbSqlClause fetchFirst(int fetchSize) {
     ...
     * @return this. (NotNull)
     */
    public MbSqlClause fetchScope(int fetchStartIndex, int fetchSize) {
        _fetchScopeEffective = true;
     ...
     * @return this. (NotNull)
     */
    public MbSqlClause fetchPage(int fetchPageNumber) {
        _fetchScopeEffective = true;
    ...
    public virtual MbSqlClause ignoreFetchScope() {
        _fetchScopeEffective = false;
        doClearFetchPageClause();
        return this;
    }

    public virtual MbSqlClause makeFetchScopeEffective() {
    ...
    //                                                                                Lock
    //                                                                                ====
    public abstract MbSqlClause lockForUpdate();
...
//    //                                                            ==========================
//    public void addWhereClauseSimpleFilter(MbWhereClauseSimpleFilter whereClauseSimpleFilter) {
//        if (_whereClauseSimpleFilterList == null) {
//            _whereClauseSimpleFilterList = new ArrayList<MbWhereClauseSimpleFilter>();
//        }
...
//        }
//        for (Iterator<MbWhereClauseSimpleFilter> ite = _whereClauseSimpleFilterList.iterator(); ite.hasNext(); ) {
//             MbWhereClauseSimpleFilter filter = ite.next();
//            if (filter == null) {
...
//    }
    ...
    public Map<String, MbConditionKey> getInvalidQueryColumnMap() {
        if (_invalidQueryColumnMap != null) {
            return _invalidQueryColumnMap;
        }
        return new HashMap<String, MbConditionKey>();
    }

    public void registerInvalidQueryColumn(String columnFullName, MbConditionKey key) {
        if (_invalidQueryColumnMap == null) {
            _invalidQueryColumnMap = new LinkedHashMap<String, MbConditionKey>();
        }
    ...
    protected MbDBMeta findDBMeta(String tableDbName) {
        return MbDBMetaInstanceHandler.FindDBMeta(tableDbName); 
    }
    ...
    protected String toStringView(Object obj) {
        return MbTraceViewUtil.ToStringView(obj);
    }
