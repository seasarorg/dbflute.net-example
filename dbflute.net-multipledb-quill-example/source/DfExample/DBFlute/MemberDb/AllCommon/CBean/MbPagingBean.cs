...
namespace DfExample.DBFlute.MemberDb.AllCommon.CBean {
    ...
    /// </summary>
    public interface MbPagingBean : MbFetchNarrowingBean, MbOrderByBean {
        ...
        MbPagingBean FetchFirst(int fetchSize);
        ...
        /// <param name="fetchSize">The size of fetch. (NotMinus & NotZero)</param>
        /// <returns>this. (NotNull)</returns>
        MbPagingBean FetchScope(int fetchStartIndex, int fetchSize);
        ...
        /// <returns>this. (NotNull)</returns>
        MbPagingBean FetchPage(int fetchPageNumber);
