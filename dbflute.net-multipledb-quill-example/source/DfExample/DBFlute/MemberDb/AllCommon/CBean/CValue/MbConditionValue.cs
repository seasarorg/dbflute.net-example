...
namespace DfExample.DBFlute.MemberDb.AllCommon.CBean.CValue {

[System.Serializable]
public class MbConditionValue {
    ...
    public MbConditionValue OverrideEqual(Object value) {
    ...
    public MbConditionValue setEqualLocation(String location) {
    ...
    public MbConditionValue OverrideNotEqual(Object value) {
    ...
    public MbConditionValue setNotEqualLocation(String location) {
    ...
    public MbConditionValue OverrideGreaterThan(Object value) {
    ...
    public MbConditionValue setGreaterThanLocation(String location) {
    ...
    public MbConditionValue OverrideLessThan(Object value) {
    ...
    public MbConditionValue setLessThanLocation(String location) {
    ...
    public MbConditionValue OverrideGreaterEqual(Object value) {
    ...
    public MbConditionValue setGreaterEqualLocation(String location) {
    ...
    public MbConditionValue OverrideLessEqual(Object value) {
    ...
    public MbConditionValue setLessEqualLocation(String location) {
    ...
    public MbConditionValue OverridePrefixSearch(Object value) {
    ...
    public MbConditionValue setPrefixSearchLocation(String location) {
    ...
    public MbConditionValue setInScopeLocation(String location) {
    ...
    public MbConditionValue setNotInScopeLocation(String location) {
    ...
    public MbConditionValue setLikeSearch(String value, MbLikeSearchOption option) {
        if (_likeSearch == null) {
    ...
    public MbConditionValue setLikeSearchLocation(String location) {
    ...
    protected class LikeSearchValue {
        ...
        protected MbLikeSearchOption _option;
        public LikeSearchValue(String value, MbLikeSearchOption option) {
            _value = value;
            _option = option;
        }
        ...
        public MbLikeSearchOption getOption() {
            return _option;
        }
    ...
    public MbConditionValue setNotLikeSearch(String value, MbLikeSearchOption option) {
        if (_notLikeSearch == null) {
    ...
    public MbConditionValue setNotLikeSearchLocation(String location) {
    ...
    protected class NotLikeSearchValue {
        protected String _value;
        protected MbLikeSearchOption _option;
        public NotLikeSearchValue(String value, MbLikeSearchOption option) {
            _value = value;
            _option = option;
        }
        public String getValue() {
    ...
    public MbConditionValue setIsNullLocation(String location) {
    ...
    public MbConditionValue setIsNotNullLocation(String location) {
