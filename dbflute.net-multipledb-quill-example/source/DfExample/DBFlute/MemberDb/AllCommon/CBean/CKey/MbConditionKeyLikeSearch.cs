...
public class MbConditionKeyLikeSearch : MbConditionKey {

    public MbConditionKeyLikeSearch() {
    ...
    protected override void doSetupConditionValue(MbConditionValue conditionValue, Object value, String location, MbConditionOption option) {
        conditionValue.setLikeSearch((String)value, (MbLikeSearchOption)option).setLikeSearchLocation(location);
    }
}
