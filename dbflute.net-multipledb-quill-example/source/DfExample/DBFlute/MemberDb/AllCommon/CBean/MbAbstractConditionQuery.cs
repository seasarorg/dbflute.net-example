...
using DfExample.DBFlute.MemberDb.AllCommon.CBean.CHelper;
...
// JavaLike
[System.Serializable]
public abstract class MbAbstractConditionQuery : MbConditionQuery {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    protected static readonly MbConditionKey CK_EQ = MbConditionKey.CK_EQUAL;
    protected static readonly MbConditionKey CK_NES = MbConditionKey.CK_NOT_EQUAL_STANDARD;
    protected static readonly MbConditionKey CK_NET = MbConditionKey.CK_NOT_EQUAL_TRADITION;
    protected static readonly MbConditionKey CK_GE = MbConditionKey.CK_GREATER_EQUAL;
    protected static readonly MbConditionKey CK_GT = MbConditionKey.CK_GREATER_THAN;
    protected static readonly MbConditionKey CK_LE = MbConditionKey.CK_LESS_EQUAL;
    protected static readonly MbConditionKey CK_LT = MbConditionKey.CK_LESS_THAN;
    protected static readonly MbConditionKey CK_INS = MbConditionKey.CK_IN_SCOPE;
    protected static readonly MbConditionKey CK_NINS = MbConditionKey.CK_NOT_IN_SCOPE;
    protected static readonly MbConditionKey CK_LS = MbConditionKey.CK_LIKE_SEARCH;
    protected static readonly MbConditionKey CK_NLS = MbConditionKey.CK_NOT_LIKE_SEARCH;
    protected static readonly MbConditionKey CK_ISN = MbConditionKey.CK_IS_NULL;
    protected static readonly MbConditionKey CK_ISNN = MbConditionKey.CK_IS_NOT_NULL;

    protected static readonly MbConditionValue DUMMY_CONDITION_VALUE = new MbConditionValue();
    ...
    //                                                                           Attribute
    //                                                                           =========
    protected readonly MbSqlClause _sqlClause;
    ...
    protected readonly MbConditionQuery _referrerQuery;
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public MbAbstractConditionQuery(MbConditionQuery childQuery, MbSqlClause sqlClause, String aliasName, int nestLevel) {
    ...
    protected MbDBMeta findDBMeta(String tableFlexibleName) {
        return MbDBMetaInstanceHandler.FindDBMeta(tableFlexibleName);
    }
    ...
    //                                                                  Important Accessor
    //                                                                  ==================
    public MbConditionQuery xgetReferrerQuery() {
        return _referrerQuery;
    }

    public MbSqlClause xgetSqlClause() {
        return _sqlClause;
    }
    ...
    protected String getLocation(String columnPropertyName, MbConditionKey key) {
    ...
    public delegate MbConditionQuery NssCall(); // Very Internal

    // ===================================================================================
    //                                                                           OuterJoin
    //                                                                           =========
    protected virtual void registerOuterJoin(MbConditionQuery foreignCQ, Map<String, String> joinOnResourceMap) {
        registerOuterJoin(foreignCQ, joinOnResourceMap, null);
    }

    protected virtual void registerOuterJoin(MbConditionQuery foreignCQ, Map<String, String> joinOnResourceMap, String fixedCondition) {
    ...
    protected FixedConditionResolver createFixedConditionResolver(MbConditionQuery foreignCQ,
            Map<String, String> joinOnMap) {
        return new MbHpFixedConditionQueryResolver(this, foreignCQ, xgetDBMetaProvider());
    }

    // ===================================================================================
    //                                                                         Union Query
    //                                                                         ===========
    protected Map<String, MbConditionQuery> _unionQueryMap;

    public Map<String, MbConditionQuery> getUnionQueryMap() {// for Internal
		if (_unionQueryMap == null) {
		    _unionQueryMap = new LinkedHashMap<String, MbConditionQuery>();
		}
        return _unionQueryMap;
    }

	public Map<String, MbConditionQuery> UnionQueryMap {// for SQL-Comment
        get { return getUnionQueryMap(); }
    }

    public void xsetUnionQuery(MbConditionQuery unionQuery) {
        xsetupUnion(unionQuery, false, getUnionQueryMap());
    }

    protected Map<String, MbConditionQuery> _unionAllQueryMap;

    public Map<String, MbConditionQuery> getUnionAllQueryMap() {// for Internal
		if (_unionAllQueryMap == null) {
		    _unionAllQueryMap = new LinkedHashMap<String, MbConditionQuery>();
		}
        return _unionAllQueryMap;
    }

	public Map<String, MbConditionQuery> UnionAllQueryMap {// for SQL-Comment
        get { return getUnionAllQueryMap(); }
    }

    public void xsetUnionAllQuery(MbConditionQuery unionAllQuery) {
        xsetupUnion(unionAllQuery, true, getUnionAllQueryMap());
    }

    protected void xsetupUnion(MbConditionQuery unionQuery, bool unionAll, Map<String, MbConditionQuery> unionQueryMap) {
        if (unionQuery == null) {
    ...
    abstract public void reflectRelationOnUnionQuery(MbConditionQuery baseQueryAsSuper, MbConditionQuery unionQueryAsSuper);
    ...
    public List<MbConditionQuery> getUnionQueryList() {
		if (_unionQueryMap == null) { return new ArrayList<MbConditionQuery>(); }
        return new ArrayList<MbConditionQuery>(_unionQueryMap.values());
    }

    public List<MbConditionQuery> getUnionAllQueryList() {
		if (_unionAllQueryMap == null) { return new ArrayList<MbConditionQuery>(); }
        return new ArrayList<MbConditionQuery>(_unionAllQueryMap.values());
    }
    ...
    //                                          Normal Query
    //                                          ------------
    protected virtual void regQ(MbConditionKey key, Object value, MbConditionValue cvalue, String colName) {
	...
	protected virtual void regQ(MbConditionKey key, Object value, MbConditionValue cvalue, String colName, MbConditionOption option) {
        if (!isValidQuery(key, value, cvalue, colName)) {
            return;
        }
    ...
    protected virtual bool isValidQuery(MbConditionKey key, Object value, MbConditionValue cvalue, String colName) {
    ...
    protected void throwInvalidQueryRegisteredException(MbConditionKey key, Object value, String realColumnName) {
        ...
        msg = msg + value + ln();
        msg = msg + "* * * * * * * * * */";
        throw new MbInvalidQueryRegisteredException(msg);
    }

    // -----------------------------------------------------
    //                                         InScope Query
    //                                         -------------
    protected void regINS<ELEMENT>(MbConditionKey key, System.Collections.IList value, MbConditionValue cvalue, String colName) {
        if (!isValidQuery(key, value, cvalue, colName)) {
            return;
        }
    ...
    static bool isConditionKeyInScope(MbConditionKey key) { // default scope for test 
        return typeof(MbConditionKeyInScope).IsAssignableFrom(key.GetType());
    }
    ...
    //                                          FromTo Query
    //                                          ------------
    protected void regFTQ(DateTime? fromDate, DateTime? toDate, MbConditionValue cvalue, String colName, MbFromToOption option) {
        {
            MbConditionKey fromKey = option.getFromDateConditionKey();
        ...
        {
            MbConditionKey toKey = option.getToDateConditionKey();
    ...
    //                                      LikeSearch Query
    //                                      ----------------
    protected void regLSQ(MbConditionKey key
                        , String value
                        , MbConditionValue cvalue
                        , String colName
                        , MbLikeSearchOption option) {
        registerLikeSearchQuery(key, value, cvalue, colName, option);
    }

    protected void registerLikeSearchQuery(MbConditionKey key
                                         , String value
                                         , MbConditionValue cvalue
                                         , String colName
                                         , MbLikeSearchOption option) {
    ...
    protected void throwLikeSearchOptionNotFoundException(String colName, String value) {
        MbDBMeta dbmeta = MbDBMetaInstanceHandler.FindDBMeta(getTableDbName());
        ...
        msg = msg + "* * * * * * * * * */";
        throw new MbRequiredOptionNotFoundException(msg);
    }

    // -----------------------------------------------------
    //                                          Inline Query
    //                                          ------------
    protected virtual void regIQ(MbConditionKey key, Object value, MbConditionValue cvalue, String colName) {
        if (!isValidQuery(key, value, cvalue, colName)) {
            return;
        }
        MbDBMeta dbmeta = MbDBMetaInstanceHandler.FindDBMeta(getTableDbName());
    ...
    protected virtual void regIQ(MbConditionKey key, Object value, MbConditionValue cvalue
    ...
    //                                       InScopeSubQuery
    //                                       ---------------
    protected virtual void registerInScopeSubQuery(MbConditionQuery subQuery
                                 , String columnName, String relatedColumnName, String propertyName) {
        registerInScopeSubQuery(subQuery, columnName, relatedColumnName, propertyName, null);
    }

    protected virtual void registerNotInScopeSubQuery(MbConditionQuery subQuery
                                 , String columnName, String relatedColumnName, String propertyName) {
    ...
    protected virtual String getInScopeSubQueryClause(MbConditionQuery subQuery
    ...
    //                                        ExistsSubQuery
    //                                        --------------
    protected virtual void registerExistsSubQuery(MbConditionQuery subQuery
                                 , String columnName, String relatedColumnName, String propertyName) {
        registerExistsSubQuery(subQuery, columnName, relatedColumnName, propertyName, null);
    }

    protected virtual void registerNotExistsSubQuery(MbConditionQuery subQuery
                                 , String columnName, String relatedColumnName, String propertyName) {
    ...
    protected virtual String getExistsSubQueryClause(MbConditionQuery subQuery
    ...
    //                              ------------------------
    protected void registerSpecifyDerivedReferrer(String function, MbConditionQuery subQuery
    ...
    protected String getSpecifyDerivedReferrerSubQueryClause(String function, MbConditionQuery subQuery
        ...
        if (subQuery.xgetSqlClause().hasUnionQuery()) {
            ...
            String beginMark = subQuery.xgetSqlClause().resolveSubQueryBeginMark(subQueryIdentity) + ln();
            String endMark = subQuery.xgetSqlClause().resolveSubQueryEndMark(subQueryIdentity);
            MbDBMeta dbmeta = MbDBMetaInstanceHandler.FindDBMeta(subQuery.getTableDbName());
    ...
    protected void assertSpecifyDerivedReferrerColumnType(String function, MbConditionQuery subQuery, String deriveColumnName) {
        MbDBMeta dbmeta = MbDBMetaInstanceHandler.FindDBMeta(subQuery.getTableDbName());
    ...
    //                                ----------------------
    protected void registerQueryDerivedReferrer(String function, MbConditionQuery subQuery
                                              , String columnName, String relatedColumnName, String propertyName
    ...
    protected String getQueryDerivedReferrerSubQueryClause(String function, MbConditionQuery subQuery
                                                         , String realColumnName, String relatedColumnName
        ...
        if (subQuery.xgetSqlClause().hasUnionQuery()) {
            ...
            String beginMark = subQuery.xgetSqlClause().resolveSubQueryBeginMark(subQueryIdentity) + ln();
            String endMark = subQuery.xgetSqlClause().resolveSubQueryEndMark(subQueryIdentity);
            MbDBMeta dbmeta = findDBMeta(subQuery.getTableDbName());
            if (!dbmeta.HasPrimaryKey || dbmeta.HasCompoundPrimaryKey) {
                String msg = "The derived-referrer is unsupported when no primary key or two-or-more primary keys:";
                msg = msg + " table=" + subQuery.getTableDbName();
    ...
    protected void throwQueryDerivedReferrerInvalidColumnSpecificationException(String function) {
        MbConditionBeanContext.ThrowQueryDerivedReferrerInvalidColumnSpecificationException(function);
    }

    protected void assertQueryDerivedReferrerColumnType(String function, MbConditionQuery subQuery, String deriveColumnName, Object value) {
        MbDBMeta dbmeta = findDBMeta(subQuery.getTableDbName());
        Type deriveColumnType = dbmeta.FindColumnInfo(deriveColumnName).PropertyType;
        if ("sum".Equals(function.ToLower()) || "avg".Equals(function.ToLower())) {
            // Determine as not string and not date because CSharp does not have abstract class of number.
    ...
    protected void throwQueryDerivedReferrerUnmatchedColumnTypeException(String function, String deriveColumnName, Type deriveColumnType, Object value) {
        MbConditionBeanContext.ThrowQueryDerivedReferrerUnmatchedColumnTypeException(function, deriveColumnName, deriveColumnType, value);
    }

    public class QDRFunction<CB> where CB : MbConditionBean { // Internal
         ...
         */
        public QDRParameter<CB, int> Count(MbSubQuery<CB> subQuery) {
         ...
         * @return The parameter for comparing with scalar. (NotNull)
         */
        public QDRParameter<CB, int> CountDistinct(MbSubQuery<CB> subQuery) {
         ...
         * @return The parameter for comparing with scalar. (NotNull)
         */
        public QDRParameter<CB, Object> Max(MbSubQuery<CB> subQuery) {
         ...
         * @return The parameter for comparing with scalar. (NotNull)
         */
        public QDRParameter<CB, Object> Min(MbSubQuery<CB> subQuery) {
         ...
         * @return The parameter for comparing with scalar. (NotNull)
         */
        public QDRParameter<CB, Object> Sum(MbSubQuery<CB> subQuery) {
         ...
         * @return The parameter for comparing with scalar. (NotNull)
         */
        public QDRParameter<CB, Object> Avg(MbSubQuery<CB> subQuery) {
            return new QDRParameter<CB, Object>("avg", subQuery, _setupper);
        }
    }

    public delegate void QDRSetupper<CB>(String function
                                       , MbSubQuery<CB> subQuery
                                       , String operand
                                       , Object value) where CB : MbConditionBean;

    public class QDRParameter<CB, PARAMETER> where CB : MbConditionBean { // Internal
        protected String _function;
        protected MbSubQuery<CB> _subQuery;
        protected QDRSetupper<CB> _setupper;
        public QDRParameter(String function, MbSubQuery<CB> subQuery, QDRSetupper<CB> setupper) {
            _function = function;
            _subQuery = subQuery;
            _setupper = setupper;
        }
    ...
    //                                        ScalarSubQuery
    //                                        --------------
    protected void registerScalarSubQuery(String function, MbConditionQuery subQuery
    ...
    protected String getScalarSubQueryClause(String function, MbConditionQuery subQuery
                                           , String propertyName) {
        int subQueryLevel = subQuery.xgetSqlClause().getSubQueryLevel();
        String tableAliasName = subQuery.xgetSqlClause().getBasePointAliasName();
        String deriveColumnName = subQuery.xgetSqlClause().getSpecifiedColumnNameAsOne();
    ...
    protected void throwScalarSubQueryInvalidColumnSpecificationException(String function) {
        MbConditionBeanContext.ThrowScalarSubQueryInvalidColumnSpecificationException(function);
    }

    protected void assertScalarSubQueryColumnType(String function, MbConditionQuery subQuery, String deriveColumnName) {
        MbDBMeta dbmeta = findDBMeta(subQuery.getTableDbName());
        Type deriveColumnType = dbmeta.FindColumnInfo(deriveColumnName).PropertyType;
        if ("sum".Equals(function.ToLower()) || "avg".Equals(function.ToLower())) {
            // Determine as not string and not date because CSharp does not have abstract class of number.
    ...
    protected void throwScalarSubQueryUnmatchedColumnTypeException(String function, String deriveColumnName, Type deriveColumnType) {
        MbConditionBeanContext.ThrowScalarSubQueryUnmatchedColumnTypeException(function, deriveColumnName, deriveColumnType);
    }

    public class SSQFunction<CB> where CB : MbConditionBean { // Internal
         ...
         */
        public void Max(MbSubQuery<CB> subQuery) {
         ...
         * @param subQuery The sub query of myself. (NotNull) 
         */
        public void Min(MbSubQuery<CB> subQuery) {
         ...
         * @param subQuery The sub query of myself. (NotNull) 
         */
        public void Sum(MbSubQuery<CB> subQuery) {
         ...
         * @param subQuery The sub query of myself. (NotNull) 
         */
        public void Avg(MbSubQuery<CB> subQuery) {
    ...
    public delegate void SSQSetupper<CB>(String function
                                       , MbSubQuery<CB> subQuery)
                                       where CB : MbConditionBean; // Internal

    // -----------------------------------------------------
    //                                       SubQuery Common
    //                                       ---------------
    protected String buildPlainSubQueryFromWhereClause(MbConditionQuery subQuery
    ...
    protected String buildCorrelationSubQueryFromWhereClause(MbConditionQuery subQuery
                                                           , String relatedColumnName
                                                           , String propertyName
                                                           , String selectClause
                                                           , String tableAliasName
    ...
    //                                          Where Clause
    //                                          ------------
    protected virtual void setupConditionValueAndRegisterWhereClause(MbConditionKey key, Object value, MbConditionValue cvalue, String colName) {
        MbDBMeta dbmeta = MbDBMetaInstanceHandler.FindDBMeta(getTableDbName());
        String propertyName = dbmeta.FindPropertyName(colName);
        String capPropName = initCap(propertyName);
    ...
    protected virtual void setupConditionValueAndRegisterWhereClause(MbConditionKey key, Object value, MbConditionValue cvalue
                                                                   , String colName, MbConditionOption option) {
        MbDBMeta dbmeta = MbDBMetaInstanceHandler.FindDBMeta(getTableDbName());
        String propertyName = dbmeta.FindPropertyName(colName);
        String capPropName = initCap(propertyName);
    ...
    //                                           Union Query
    //                                           -----------
    public void registerUnionQuery(MbConditionQuery unionQuery, bool unionAll, String unionQueryPropertyName) {
    ...
    protected String getUnionQuerySql(MbConditionQuery unionQuery, String unionQueryPropertyName) {
    ...
    //                                                                 Reflection Invoking
    //                                                                 ===================
    public MbConditionValue invokeValue(String columnFlexibleName) {
        ...
        return (MbConditionValue)helpInvokingCQProperty(this, property);
    }
    ...
    public void invokeQuery(String columnFlexibleName, String conditionKeyName, Object value) {
        ...
        MbConditionQuery cq = container.getConditionQuery();
        MbDBMeta dbmeta = MbDBMetaInstanceHandler.FindDBMeta(cq.getTableDbName());
    ...
    public MbConditionQuery invokeForeignCQ(String foreignPropertyName) {
        assertStringNotNullAndNotTrimmedEmpty("foreignPropertyName", foreignPropertyName);
        String[] splitList = foreignPropertyName.Split('.');
        MbConditionQuery foreignCQ = this;
    ...
    protected MbConditionQuery doInvokeForeignCQ(MbConditionQuery cq, String foreignPropertyName) {
        assertStringNotNullAndNotTrimmedEmpty("foreignPropertyName", foreignPropertyName);
        ...
        return (MbConditionQuery)helpInvokingCQMethod(cq, method, new Object[]{});
    }
    ...
    protected bool doInvokeHasForeignCQ(MbConditionQuery cq, String foreignPropertyName) {
        assertStringNotNullAndNotTrimmedEmpty("foreignPropertyName", foreignPropertyName);
    ...
    private class PropertyNameCQContainer {
        ...
        protected MbConditionQuery _cq;
        public PropertyNameCQContainer(String propertyName, MbConditionQuery cq) {
        ...
        public MbConditionQuery getConditionQuery() {
            return _cq;
        }
    }

    private PropertyInfo helpGettingCQProperty(MbConditionQuery cq, String propertyName) {
    ...
    private Object helpInvokingCQProperty(MbConditionQuery cq, PropertyInfo property) {
        return property.GetValue(cq, null);
    }

    private MethodInfo helpGettingCQMethod(MbConditionQuery cq, String methodName, Type[] argTypes, String property) {
    ...
    private Object helpInvokingCQMethod(MbConditionQuery cq, MethodInfo method, Object[] args) {
    ...
    protected MbLikeSearchOption cLSOP() {
        return new MbLikeSearchOption().LikePrefix();
    }
    ...
    protected String initUncap(String str) {
	    return MbSimpleStringUtil.InitUncap(str);
    }

    protected String convertObjectArrayToStringView(Object[] objArray) {
	    return MbTraceViewUtil.ConvertObjectArrayToStringView(objArray);
    }
