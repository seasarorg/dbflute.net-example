...
namespace DfExample.DBFlute.MemberDb.AllCommon.CBean {
    ...
    [System.Serializable]
    public abstract class MbAbstractConditionBean : MbConditionBean {
        ...
        private MbUnionQuery<MbConditionBean> _unionQuerySynchronizer;
        ...
        //                                                                     Constructor
        //                                                                     ===========
        public MbAbstractConditionBean() {
            MbDBMeta dbmeta = MbDBMetaInstanceHandler.FindDBMeta(TableDbName);
            _sqlClause = new MbSqlClauseMySql(dbmeta.TableSqlName);
        }
        ...
        //                                                                       SqlClause
        //                                                                       =========
        public MbSqlClause SqlClause { get { return _sqlClause; } }
        public String GetClause() { return this.SqlClause.getClause(); }

        // ===============================================================================
        //                                                                           Query
        //                                                                           =====
        public abstract MbConditionQuery LocalCQ { get; }
        ...
        //                                     Fetch Setting
        //                                     -------------
        public MbPagingBean FetchFirst(int fetchSize) {
            this.SqlClause.fetchFirst(fetchSize);
            return this;
        }

        public MbPagingBean FetchScope(int fetchStartIndex, int fetchSize) {
            this.SqlClause.fetchScope(fetchStartIndex, fetchSize);
            return this;
        }

        public MbPagingBean FetchPage(int fetchPageNumber) {
        ...
        //                                                   =============================
        public MbOrderByClause SqlComponentOfOrderByClause {
            get { return this.SqlClause.getSqlComponentOfOrderByClause(); }
        }

        public MbOrderByBean ClearOrderBy() {
            this.SqlClause.clearOrderBy();
            return this;
        }

        public MbOrderByBean IgnoreOrderBy() {
            this.SqlClause.ignoreOrderBy();
            return this;
        }

        public MbOrderByBean MakeOrderByEffective() {
            this.SqlClause.makeOrderByEffective();
            return this;
        }

        public abstract MbConditionBean AddOrderBy_PK_Asc();
        public abstract MbConditionBean AddOrderBy_PK_Desc();

        // ===============================================================================
        //                                                                    Lock Setting
        //                                                                    ============
        public MbConditionBean LockForUpdate() {
        ...
        //                                                                    Select Count
        //                                                                    ============
        public MbConditionBean xsetupSelectCountIgnoreFetchScope() {
        ...
        public MbConditionBean xafterCareSelectCountIgnoreFetchScope() {
        ...
        //                                                                     ColumnQuery
        //                                                                     ===========
        protected void xcolqy<CB>(CB leftCB, CB rightCB, MbSpecifyQuery<CB> leftSp,
                MbSpecifyQuery<CB> rightSp, String operand) where CB : MbConditionBean {
            // specify left column
        ...
        //                                                                    OrScopeQuery
        //                                                                    ============
        protected void xorQ<CB>(CB cb, MbOrQuery<CB> orQuery) where CB : MbConditionBean {
        ...
        //                                                                Statement Config
        //                                                                ================
        public void Configure(MbStatementConfig statementConfig) {
            _statementConfig = statementConfig;
        }
    
        public MbStatementConfig StatementConfig { get {
        ...
        public virtual String ToDisplaySql() {
            return MbConditionBeanContext.ConvertConditionBean2DisplaySql(this);
        }
        ...
        //                                                              Query Synchronizer
        //                                                              ==================
        protected void xsyncUQ(MbConditionBean unionCB) { // synchronizeUnionQuery()
            if (_unionQuerySynchronizer != null) {
                _unionQuerySynchronizer.Invoke(unionCB);
            }
        }

        public void xregisterUnionQuerySynchronizer(MbUnionQuery<MbConditionBean> unionQuerySynchronizer) {
        ...
        public void xsetupForUnion(MbConditionBean mainCB) {
            xinheritSubQueryInfo(mainCB.LocalCQ);
            _forUnion = true;
        }

        public void xsetupForExistsReferrer(MbConditionQuery mainCQ) {
            xprepareSubQueryInfo(mainCQ);
            _forExistsReferrer = true;
        }

        public void xsetupForInScopeRelation(MbConditionQuery mainCQ) {
            xprepareSubQueryInfo(mainCQ);
            _forInScopeRelation = true;
        }

        public void xsetupForDerivedReferrer(MbConditionQuery mainCQ) {
            xprepareSubQueryInfo(mainCQ);
        ...
        public void xsetupForScalarCondition(MbConditionQuery mainCQ) {
            xprepareSubQueryInfo(mainCQ);
        ...
        protected void xinheritSubQueryInfo(MbConditionQuery mainCQ) {
            if (mainCQ.xgetSqlClause().isForSubQuery()) {
                this.SqlClause.setupForSubQuery(mainCQ.xgetSqlClause().getSubQueryLevel()); // inherited
            }
        }

        protected void xprepareSubQueryInfo(MbConditionQuery mainCQ) {
        ...
        protected delegate MbConditionQuery SsCall();
    ...
    // [DBFlute-0.7.4]
    public abstract class AbstractSpecification<CQ> where CQ : MbConditionQuery {
        protected MbConditionBean _baseCB;
        ...
        protected AbstractSpecification(MbConditionBean baseCB, HpSpQyCall<CQ> qyCall
        ...
        protected void throwScalarSubQueryInvalidForeignSpecificationException(String foreignPropertyName) {
            MbConditionBeanContext.ThrowScalarSubQueryInvalidForeignSpecificationException(foreignPropertyName);
        }
    ...
    public interface HpSpQyCall<CQ> where CQ : MbConditionQuery {
        bool has(); 
        CQ qy(); 
    }

    public class HpColQyOperand<CB> where CB : MbConditionBean {
        ...
        public void Equal(MbSpecifyQuery<CB> rightSpecifyQuery) {
            _handler.Invoke(rightSpecifyQuery, "=");
        }

        public void NotEqual(MbSpecifyQuery<CB> rightSpecifyQuery) {
            _handler.Invoke(rightSpecifyQuery, "<>");
        }

        public void GreaterThan(MbSpecifyQuery<CB> rightSpecifyQuery) {
            _handler.Invoke(rightSpecifyQuery, ">");
        }

        public void GreaterEqual(MbSpecifyQuery<CB> rightSpecifyQuery) {
            _handler.Invoke(rightSpecifyQuery, ">=");
        }

        public void LessThan(MbSpecifyQuery<CB> rightSpecifyQuery) {
            _handler.Invoke(rightSpecifyQuery, "<");
        }

        public void LessEqual(MbSpecifyQuery<CB> rightSpecifyQuery) {
            _handler.Invoke(rightSpecifyQuery, "<=");
        }
    }

    public delegate void HpColQyHandler<CB>(MbSpecifyQuery<CB> rightSp, String operand) where CB : MbConditionBean;
    ...
    public class RAFunction<REFERRER_CB, LOCAL_CQ> where REFERRER_CB : MbConditionBean where LOCAL_CQ : MbConditionQuery {
        protected MbConditionBean _baseCB;
        protected LOCAL_CQ _localCQ;
        protected RAQSetupper<REFERRER_CB, LOCAL_CQ> _querySetupper;

        public RAFunction(MbConditionBean baseCB, LOCAL_CQ localCQ, RAQSetupper<REFERRER_CB, LOCAL_CQ> querySetupper) {
            _baseCB = baseCB;
            _localCQ = localCQ;
            _querySetupper = querySetupper;
        }

        public void Count(MbSubQuery<REFERRER_CB> subQuery, String aliasName) {
            assertAliasName(aliasName);
            _querySetupper.Invoke("count", subQuery, _localCQ, aliasName.Trim());
        }
        public void CountDistinct(MbSubQuery<REFERRER_CB> subQuery, String aliasName) {
            assertAliasName(aliasName);
            _querySetupper.Invoke("count(distinct", subQuery, _localCQ, aliasName.Trim());
        }
        public void Max(MbSubQuery<REFERRER_CB> subQuery, String aliasName) {
            assertAliasName(aliasName);
            _querySetupper.Invoke("max", subQuery, _localCQ, aliasName.Trim());
        }
        public void Min(MbSubQuery<REFERRER_CB> subQuery, String aliasName) {
            assertAliasName(aliasName);
            _querySetupper.Invoke("min", subQuery, _localCQ, aliasName.Trim());
        }
        public void Sum(MbSubQuery<REFERRER_CB> subQuery, String aliasName) {
            assertAliasName(aliasName);
            _querySetupper.Invoke("sum", subQuery, _localCQ, aliasName.Trim());
        }
        public void Avg(MbSubQuery<REFERRER_CB> subQuery, String aliasName) {
            assertAliasName(aliasName);
        ...
        protected void assertAliasName(String aliasName) {
            ...
            MbDBMeta dbmeta = MbDBMetaInstanceHandler.FindDBMeta(_baseCB.TableDbName);
    ...
    public delegate void RAQSetupper<REFERRER_CB, LOCAL_CQ>(String function, MbSubQuery<REFERRER_CB> subQuery, LOCAL_CQ cq, String aliasName)
            where REFERRER_CB : MbConditionBean where LOCAL_CQ : MbConditionQuery;
