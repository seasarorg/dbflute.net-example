...
namespace DfExample.DBFlute.MemberDb.AllCommon.CBean {
    ...
    public class MbPagingInvoker<ENTITY> {
        ...
        //                                                                     Constructor
        //                                                                     ===========
        public MbPagingInvoker(String tableDbName) {
        ...
        //                                                                          Invoke
        //                                                                          ======
        public MbPagingResultBean<ENTITY> InvokePaging(MbPagingHandler<ENTITY> handler) {
            AssertObjectNotNull("handler", handler);
            MbPagingBean pagingBean = handler.PagingBean;
            ...
            MbPagingResultBean<ENTITY> rb = new MbResultBeanBuilder<ENTITY>(_tableDbName).BuildPagingResultBean(pagingBean, allRecordCount, selectedList);
            if (pagingBean.CanPagingReSelect && IsNecessaryToReadPageAgain(rb)) {
                ...
                return new MbResultBeanBuilder<ENTITY>(_tableDbName).BuildPagingResultBean(pagingBean, reAllRecordCount, reSelectedList);
            } else {
                return rb;
            }
        }

        protected bool IsNecessaryToReadPageAgain(MbPagingResultBean<ENTITY> rb) {
        ...
        //                                                                          Option
        //                                                                          ======
        public MbPagingInvoker<ENTITY> CountLater() {
