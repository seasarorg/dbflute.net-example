...
namespace DfExample.DBFlute.MemberDb.AllCommon.CBean.OutsideSql {
    ...
    public class MbOutsideSqlContext {
        ...
        public static MbOutsideSqlContext GetOutsideSqlContextOnThread() {
            return (MbOutsideSqlContext)Thread.GetData(_slot);
        }

        public static void SetOutsideSqlContextOnThread(MbOutsideSqlContext outsideSqlContext) {
        ...
        //                                                                      Unique Key
        //                                                                      ==========
        public static String GenerateSpecifiedOutsideSqlUniqueKey(String methodName, String path, Object pmb, MbOutsideSqlOption option, Type resultType) {
        ...
        public static void ThrowOutsideSqlNotFoundException(String path) {
            ...
            msg = msg + "* * * * * * * * * */";
            throw new DfExample.DBFlute.MemberDb.AllCommon.Exp.MbOutsideSqlNotFoundException(msg);
        }
        ...
        public String ReadOutsideSql(String sqlFileEncoding, String dbmsSuffix) { // Non Filtered
            ...
            AdditionalAssembly additionalAssemblyProvider = MbDBFluteConfig.GetInstance().AdditionalAssemblyProvider;
        ...
        protected String BuildBehaviorSqlPackageName() {
            MbDBMeta dbmeta = MbDBMetaInstanceHandler.FindDBMeta(_tableDbName);
            String behaviorTypeName = dbmeta.BehaviorTypeName;
            String outsideSqlPackage = MbDBFluteConfig.GetInstance().OutsideSqlPackage;
        ...
        public String FilterAboutOmitDirectoryPackage(String pckge) { // CSharp only
            String omitDirectoryPackage = MbDBFluteConfig.GetInstance().OmitDirectoryPackage;
        ...
        public String FilterAboutOmitResourcePathPackage(String pckge) { // CSharp only
            String omitResourcePathPackage = MbDBFluteConfig.GetInstance().OmitResourcePathPackage;
        ...
        protected String FilterAboutDefaultPackage(String pckge) { // CSharp only
            String defaultPackage = MbDBFluteConfig.GetInstance().DefaultPackage;
        ...
        protected virtual String BuildFileSystemPath(String standardPath) {
            ...
            String omitPathPackage = MbDBFluteConfig.GetInstance().OmitFileSystemPathPackage;
            ...
            String flatDirectory = MbDBFluteConfig.GetInstance().FlatDirectoryPackage;
            ...
            FileSystemPath resolver = MbDBFluteConfig.GetInstance().FileSystemPathResolver;
            if (resolver != null) {
    ...
    public delegate String FileSystemPath(String relativePath, String standardPath, MbOutsideSqlContext context);
}
