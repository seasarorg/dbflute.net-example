...
namespace DfExample.DBFlute.MemberDb.ExEntity {
    ...
    [System.Serializable]
    public partial class MbMemberLogin : MbEntity {
        ...
        public MbCDef.Flg MobileLoginFlgAsFlg { get {
            return MbCDef.Flg.CodeOf(_mobileLoginFlg);
        } set {
        ...
        public void SetMobileLoginFlg_True() {
            MobileLoginFlgAsFlg = MbCDef.Flg.True;
        }
        ...
        public void SetMobileLoginFlg_False() {
            MobileLoginFlgAsFlg = MbCDef.Flg.False;
        }
        ...
        public bool IsMobileLoginFlgTrue {
            get {
                MbCDef.Flg cls = MobileLoginFlgAsFlg;
        ...
        public override bool Equals(Object other) {
            if (other == null || !(other is MbMemberLogin)) { return false; }
            MbMemberLogin otherEntity = (MbMemberLogin)other;
        ...
        public override String ToString() {
            return "MbMemberLogin:" + BuildColumnString() + BuildRelationString();
        }
