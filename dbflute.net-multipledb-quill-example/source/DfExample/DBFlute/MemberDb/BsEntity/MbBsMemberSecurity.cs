...
namespace DfExample.DBFlute.MemberDb.ExEntity {
    ...
    [System.Serializable]
    public partial class MbMemberSecurity : MbEntityDefinedCommonColumn {
        ...
        public override bool Equals(Object other) {
            if (other == null || !(other is MbMemberSecurity)) { return false; }
            MbMemberSecurity otherEntity = (MbMemberSecurity)other;
        ...
        public override String ToString() {
            return "MbMemberSecurity:" + BuildColumnString() + BuildRelationString();
        }
