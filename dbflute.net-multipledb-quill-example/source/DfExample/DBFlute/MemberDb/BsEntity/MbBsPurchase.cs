...
namespace DfExample.DBFlute.MemberDb.ExEntity {
    ...
    /// <summary>
    /// The entity of purchase as TABLE. (partial class for auto-generation)
    /// <![CDATA[
    /// [primary-key]
    ///     PURCHASE_ID
    /// 
    ...
    [System.Serializable]
    public partial class MbPurchase : MbEntityDefinedCommonColumn {
        ...
        public MbCDef.Flg PaymentCompleteFlgAsFlg { get {
            return MbCDef.Flg.CodeOf(_paymentCompleteFlg);
        } set {
        ...
        public void SetPaymentCompleteFlg_True() {
            PaymentCompleteFlgAsFlg = MbCDef.Flg.True;
        }
        ...
        public void SetPaymentCompleteFlg_False() {
            PaymentCompleteFlgAsFlg = MbCDef.Flg.False;
        }
        ...
        public bool IsPaymentCompleteFlgTrue {
            get {
                MbCDef.Flg cls = PaymentCompleteFlgAsFlg;
                return cls != null ? cls.Equals(MbCDef.Flg.True) : false;
            }
        }
        ...
        public bool IsPaymentCompleteFlgFalse {
            get {
                MbCDef.Flg cls = PaymentCompleteFlgAsFlg;
                return cls != null ? cls.Equals(MbCDef.Flg.False) : false;
            }
        }
        ...
        public override bool Equals(Object other) {
            if (other == null || !(other is MbPurchase)) { return false; }
            MbPurchase otherEntity = (MbPurchase)other;
        ...
        public override String ToString() {
            return "MbPurchase:" + BuildColumnString() + BuildRelationString();
        }
