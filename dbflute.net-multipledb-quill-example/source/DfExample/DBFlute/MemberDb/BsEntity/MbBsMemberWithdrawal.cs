...
namespace DfExample.DBFlute.MemberDb.ExEntity {
    ...
    /// <summary>
    /// The entity of member_withdrawal as TABLE. (partial class for auto-generation)
    /// <![CDATA[
    /// [primary-key]
    ///     MEMBER_ID
    /// 
    ...
    [System.Serializable]
    public partial class MbMemberWithdrawal : MbEntityDefinedCommonColumn {
        ...
        public MbWithdrawalReason WithdrawalReason {
        ...
        public override bool Equals(Object other) {
            if (other == null || !(other is MbMemberWithdrawal)) { return false; }
            MbMemberWithdrawal otherEntity = (MbMemberWithdrawal)other;
        ...
        public override String ToString() {
            return "MbMemberWithdrawal:" + BuildColumnString() + BuildRelationString();
        }
